...
static HcclResult groupLaunchA5()
{
    ...
    for (HcclComm comm : hcclGroupCommListV2) {
        ...
        // 下发record kernel
        CHK_RET(
            LaunchNotifyRecordToThread(comm, unfoldStream, aicpuSendThread, exportedAicpuTsThread, 0, "RunAicpuNotifyRecord"));
        CHK_RET(
            LaunchNotifyRecordToThread(comm, unfoldStream, aicpuRecvThread, exportedAicpuTsThread, 0, "RunAicpuNotifyRecord"));
