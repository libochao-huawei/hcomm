...
#define AIV_REDUCE_SCATTER_KERNEL_DEF(aa, kernel_name, type) \
...
#define AIV_REDUCE_SCATTER_KERNEL_DEF_A3(aa, kernel_name, type) \
...
#define AIV_REDUCE_SCATTER_KERNEL_BATCH_DEF(type) \
    AIV_KERNEL_BATCH_DEF(aiv_reduce_scatter, type, AIV_REDUCE_SCATTER_KERNEL_DEF, SK_BIND_FUNC_DEF_A2)

#define AIV_REDUCE_SCATTER_KERNEL_BATCH_DEF_A3(type) \
    AIV_KERNEL_BATCH_DEF(aiv_reduce_scatter_cn, type, AIV_REDUCE_SCATTER_KERNEL_DEF_A3, SK_BIND_FUNC_DEF_A3)
