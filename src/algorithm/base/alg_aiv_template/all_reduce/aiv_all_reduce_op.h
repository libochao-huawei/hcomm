...
#define AIV_ALL_REDUCE_KERNEL_BATCH_DEF_A3(type) \
    ...
    SK_BIND_FUNC_DEF_A2(aiv_all_reduce_cn_##type, 1); \
    SK_BIND_FUNC_DEF_A2(aiv_all_reduce_cn_##type, 2); \
    SK_BIND_FUNC_DEF_A2(aiv_all_reduce_cn_##type, 3); \
    SK_BIND_FUNC_DEF_A2(aiv_all_reduce_cn_##type, 4); \
