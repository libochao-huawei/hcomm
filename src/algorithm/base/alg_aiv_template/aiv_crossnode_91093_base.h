...
public:
    ...
    __aicore__ inline void SyncAllCycle(int32_t tag, AivNotifyType notifyType, int32_t blockGroup, bool ifSyncCore);
...
__aicore__ inline void AivCrossNode91093Base::SyncAllCycle(int32_t tag, AivNotifyType notifyType, int32_t blockGroup, bool ifSyncCore)
{
    //todo
