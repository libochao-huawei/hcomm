...
GM_ADDR buffOut8 = args->buffOut8; GM_ADDR buffOut9 = args->buffOut9; GM_ADDR buffOut10 = args->buffOut10; GM_ADDR buffOut11 = args[27]; \
...
int32_t tag = args->tag; uint32_t numBlocks = args->numBlocks; isOpBase = args->isOpBase; uint64_t bufferSize = args->bufferSize; \
