...
namespace hccl {
class AlltoAllVFullMeshSymmetricMemory : public AlgTemplateBase {
public:
    explicit AlltoAllVFullMeshSymmetricMemory(const HcclDispatcher dispatcher);
    ~AlltoAllVFullMeshSymmetricMemory() override;
