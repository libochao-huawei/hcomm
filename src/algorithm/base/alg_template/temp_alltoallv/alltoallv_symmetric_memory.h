...
namespace hccl {
class AlltoAllVSymmetricMemory : public AlgTemplateBase {
public:
    explicit AlltoAllVSymmetricMemory(const HcclDispatcher dispatcher);
    ~AlltoAllVSymmetricMemory() override;
