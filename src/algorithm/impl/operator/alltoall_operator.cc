...
HcclResult AlltoAllOperator::SetExcutorExtraInfo(const std::string& algName, const OpParam& param)
{
    ...
    return alltoAllExecutor->SetExcutorExtraInfo(
...
bool AlltoAllOperator::IsSatisfyAlltoallPipelineCondition()
{
    ...
    HCCL_DEBUG(
        ...
        multiRankPerServer, isMultiServer, satisfyAlgType, multiModuleDiffDeviceNumMode_);
    bool res
        = (deviceType_ == DevType::DEV_TYPE_910B && satisfyAlgType && multiRankPerServer
