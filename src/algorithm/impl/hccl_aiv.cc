...
using AivKernelArgs = struct AivKernelArgsDef {
   ...
   AivKernelArgsDef(void** buffIn, void** buffOut, const void* input, const void* output, u32 rank,
        u32 rankSize, u64 len, u32 dataType, u32 reduceOp, u32 root, s32 tag, s32 numBlocks, bool isOpBase = true,
        ...
        reduceOp(reduceOp), root(root), tag(tag), numBlocks(numBlocks), (isOpBase), bufferSize(bufferSize), aivRdmaStep(aivRdmaStep),
...
using AivKernelArgsV3 = struct AivKernelArgsV3Def {
   ...
   AivKernelArgsV3Def(void** buffIn, void** buffOut, const void* input, const void* output, u32 rank,
        ...
        u64 bufferSize = 200 * 1024 * 1024, s32 step = 0, s32 numBlocks, void* headCounterAddr = nullptr,
        ...
        step(step), numBlocks(numBlocks), deterministic(deterministic)
    {
