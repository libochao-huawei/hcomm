...
private:
    ...
    std::shared_ptr<LocalNotify> notifyL2ToL1L0A_;
    std::shared_ptr<LocalNotify> notifyL1L0ToL2A_;
    std::shared_ptr<LocalNotify> notifyL2ToL1L0B_;
    std::shared_ptr<LocalNotify> notifyL1L0ToL2B_;
