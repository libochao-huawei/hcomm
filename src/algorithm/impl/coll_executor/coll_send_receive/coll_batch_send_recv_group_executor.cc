    ...
    bool retryEnable, bool isSendStream, u32 sendStreamId)
{
    ...
    if (!isSendStream) {
        DeviceMem inMem(slice.addr, slize.size);
...
HcclResult CollBatchSendRecvGroupExecutor::ProcessSendStreamDataSlice(Stream& stream, bool needStreamSync, bool retryEnable)
{
