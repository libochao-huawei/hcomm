...
HcclResult hcclImpl::Init(bool isHeterogComm)
{
    ...
    commFactory_.reset(new (std::nothrow) CommFactory(
        ...
        topoType_, deviceType_, rankInfoList_, nicDeployment_, isHeterogComm, transportResourceInfoAddr_,
        transportResourceInfoSize_, meshAggregationRankSize_, isHaveCpuRank_, isUsedInterHccsMode_, useSuperPodMode_));
