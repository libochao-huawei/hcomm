...
/* 公共模块函数返回值定义，跟业务层同步 */
static const std::unordered_map<CommProtocol, std::string> HCOM_COMM_PROTOCOL_STR_MAP = {
...
static const std::unordered_map<CommEngine, std::string> HCOM_COMM_ENGINE_STR_MAP = {
