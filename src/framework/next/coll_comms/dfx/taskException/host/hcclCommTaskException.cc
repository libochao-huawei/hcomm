...
void TaskExceptionHost::PrintAicpuErrorMessage(rtExceptionInfo_t *exceptionInfo, bool &isExistAicpuError)
{
...
void TaskExceptionHost::PrintUbDfxInfo(rtExceptionInfo_t *exceptionInfo, const ErrorMessageReport &errorMessage) {
