...
// 把UB类错误码转换成Ts对应的错误码
uint16_t HcclCommTaskExceptionLite::SwitchUBCqeErrCodeToTsErrCode(u32 ubCqeErrCode) {
    switch (ubCqeErrCode) {
...
uint16_t HcclCommTaskExceptionLite::SwitchSdmaCqeErrCodeToTsErrCode(u32 sdmaCqeErrCode) {
    switch (sdmaCqeErrCode) {
