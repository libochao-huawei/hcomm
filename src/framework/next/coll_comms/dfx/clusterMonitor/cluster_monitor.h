...
struct ClusterUidCtxt {
    ...
    ClusterUidCtxt() {}
    ClusterUidCtxt(uint32_t netLayer, std::string &netInstanceId,
        s32 deviceLogicId, std::string &commAddrStr)
    : netLayer(netLayer), netInstanceId(netInstanceId),
        deviceLogicId(deviceLogicId), commAddrStr(commAddrStr)
    {}
};
