...
public:
    ...
    HcclResult RegisterCtxHandleToClusterMonitor(u32 devPhyId, CtxHandle handle);
...
private:
    ...
    std::mutex ctxHandleTableMtx_;
    std::unordered_map<u32, std::unordered_set<u64>> ctxHandleTable_;
};
} // namespace hcomm
