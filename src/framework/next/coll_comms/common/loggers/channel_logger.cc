...
namespace logger {
    ...
    void ChannelLogger::PrintDescTableHeader()
    {
        HCCL_INFO(
            "   "
            "_________________________________________________CHANNEL_DESCRIPTOR_INFO__________________________________"
            "_______________");
        HCCL_INFO(
            "   |  idx  | remoteRank | Proto |  notifyNum  | memHandleNum |              localAddr               |     "
    ...
    void ChannelLogger::PrintErrorTableHeader(uint32_t localRank)
    {
        HCCL_ERROR(
            "   "
            "________________________________________________CHANNEL_CONNECT_ERROR_INFO________________________________"
            "________________");
        ...
        int32_t status, uint64_t elapsedMs, Hccl::TlsStatus tlsStatus)
    {
        ...
        HCCL_ERROR(
            "   | %5u | %9u | %35s | %10u | %35s | 0x%08llx | %26s | %15s | %5d | %7llu |", idx, localRank,
