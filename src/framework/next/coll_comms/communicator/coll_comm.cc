...
HcclResult CollComm::RegisterSymmetricMemoryResource(void* ptr, size_t size, SymmetricChannelResource &resource)
{
    CHK_PTR_NULL(ptr);
    CHK_PRT_RET(size == 0,
...
void CollComm::UnregisterSymmetricMemoryResource(const SymmetricChannelResource &resource)
{
