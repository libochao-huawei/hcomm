...
private:
    ...
    HcclResult RegisterSymmetricMemoryResource(void* ptr, size_t size, SymmetricChannelResource &resource);
    void UnregisterSymmetricMemoryResource(const SymmetricChannelResource &resource);
