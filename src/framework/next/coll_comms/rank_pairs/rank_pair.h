...
class RankPair {
public:
    RankPair(RankIdPair rankIdPair, std::shared_ptr<std::unordered_map<u32, std::unordered_map<Hccl::IpAddress, u32>>> rankIpPortMap):
        localRankId_(rankIdPair.first), remoteRankId_(rankIdPair.second), rankIpPortMap_(rankIpPortMap) {}
    ~RankPair() = default;
