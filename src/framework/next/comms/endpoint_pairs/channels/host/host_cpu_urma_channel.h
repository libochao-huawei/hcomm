...
#include "../../../../../../legacy/unified_platform/resource/buffer/local_ub_rma_buffer.h"
...
class HostCpuUrmaChannel final : public Channel {
public:
    MAKE_ENUM(RdmaStatus, INIT, SOCKET_OK, QP_CREATED,  DATA_EXCHANGE, QP_MODIFIED, CONN_OK)

    HostCpuUrmaChannel(EndpointHandle endpointHandle, HcommChannelDesc channelDesc);
    ~HostCpuUrmaChannel();
...
private:
    ...
    std::vector<std::unique_ptr<HostUbConnection>> connections_{};
