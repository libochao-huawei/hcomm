...
private:
    ...
    HcclResult GetLocSeg(const void *addr, const size_t size, uint64_t *seg);
    ...
    HcclResult GetLocalAndRemoteSeg(urma_opcode_t opcode, void *dst, const void *src, uint64_t len, uint64_t &localSeg, uint64_t &remoteSeg);
