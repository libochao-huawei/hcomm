...
private:
    ...
    static HcclResult WithChannelByHandle(ChannelHandle handle, Func &&func);
    ...
    static HcclResult RemoveSingleChannel(ChannelHandle handle, std::vector<ChannelHandle> &deviceHandles);
};
