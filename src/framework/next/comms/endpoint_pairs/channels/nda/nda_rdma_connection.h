...
#include "nda_vendor_ub_ops.h"
#include "nda_vendor_pcie_ops.h"
...
public:
    ...
    // 数据面
    void Write(const RmaBufSliceLite &loc, const RmtRmaBufSliceLite &rmt, u64 &dbVa, u64 &dbValue);
    void WriteWithNotify(const RmaBufSliceLite &loc, const RmtRmaBufSliceLite &rmt, uint32_t remoteNotifyId, u64 &dbVa, u64 &dbValue);
