...
 */
#ifndef AICPU_TS_ROCE_CHANNEL_LITE_H
#define AICPU_TS_ROCE_CHANNEL_LITE_H
...
class AicpuTsRoceChannelLite {
public:
    explicit AicpuTsRoceChannelLite(std::vector<char> &uniqueId);

    ~AicpuTsRoceChannelLite();
