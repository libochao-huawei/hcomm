...
HcclResult EndpointPairMgr::Get(const EndpointDescPair &endpointDescPair, EndpointPair*& out, std::unordered_map<u32, std::unordered_map<IpAddress, u32>>& rankListenPortMap)
{
