...
public:
    ...
    HcclResult MakeSocketInUse(const Hccl::SocketConfig &socketConfig);
    void PutSocket(Hccl::Socket*& socket);
...
private:
    ...
    std::unordered_map<Hccl::SocketConfig, bool> socketInUseMap_{};
    std::mutex mutex_{};
