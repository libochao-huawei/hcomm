...
public:
    ...
    HcclResult MemoryGrant(void* memHandle, const HcommMemGrantInfo *remoteGrantInfo) override;
...
private:
    ...
    // for MemoryUnimport
    std::unordered_map<EndpointDesc, std::unique_ptr<RemoteIpcRmaBufferMgr>> remoteIpcRmaBufferMgrs_;
};
}
