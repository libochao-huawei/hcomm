...
HcclResult RoceRegedMemMgr::RegisterMemory(HcommMem mem, const char *memTag, void **memHandle)
{
    ...
    if (findPair.first) {
        ...
        return RegSubset<LocalRdmaRmaBufferMgr, Hccl::LocalRdmaRmaBuffer, Hccl::VirtualLocalRdmaRmaBuffer>(
            *localRdmaRmaBufferMgr_, existingBuffer, allRegisteredBuffers_,
