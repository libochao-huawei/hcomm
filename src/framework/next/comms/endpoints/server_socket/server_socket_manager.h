...
public:
    ...
    HcclResult ServerSocketStartListen(const Hccl::PortData& localPort, const Hccl::NicType nicType, const uint32_t devPhyId, const uint32_t port, uint32_t *actualPort = nullptr);
