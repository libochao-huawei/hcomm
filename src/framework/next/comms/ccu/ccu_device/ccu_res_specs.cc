...
HcclResult CcuGetMainboardId(uint32_t deviceLogicId, HcclMainboardId& hcclMainboardId)
{
    ...
    HCCL_INFO(
        "[%s] deviceLogicId[%d] mainboardId[%llu] hcclMainboardId[%s].", __func__, deviceLogicId, mainboardId,
...
bool CcuResSpecifications::GetArmX86Flag() const { return armX86Flag_; }
