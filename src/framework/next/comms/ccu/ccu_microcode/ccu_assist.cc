...
namespace CcuRep {
    ...
    uint16_t GetCcuDataType(Hccl::DataType dataType, Hccl::ReduceOp reduceOp)
    {
        static std::map<Hccl::DataType, uint16_t> ccuSumDataTypeMap = {
            {Hccl::DataType::FP32, 0},
            {Hccl::DataType::FP16, 1},
            {Hccl::DataType::BFP16, 2},
            {Hccl::DataType::HIF8, 3},
            {Hccl::DataType::FP8E4M3, 4},
            {Hccl::DataType::FP8E5M2, 5},
            {Hccl::DataType::INT8, 6},
            {Hccl::DataType::UINT8, 7},
            {Hccl::DataType::INT16, 8},
