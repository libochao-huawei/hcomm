...
namespace CcuRep {
    ...
    void LoopGroupInstr(
        CcuInstr *instr, uint16_t startLoopInstrId, uint16_t xnId, uint16_t xmId, uint16_t highPerfModeEn)
    {
    ...
    void ClearCKEInstr(CcuInstr *instr, uint16_t clearCKEId, uint16_t clearMask, uint16_t waitCKEId,
    ...
    void TransLocMemToLocMSInstr(CcuInstr *instr, uint16_t locMSId, uint16_t locGSAId, uint16_t locXnId,
        uint16_t lengthXnId, uint16_t channelId, uint16_t setCKEId, uint16_t setCKEMask, uint16_t waitCKEId,
    ...
    void TransLocMSToRmtMSInstr(CcuInstr *instr, uint16_t rmtMSId, uint16_t locMSId, uint16_t lengthXnId,
        uint16_t channelId, uint16_t setRmtCKEId, uint16_t setRmtCKEMask, uint16_t setCKEId, uint16_t setCKEMask,
    ...
    // 数据长度: length
    // 路径: channelId
    void TransRmtMemToLocMemInstr(CcuInstr *instr, uint16_t locGSAId, uint16_t locXnId, uint16_t rmtGSAId,
        uint16_t rmtXnId, uint16_t lengthXnId, uint16_t channelId, uint16_t reduceDataType, uint16_t reduceOpCode,
        uint16_t setCKEId, uint16_t setCKEMask, uint16_t waitCKEId, uint16_t waitCKEMask, uint16_t clearType,
        uint16_t lengthEn, uint16_t reduceEn)
    {
    ...
    // 数据长度: length
    // 路径: channelId
    void TransLocMemToRmtMemInstr(CcuInstr *instr, uint16_t rmtGSAId, uint16_t rmtXnId, uint16_t locGSAId,
        uint16_t locXnId, uint16_t lengthXnId, uint16_t channelId, uint16_t reduceDataType, uint16_t reduceOpCode,
        uint16_t setCKEId, uint16_t setCKEMask, uint16_t waitCKEId, uint16_t waitCKEMask, uint16_t clearType,
        uint16_t lengthEn, uint16_t reduceEn)
    {
    ...
    void TransLocMemToLocMemInstr(CcuInstr *instr, uint16_t dstGSAId, uint16_t dstXnId, uint16_t srcGSAId,
        uint16_t srcXnId, uint16_t lengthXnId, uint16_t channelId, uint16_t setCKEId, uint16_t setCKEMask,
        uint16_t waitCKEId, uint16_t waitCKEMask, uint16_t clearType, uint16_t lengthEn)
    {
    ...
    // castEn: 输出是否截断
    // dataType: Reduce数据类型
    void AddInstr(CcuInstr *instr, uint16_t *msId, uint16_t count, uint16_t castEn, uint16_t dataType,
        uint16_t setCKEId, uint16_t setCKEMask, uint16_t waitCKEId, uint16_t waitCKEMask, uint16_t clearType,
        uint16_t XnIdLength)
    {
    ...
    static std::string ParseSetCKEInstr(const CcuInstr *instr)
    {
        ...
        return Hccl::StringFormat("Wait CKE[%u:%04x], Set CKE[%u:%04x], clearType[%u]", waitCKEId, waitCKEMask,
    ...
    static std::string ParseClearCKEInstr(const CcuInstr *instr)
    {
        ...
        return Hccl::StringFormat("Wait CKE[%u:%04x], Clear CKE[%u:%04x], clearType[%u]", waitCKEId, waitCKEMask,
            clearCKEId, clearMask, clearType);
    }
    ...
    static std::string ParseJumpInstr(const CcuInstr *instr)
    {
        ...
        return Hccl::StringFormat("When conditionXn[%u] not equal to expectData[%llu], Jump To InstrIdXn[%u]",
            conditionXnId, expectData, dstInstrXnId);
    }
