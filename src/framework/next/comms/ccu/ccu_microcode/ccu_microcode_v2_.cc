...
namespace CcuRep {
    namespace CcuV2 {
        ...
        inline void Operator(
            CcuInstr *instr, uint16_t xdId, uint16_t xnId, uint16_t xmId, uint16_t setCKEId, uint16_t setCKEMask)
        {
        ...
        void Add(CcuInstr *instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId,
            uint16_t setCKEMask)
        {
        ...
        void AddI(
            CcuInstr *instr, uint16_t result, uint16_t operand, uint16_t imm, uint16_t setCKEId, uint16_t setCKEMask)
        {
            instr->header = InstrHeader(LOAD_TYPE, ADD_CODE);
        ...
        void Mul(CcuInstr *instr, uint16_t result, uint16_t operand1, uint16_t operand2, uint16_t setCKEId,
            uint16_t setCKEMask)
        {
        ...
        void ClearCKE(CcuInstr *instr, uint16_t clearCKEId, uint16_t clearMask, uint16_t waitCKEId,
        ...
        // 本端Memory传输到本端MS
        void TransLocMemToLocMS(CcuInstr *instr, uint16_t ms, uint16_t src, uint16_t srcToken, uint16_t len,
            uint16_t offset, uint16_t setCKEId, uint16_t setCKEMask, const CacheConfig &cacheConfig)
        {
        ...
        // 本端MS传输到本端Memory
        void TransLocMSToLocMem(CcuInstr *instr, uint16_t dst, uint16_t dstToken, uint16_t ms, uint16_t len,
            uint16_t offset, uint16_t setCKEId, uint16_t setCKEMask, const CacheConfig &cacheConfig)
        {
        ...
        void TransLocMemToLocMem(CcuInstr *instr, uint16_t dst, uint16_t dstToken, uint16_t src, uint16_t srcToken,
            uint16_t len, uint16_t usedMSId, uint16_t setCKEId, uint16_t setCKEMask, const CacheConfig &srcCacheConfig,
        ...
        // 将本端Xn的值写入远端8B地址
        inline void SyncWtX(CcuInstr *instr, uint16_t dst, uint16_t dstToken, uint16_t xn, uint16_t channelId,
        ...
        void SyncAtX(CcuInstr *instr, uint16_t dst, uint16_t dstToken, uint16_t mask, uint16_t channelId,
            uint16_t setCKEId, uint16_t setCKEMask)
        {
        ...
        // MSA~MSH Reduce到 MSA
        inline void Reduce(CcuInstr *instr, uint16_t *ms, uint16_t count, uint16_t castEn, uint16_t dataType,
            uint16_t setCKEId, uint16_t setCKEMask)
        {
        ...
        void ReduceAdd(CcuInstr *instr, uint16_t *ms, uint16_t count, uint16_t castEn, uint16_t dataType,
            uint16_t setCKEId, uint16_t setCKEMask)
        {
