...
HcclResult CcuTransport::GetUserRemoteMem(CommMem** remoteMem, char*** memTags, uint32_t* memNum)
{
    ...
    Hccl::RemoteMemCtx<CclBufferInfo> remoteMemCtx{userMemCount,    cacheValid_, rmtBufferInfos_, remoteUserMemTag_,
                                                   remoteUserMems_, tagCopies_,  tagPointers_,    cacheBuilder,
                                                   remoteMem,       memTags,     memNum};
