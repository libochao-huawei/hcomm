...
public:
    ...
    HcclResult GetDeviceCount(uint32_t& deviceCount) const;

    HcclResult VisitBaseCommRes(const std::function<HcclResult(BaseCommRes*)>& visitor);
