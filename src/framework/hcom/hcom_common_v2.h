...
HcclResult __attribute__((weak)) HcomGetCommV2(void **comm);
HcclResult __attribute__((weak)) HcommGetGroupParamsV2(const char *group, void* groupParams, void **commV2);
