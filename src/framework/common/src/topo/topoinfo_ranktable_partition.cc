/*
聽* This program is free software, you can redistribute it and/or modify it.
聽* Copyright (c) 2025 Huawei Technologies Co., Ltd.
聽* This file is a part of the CANN Open Software.
聽* Licensed under CANN Open Software License Agreement Version 2.0 (the "License").
聽* Please refer to the License for details. You may not use this file except in compliance with the License.
聽* THIS SOFTWARE IS PROVIDED ON AN "AS IS" BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO NON-INFRINGEMENT, MERCHANTABILITY, OR FITNESS FOR A PARTICULAR PURPOSE.
