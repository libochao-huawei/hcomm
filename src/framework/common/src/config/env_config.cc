...
{
    return ParseUbTimeOutCommon(uboeTimeOutRange, MM_ENV_HCCL_UBOE_TIMEOUT, "HCCL_UBOE_TIMEOUT",
        HCCL_UBOE_TIMEOUT_DEFAULT, HCCL_UBOE_TIMEOUT_MIN, HCCL_UBOE_TIMEOUT_MAX, g_envConfig.uboeTimeOut);
}

HcclResult EnvConfig::ParseUBTimeOut(std::pair<u32, u32> &ubTimeOutRange)
{
    return ParseUbTimeOutCommon(ubTimeOutRange, MM_ENV_HCCL_UB_TIMEOUT, "HCCL_UB_TIMEOUT", HCCL_UB_TIMEOUT_DEFAULT,
        HCCL_UB_TIMEOUT_MIN, HCCL_UB_TIMEOUT_MAX, g_envConfig.ubTimeOut);
}
