...
const std::map<RetryState, RetryState> RETRY_SERVER_STATE_TRANSFER_LABEL_PARTIAL {
    ...
    {RETRY_STATE_CMD_CAN_PARTIAL_RETRY, RETRY_STATE_WAIT_CAN_PARTIAL_RETRY},
    {RETRY_STATE_WAIT_CAN_PARTIAL_RETRY, RETRY_STATE_ISSUE_PARTIAL_RETRY_INFO},
    {RETRY_STATE_ISSUE_PARTIAL_RETRY_INFO, RETRY_STATE_WAIT_ISSUE_PARTIAL_RETRY_INFO},
    {RETRY_STATE_WAIT_ISSUE_PARTIAL_RETRY_INFO, RETRY_STATE_CMD_CAN_RETRY}
};
