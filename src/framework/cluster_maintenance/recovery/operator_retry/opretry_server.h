...
// 只用于局部重执行下的server状态切换
const std::map<RetryState, RetryState> RETRY_SERVER_STATE_TRANSFER_LABEL_PARTIAL {
    {RETRY_STATE_CHECK_OP, RETRY_STATE_CMD_CAN_PARTIAL_RETRY},
    {RETRY_STATE_CMD_CAN_PARTIAL_RETRY, RETRY_STATE_WAIT_RESP_CAN_PARTIAL_RETRY},
    {RETRY_STATE_WAIT_RESP_CAN_PARTIAL_RETRY, RETRY_STATE_ISSUE_PARTIAL_RETRY_INFO},
    {RETRY_STATE_ISSUE_PARTIAL_RETRY_INFO, RETRY_STATE_WAIT_RESP_PARTIAL_RETRY_INFO},
    {RETRY_STATE_WAIT_RESP_PARTIAL_RETRY_INFO, RETRY_STATE_CMD_CAN_RETRY}
};
...
// 只用于局部重执行下的 IssueCmd状态对应的command
const std::map<RetryState, RetryCommand> RETRY_SERVER_STATE_TO_CMD_LABEL_PARTIAL {
    {RETRY_STATE_CMD_CAN_PARTIAL_RETRY, RETRY_CMD_CAN_PARTIAL_RETRY}
};
