...
typedef enum {
    ...
    RETRY_STATE_CMD_CAN_PARTIAL_RETRY, // 通知agent准备局部重执行
    RETRY_STATE_WAIT_CAN_PARTIAL_RETRY, // 确认agent准备完毕
    RETRY_STATE_ISSUE_PARTIAL_RETRY_INFO, // 将局部重执行信息发送给agent
    RETRY_STATE_WAIT_ISSUE_PARTIAL_RETRY_INFO, // 确认agent接收完毕
    ...
    RETRY_STATE_RESP_CAN_PARTIAL_RETRY, // 通知server局部重执行准备完毕
    RETRY_STATE_WAIT_PARTIAL_RETRY_INFO, // 等待server发送局部重执行信息
    RETRY_STATE_RESP_PARTIAL_RETRY_INFO, // 通知server局部重执行信息接收完毕
...
const std::map<RetryState, std::string> RETRY_STATE_STR_MAP {
    ...
    {RETRY_STATE_CMD_CAN_PARTIAL_RETRY, "RETRY_STATE_CMD_CAN_PARTIAL_RETRY"},
    {RETRY_STATE_WAIT_CAN_PARTIAL_RETRY, "RETRY_STATE_WAIT_CAN_PARTIAL_RETRY"},
    {RETRY_STATE_ISSUE_PARTIAL_RETRY_INFO, "RETRY_STATE_ISSUE_PARTIAL_RETRY_INFO"},
    {RETRY_STATE_WAIT_ISSUE_PARTIAL_RETRY_INFO, "RETRY_STATE_WAIT_ISSUE_PARTIAL_RETRY_INFO"},
    ...
    {RETRY_STATE_RESP_CAN_PARTIAL_RETRY, "RETRY_STATE_RESP_CAN_PARTIAL_RETRY"},
    {RETRY_STATE_WAIT_PARTIAL_RETRY_INFO, "RETRY_STATE_WAIT_PARTIAL_RETRY_INFO"},
    {RETRY_STATE_RESP_PARTIAL_RETRY_INFO, "RETRY_STATE_RESP_PARTIAL_RETRY_INFO"},
...
typedef enum {
    ...
    RETRY_CMD_CAN_RETRY,
    RETRY_CMD_CAN_PARTIAL_RETRY, // server通知agent准备局部重执行
...
const std::map<RetryCommand, std::string> RETRY_COMMAND_STR_MAP {
    ...
    {RETRY_CMD_CAN_PARTIAL_RETRY, "RETRY_CMD_CAN_PARTIAL_RETRY"},
...
const std::map<RetryState, RetryState> RETRY_SERVER_WAIT_AGENT_STATE_LABEL {
    ...
    {RETRY_STATE_WAIT_CAN_PARTIAL_RETRY, RETRY_STATE_RESP_CAN_PARTIAL_RETRY}, // agent准备局部重执行完毕, 发送resp
    {RETRY_STATE_WAIT_ISSUE_PARTIAL_RETRY_INFO, RETRY_STATE_RESP_PARTIAL_RETRY_INFO}, // agent接收局部重执行信息, 发送resp
