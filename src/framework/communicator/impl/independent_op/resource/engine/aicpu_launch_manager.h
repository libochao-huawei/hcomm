...
constexpr uint32_t NOTIFY_UNIQUE_ID_MAX_SIZE = THREAD_UNIQUE_ID_MAX_SIZE * hccl::HCCL_NOTIFY_MAX_NUM;
constexpr uint32_t NOTIFY_DEVCIE_ID_MAX_SIZE = 21  * hccl:HCCL_NOTIFY_MAX_NUM;
