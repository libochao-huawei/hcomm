...
private:
    ...
    HcclResult SupplementNotify(CommEngine engine, uint32_t threadNum, ThreadType type, const ThreadCongif *config);
    HcclResult SupplementThread(CommEngine engine, uint32_t supplementThreadNum, ThreadType type, const ThreadCongif *config);
