...
public:
    ...
    HcclResult GetLinks(
        uint32_t netLayer, uint32_t srcRank, uint32_t dstRank, CommLink **linkList, uint32_t *listSize) override;
    ...
    std::set<CommProtocol> GetProtocolsByConnections(
