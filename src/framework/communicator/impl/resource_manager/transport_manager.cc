    ...
    const HcclCMDType &opType, bool isIndOp)
{
    ...
    for (auto iter = subCommLinkPara.remoteRankMap.begin(); iter != subCommLinkPara.remoteRankMap.end(); ++iter) {
    ...
    bool isCapture, const HcclCMDType &opType, bool isIndOp)
{
    ...
    for (auto iter = nextSubCommLinkPara.remoteRankMap.begin(); iter != nextSubCommLinkPara.remoteRankMap.end(); ++iter) {
