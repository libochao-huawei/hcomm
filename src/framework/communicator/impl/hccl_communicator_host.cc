...
namespace hccl
{
    ...
    */
    ...
    HcclResult HcclCommunicator::AllocAlgResource(const std::string &newTag, HcclCMDType opType, const OpParam &opParam,
        AlgResourceRequest &resRequest, AlgResourceResponse &algResResponse, bool selectAivAlg = false, bool isZeroCopy)
    {
        HcclResult ret = HCCL_SUCCESS;
        ...
        if ((GetWorkflowMode() == HcclWorkflowMode::HCCL_WORKFLOW_MODE_OPS_KERNEL_INFO_LIB &&
            !IsForceAicpuOpBaseMode(opParam, opType)) || (OpParam.supportSymmetricMemory && !isZeroCopy)) {
