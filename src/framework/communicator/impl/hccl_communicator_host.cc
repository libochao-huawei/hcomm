...
namespace hccl
{
    ...
    */
    ...
    HcclResult HcclCommunicator::RegisterToSnapshot()
    {
        ...
        if (IsEnableBackupLink()) {
            CHK_RET(SnapshotControl::GetInstance(deviceLogicId_).RegsiterBackup(identifier_, deviceBackUpPhyId_));
        }
        return HCCL_SUCCESS;
    }
    ...
    HcclResult HcclCommunicator::UnRegisterFromSnapshot()
    {
        ...
        if (IsEnableBackupLink()) {
            CHK_RET(SnapshotControl::GetInstance(deviceLogicId_).UnRegsiterBackup(identifier_, deviceBackUpPhyId_));
        }
        return HCCL_SUCCESS;
    }
