...
namespace hccl
{
    ...
    */
    ...
    HcclResult HcclCommunicator::AllocAlgResource(const std::string &tag, HcclCMDType opType, const OpParam &opParam,
        AlgResourceRequest &resRequest, AlgResourceResponse &algResResponse, bool isNeedHostSlaveStream, bool isZeroCopy)
    {
