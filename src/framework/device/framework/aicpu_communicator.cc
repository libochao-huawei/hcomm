    ...
    const HcclOpResParam *commParam, OpParam& opParam)
{
    ...
    if (opParam.opType == HcclCMDType::HCCL_CMD_BATCH_SEND_RECV) {
        ...
        // TODOSSY: debug
        HCCL_INFO("[HcclCommAicpu][DeserializeOpParam] sendCountMatrixPtr[%p] sendCountMatrixPtr[0][%llu] "
            ...
            sizeof(struct OpTilingData), reinterpret_cast<u64>(dynamicDataPtr - tilingData), opTilingDataPtr->length);
