    ...
    KfcError &errorCode, uint32_t &beginSqePos, uint32_t &endSqePos, uint32_t retryCnt)
{
    ...
    // CHK_RET(AicpuAsyncUnfolder::GetAsyncUnfoldKey(param, curAsyncUnfoldKey)); // TODOSSY: segfault
    AsyncUnfoldCacheEntry* curAsyncUnfoldCacheEntryPtr = nullptr;
    // AsyncUnfoldCache& asyncUnfoldCache = aicpuAsyncUnfolder_.GetAsyncUnfoldCache(); // TODOSSY: segfault
    // CHK_RET(asyncUnfoldCache.FindAsyncUnfoldEntry(curAsyncUnfoldKey, &curAsyncUnfoldCacheEntryPtr)); // TODOSSY: segfault
    ...
    if (applyAsyncUnfold) {
        // CHK_RET(asyncUnfoldCache.ClearAsyncUnfoldEntry(curAsyncUnfoldKey)); // TODOSSY: segfault
    }
...
{
    HCCL_INFO("[TODOSSY] OrchestrateHcclOp applyAsyncUnfold:%d, asyncUnfoldCacheEntryPtr:%p", 
        applyAsyncUnfold, asyncUnfoldCacheEntryPtr); // TODOSSY: segfault
