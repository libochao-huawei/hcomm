    ...
    KfcError &errorCode, uint32_t &beginSqePos, uint32_t &endSqePos, uint32_t retryCnt)
{
    ...
    CHK_RET(curAsyncUnfoldKey.Init(param.opBaseOpIdx, param.opType, param.dataType));
    ...
    const HcclOpResParam *commParam)
{
    ...
    do {
        ...
        if (aicpuAsyncUnfolder_.IsAsyncUnfoldEnable()) {
            ...
            CHK_RET(nextAsyncUnfoldKey.Init(validOpBaseOpIdx, nextParam.opType, nextParam.dataType));
