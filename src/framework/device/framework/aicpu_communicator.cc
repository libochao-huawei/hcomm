    ...
    std::string &tag, const uint32_t &beginSqePos, OpParam &param)
{
    ...
    do {
        ...
        if (aicpuAsyncUnfolder_.IsAsyncUnfoldEnable()) {
            ...
            // TODO: 对相邻后续算子校验异步展开约束by UpdateAsyncUnfoldFlag
            ...
            // TODO: 根据OpAsyncUnfoldInfo构造AsyncUnfoldKey
            ...
            const std::string nextAlgName = ""; // TODO: 根据OpAsyncUnfoldInfo获得algName
            OpParam nextParam; // TODO: 根据OpAsyncUnfoldInfo获得opParam
            CHK_RET(OrchestrateHcclOp(nextAlgName, nextParam,
std::unique_ptr<CollExecutorBase> &executor, AlgResourceResponse &algResource, uint32_t &beginSqePos,
