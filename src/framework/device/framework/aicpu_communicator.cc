    ...
    std::string &tag, const uint32_t &beginSqePos, OpParam &param)
{
    ...
    do {
        ...
        if (aicpuAsyncUnfolder_.IsAsyncUnfoldEnable()) {
            ...
            // TODO: 触发异步展开生成阶段, 将展开的SQE保存为AsyncUnfoldCache中的new entry
            const std::string nextAlgName = ""; // TODO: 根据OpAsyncUnfoldInfo获得algName
            OpParam nextParam; // TODO: 根据OpAsyncUnfoldInfo获得opParam
            std::unique_ptr<CollExecutorBase> nextExecutor = nullptr; // TODO: 根据OpAsyncUnfoldInfo获得executor
            AlgResourceResponse nextAlgResource; // TODO: 根据OpAsyncUnfoldInfo获得algResource
