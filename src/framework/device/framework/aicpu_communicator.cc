...
HcclResult HcclCommAicpu::HcclOpExecFsmWaitEndProcess(OpParam &param, const std::string& algName, HcclOpResParam *commParam,
...
HcclResult HcclCommAicpu::BackupHcclCommAicpuBeforeAsyncUnfold(const OpParam &param, const std::string &algName)
{
    ...
    asyncUnfoldBackup_.inplaceSupportRetry = algOpContext_.opRetryHandler.inplaceSupportRetry;
    asyncUnfoldBackup_.retryEnable = algOpContext_.opRetryHandler.retryEnable;
    asyncUnfoldBackup_.inPlaceSupportRetryStatus = algOpContext_.opRetryHandler.inPlaceSupportRetryStatus;
    asyncUnfoldBackup_.isInplacePreSync = algOpContext_.opRetryHandler.isInplacePreSync;
    asyncUnfoldBackup_.isPostSync = algOpContext_.opRetryHandler.isPostSync;
    ...
    const HcclOpResParam *commParam)
{
    ...
    CHK_RET(hcclCommAicpu->ParseHierarchicalAlgOption(asyncUnfoldBackup_.ahcConfInfo));
    ...
    HcclOpResParam *commParam)
{
    ...
    do {
        ...
        if (aicpuAsyncUnfolder_.IsAsyncUnfoldEnable()) {
            ...
            AlgResourceResponse nextAlgResource;
