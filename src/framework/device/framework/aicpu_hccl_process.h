...
public:
    ...
    static HcclResult AicpuIndOpChannelDestroyV2Inner(HcclChannelUrmaRes *commParam);
    ...
    static HcclResult AicpuIndOpThreadDestroyInner(ThreadMgrAicpuParam *param);
