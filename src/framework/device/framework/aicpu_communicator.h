...
private:
    ...
    // 获取指定索引的算子信息
    const AicpuOpInfo* GetOpInfoFromSqIdx(u32 sqIdx, SqeRingBuffer *sqeContextBuffer) const;
    ...
    // 打印算子数据信息
    void PrintOpDataInfo(u32 sqIdx, SqeRingBuffer *sqeContextBuffer, bool isMonitor) const;
