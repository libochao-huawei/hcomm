...
if(NOT BUILD_OPEN_PROJECT OR (BUILD_OPEN_PROJECT AND KERNEL_MODE))
    ...
    set(CCL_KERNEL_SRC_LIST
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/resource_manager/share_ccl_buffer_manager.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/asymmetric_hierarchical_concatenate_base.cc
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/asymmetric_hierarchical_concatenate_nslb.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/temp_all_gather/all_gather_hccs_sio.cc
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/temp_all_gather/all_gather_graph_pipeline.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/temp_alltoall/alltoall_symmetric_memory.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/temp_alltoallv/alltoallv_continuous_pipeline.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/temp_reduce_scatter/reduce_scatter_plant_local_reduce.cc
        ${HCCL_BASE_DIR}/algorithm/base/alg_template/temp_reduce_scatter/reduce_scatter_plant_local_reduce_combine.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_reduce/coll_all_reduce_ars_for_910_93_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_reduce/coll_all_reduce_mid_count_for_910_93_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_reduce/coll_all_reduce_order_preserved_for_910_93_executor.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_gather/coll_all_gather_hccs_sio_executor.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_gather/coll_all_gather_ring_zerocopy_pipeline_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_gather/coll_all_gather_ars_for_910_93_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_gather/coll_all_gather_mid_count_for_910_93_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_gather/coll_all_gather_mesh_graph_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_gather/coll_all_gather_mesh_graph_pipeline_executor.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_reduce_scatter/coll_reduce_scatter_hccs_sio_executor.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_reduce_scatter/coll_reduce_scatter_ring_zerocopy_exchange_pipeline_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_reduce_scatter/coll_reduce_scatter_order_preserved_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_reduce_scatter/coll_reduce_scatter_ars_for_910_93_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_reduce_scatter/coll_reduce_scatter_order_preserved_for_910_93_executor.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_send_receive/coll_batch_send_recv_group_executor.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_to_all/coll_all_to_all_symmetric_memory_executor.cc
        ...
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_to_all/coll_all_to_all_v_continuous_pipeline_executor.cc
        ${HCCL_BASE_DIR}/algorithm/impl/coll_executor/coll_all_to_all/coll_all_to_all_v_staged_executor.cc
        ...
        #framework
        ${HCCL_BASE_DIR}/framework/communicator/impl/independent_op/hccl_independent_rank_graph.cc
...
if(NOT BUILD_OPEN_PROJECT)
    # orion仓依赖
    FILE(GLOB_RECURSE sources_list LIST_DIRECTORIES TRUE ${TOP_DIR}/ace/comop/hccl/orion/*)
    ...
    FILE(GLOB_RECURSE open_dir_list LIST_DIRECTORIES TRUE ${TOP_DIR}/ace/comop/hccl/whole/hccl_next/*)
...
if(BUILD_OPEN_PROJECT AND KERNEL_MODE)
    if(BUILD_OPEN_PROJECT)
        ...
        add_custom_command(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/libaicpu_custom.json
            COMMAND ${HI_PYTHON} ${HCCL_BASE_DIR}/../cmake/scripts/parser_ini.py ${HCCL_BASE_DIR}/../src/framework/device/framework/aicpu_custom.ini ${CMAKE_CURRENT_BINARY_DIR}/libaicpu_custom.json
...
if(DEVICE_MODE AND KERNEL_MODE)
    ...
    target_include_directories(aicpu_custom PRIVATE ${AICPU_CUSTOM_INCLUDE_LIST})
