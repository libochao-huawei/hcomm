...
public:
    ...
    void SetUpdateFirstFlipPlaceholderSqIdxCallback(
        std::function<HcclResult(const int32_t, const int64_t)> updateFirstFlipPlaceholderSqIdxCallback)
    {
        updateFirstFlipPlaceholderSqIdxCallback_ = updateFirstFlipPlaceholderSqIdxCallback;
        return;
    }
...
private:
    ...
    std::function<HcclResult(const int32_t, const int64_t)> updateFirstFlipPlaceholderSqIdxCallback_ = nullptr;
};
} // namespace hccl
