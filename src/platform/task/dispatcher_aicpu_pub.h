...
public:
    ...
    HcclResult SetLaunchAsyncContext(const AsyncUnfoldKey& asyncUnfoldKey, AsyncUnfoldCache* asyncUnfoldCachePtr,
...
private:
    ...
    AsyncUnfoldKey asyncUnfoldKey_; // 异步展开的key
    AsyncUnfoldCache* asyncUnfoldCachePtr_ = nullptr; // 异步展开的cache pointer
