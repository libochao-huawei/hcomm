    ...
    Stream &stream)
{
    ...
    if (useSdmaToSignalRecord_) {
        ...
        return dispatcher_->SignalRecord(dstDevMem, notifyValueMem_[machinePara_.deviceLogicId], stream, 
            machinePara_.remoteWorldRank, transportAttr_.linkType, notifyInfo.resId);
    } else {
