...
struct RsCtxOps {
    ...
    int (*getDevEidInfoList)(unsigned int phyId, struct DevEidInfo infoList[], unsigned int startIndex,
        unsigned int count);
    ...
    int (*getTpInfoList)(struct RaRsDevInfo *devInfo, struct GetTpCfg *cfg, struct TpInfo infoList[],
        unsigned int *num);
    ...
    int (*ctxQpQueryBatch)(struct RaRsDevInfo *devInfo, unsigned int ids[], struct JettyAttr attr[],
        unsigned int *num);
    int (*ctxGetAuxInfo)(struct RaRsDevInfo *devInfo, struct AuxInfoIn *infoIn,
