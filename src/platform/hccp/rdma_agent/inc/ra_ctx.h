...
struct ra_ctx_ops {
    int (*ra_ctx_init)(struct ra_ctx_handle *ctx_handle, struct ctx_init_attr *attr, unsigned int *dev_index,
        struct dev_base_attr *dev_attr);
    ...
    int (*ra_ctx_chan_create)(struct ra_ctx_handle *ctx_handle, struct ra_chan_handle *chan_handle);
