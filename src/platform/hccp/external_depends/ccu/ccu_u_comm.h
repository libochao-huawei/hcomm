...
#define CCU_MEMTYPE_INS             ((ccum_memtype_bitmap)1ULL << 0)
#define CCU_MEMTYPE_GSA             ((ccum_memtype_bitmap)1ULL << 1)
#define CCU_MEMTYPE_XN              ((ccum_memtype_bitmap)1ULL << 2)
#define CCU_MEMTYPE_CKE             ((ccum_memtype_bitmap)1ULL << 3)
#define CCU_MEMTYPE_LOOP_CKE        ((ccum_memtype_bitmap)1ULL << 4)
#define CCU_MEMTYPE_PFE             ((ccum_memtype_bitmap)1ULL << 5)
#define CCU_MEMTYPE_CHN             ((ccum_memtype_bitmap)1ULL << 6)
#define CCU_MEMTYPE_JETTY_CTX       ((ccum_memtype_bitmap)1ULL << 7)
#define CCU_MEMTYPE_MISSION_CTX     ((ccum_memtype_bitmap)1ULL << 8)
#define CCU_MEMTYPE_LOOP_CTX        ((ccum_memtype_bitmap)1ULL << 9)
#define CCU_MEMTYPE_MISSION_SQE     ((ccum_memtype_bitmap)1ULL << 10)
#define CCU_MEMTYPE_CQE_BLOCK0      ((ccum_memtype_bitmap)1ULL << 11)
#define CCU_MEMTYPE_CQE_BLOCK1      ((ccum_memtype_bitmap)1ULL << 12)
#define CCU_MEMTYPE_CQE_BLOCK2      ((ccum_memtype_bitmap)1ULL << 13)
#define CCU_MEMTYPE_WQEBB           ((ccum_memtype_bitmap)1ULL << 14)
