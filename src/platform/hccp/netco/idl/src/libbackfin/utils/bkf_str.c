...
#define BKF_STR_GUARD_SET(head) do {                                                                    \
    (void)memcpy_s(BKF_STR_2GUARD(head), sizeof(g_BkfStrGuard), &g_BkfStrGuard, sizeof(g_BkfStrGuard)); \
} while (0)
#define BKF_STR_GUARD_CLR(head) do {                                                       \
