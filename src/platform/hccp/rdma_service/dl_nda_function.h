...
struct RsNdaOps {
    ...
    int (*rsNdaIbvDestroyQpExtend)(struct ibv_context_extend *context, struct ibv_qp_extend *qp_extend);
    int (*rsNdaIbvDestroyCqExtend)(struct ibv_context_extend *context, struct ibv_cq_extend *cq_extend);
};

DL_ATTRI_VISI_DEF int RsNdaApiInit(void);
DL_ATTRI_VISI_DEF void RsNdaApiDeinit(void);
struct ibv_context_extend * RsNdaIbvOpenExtend(struct ibv_context *context)
int RsNdaIbvOpenExtend(struct ibv_context *context);
