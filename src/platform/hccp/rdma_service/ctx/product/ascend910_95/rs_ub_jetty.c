...
STATIC int RsResAddrMunmap(struct RsCtxJettyCb *jettyCb, struct JettyVaInfo *vaInfo)
{
    ...
    resInfoIn.priv_len = sizeof(struct JettyVaInfo);
...
STATIC int RsResAddrMmap(struct RsCtxJettyCb *jettyCb, struct JettyVaInfo *vaInfo,
...
STATIC int RsMmapJettyVa(struct RsCtxJettyCb *jettyCb)
{
    ...
    struct JettyVaInfo jettyVaInfo = {0};
    struct JettyVaInfo dbVaInfo = {0};
    uint64_t dbOffset = 0;
    int ret = 0;
