...
struct DlHalOps {
    ...
    drvError_t (*dlHalHostRegister)(void *srcPtr, UINT64 size, UINT32 flag, UINT32 devId, void **dstPtr);
    drvError_t (*dlHalHostUnregister)(void *src_ptr, UINT32 devid);
};
...
int DlHalHostRegister(void *srcPtr, UINT64 size, UINT32 flag, UINT32 devId, void **dstPtr);
int DlHalHostUnRegister(void *srcPtr, UINT32 devId);
