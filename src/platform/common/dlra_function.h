...
public:
    ...
    std::function<int(QpHandle handle, struct VerbsSendWr *wr, struct SendWrRsp *opRsp)> dlRaSendWrVerbs;
    std::function<int(QpHandle handle, struct VerbsRecvWr *wr)> dlRaRecvWrVerbs;
