...
namespace hccl {
    ...
    HcclResult OpUnfoldCache::DumpSqeContent(const uint8_t *sqePtr, const uint8_t sqeType, const bool forceDump) {
        // 根据sqe type打印debug信息
        // 设置HCCL_DEBUG_CONFIG="task", 或者设置ASCEND_GLOBAL_LOG_LEVEL=0
        if ((UNLIKELY(GetExternalInputDebugConfig() & PLF_TASK)) || UNLIKELY(HcclCheckLogLevel(HCCL_LOG_DEBUG)) || forceDump) {
            CHK_PTR_NULL(sqePtr);

            switch(sqeType) {
                case SqeType::NOTIFY_SQE: {
                    const rtStarsNotifySqeV1_t *notifySqePtr = reinterpret_cast<const rtStarsNotifySqeV1_t *>(sqePtr);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsNotifySqeV1_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(notifySqePtr->header, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] notify_id[%u] res2[%u] res3[%u] kernel_credit[%u] res4[%u] timeout[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res5[0][%u] res5[1][%u] res5[2][%u] res5[3][%u] res5[4][%u] res5[5][%u]",
                        notifySqePtr->res5[0], notifySqePtr->res5[1], notifySqePtr->res5[2], notifySqePtr->res5[3], notifySqePtr->res5[4], notifySqePtr->res5[5]);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res5[6][%u] res5[7][%u] res5[8][%u] res5[9][%u] res5[10][%u]",
                ...
                case SqeType::RDMA_DB_SEND_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsWriteValueSqe_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(writeValueSqePtr->header, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res3[%u] res4[%u] kernel_credit[%u] res5[%u] write_addr_low[0x%08x] write_addr_high[0x%08x]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res6[%u] awsize[%u] snoop[%u] awcache[%u] awprot[%u] va[%u] res7[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] sub_type[%u] write_value_part0[%u] write_value_part1[%u] rdmaWrLenth[%u] rdmaType[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] write_value_part4[%u] write_value_part5[%u] write_value_part6[%u] write_value_part7[%u]",
                ...
                case SqeType::EVENT_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsEventSqe_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(eventSqePtr->header, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] eventId[%u] res2[%u] res3[%u] kernel_credit[%u] res4[%u] exe_result[%u] timeout[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res5[0][%u] res5[1][%u] res5[2][%u] res5[3][%u] res5[4][%u]",
                        eventSqePtr->res5[0], eventSqePtr->res5[1], eventSqePtr->res5[2], eventSqePtr->res5[3], eventSqePtr->res5[4]);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res5[5][%u] res5[6][%u] res5[7][%u] res5[8][%u] res5[9][%u]",
                ...
                case SqeType::MEMCPY_ASYNC_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsMemcpyAsyncSqe_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(memcpyAsyncSqePtr->header, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res3[%u] res4[%u] kernel_credit[%u] ptr_mode[%u] res5[%u] opcode[%u] ie2[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] sssv[%u] dssv[%u] sns[%u] dns[%u] qos[%u] sro[%u] dro[%u] partid[%u] mpam[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res6[%u] src_streamid[%u] src_sub_streamid[%u] dst_streamid[%u] dst_sub_streamid[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] length[%u] src_addr_low[0x%08x] src_addr_high[0x%08x] dst_addr_low[0x%08x] dst_addr_high[0x%08x]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] linkType[%u] resvered[0][%u] resvered[1][%u] resvered[2][%u] reslast[0][%u] reslast[1][%u] reslast[2][%u]",
                ...
                case SqeType::CCORE_WAIT_START_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsCcoreWaitStartSqe_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(ccoreWaitStartSqePtr->sqeHeader, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] reserved0[%u] reserved1[%u] kernel_credit[%u] reserved2[%u] csc[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] ldrImm1: opCode[%u] rd[%u] reserved[%u] func3[%u] immdAddrHigh[0x%08x] immdAddrLow[0x%08x]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] ldrImm2: opCode[%u] rd[%u] reserved[%u] func3[%u] immdAddrHigh[0x%08x] immdAddrLow[0x%08x]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] beq: opCode[%u] jumpInstrOffset[%u] rsvd[%u] func3[%u] rs1[%u] rsvd1[%u] rs2[%u] rsvd2[%u] rsvd3[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] clear.llwi1: opCode[%u] rd[%u] reserved0[%u] func3[%u] immdHigh[%u] immdLow[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] clear.lhwi1: opCode[%u] rd[%u] reserved0[%u] func3[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] clear.sw: opCode[%u] immdLow[%u] func3[%u] rs1[%u] reserved1[%u] rs2[%u] reserved2[%u] immdHigh[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] clear.nop[0]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] clear.nop[1]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] clear.nop[2]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] nop[0]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] nop[1]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] nop[2]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] nop[3]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] nop[4]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] nop[5]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] nop[6]: opCode[%u] rd[%u] reserved0[%u] func3[%u] rs1[%u] reserved1[%u] immd[%u]",
                ...
                case SqeType::CCORE_WRITE_VALUE_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsCcoreWriteValueSqe_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(ccoreWriteValueSqePtr->sqeHeader, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] reserved0[%u] reserved1[%u] kernel_credit[%u] reserved2[%u] csc[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] ldrImm: opCode[%u] rd[%u] reserved[%u] func3[%u] immdAddrHigh[0x%08x] immdAddrLow[0x%08x]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] llwi1: opCode[%u] rd[%u] reserved0[%u] func3[%u] immdHigh[%u] immdLow[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] lhwi1: opCode[%u] rd[%u] reserved0[%u] func3[%u] reserved1[%u] immd[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] sw: opCode[%u] immdLow[%u] func3[%u] rs1[%u] reserved1[%u] rs2[%u] reserved2[%u] immdHigh[%u]",
                ...
                case SqeType::NOTIFY_SQE_V2: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsNotifySqeV2_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(notifyV2SqePtr->header, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] notify_id[%u] res2[%u] res3[%u] kernel_credit[%u] res4[%u]",    
                        notifyV2SqePtr->notify_id, notifyV2SqePtr->res2, notifyV2SqePtr->res3, notifyV2SqePtr->kernel_credit, notifyV2SqePtr->res);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res[0][%u] res[1][%u] res[2][%u] res[3][%u] res[4][%u] res[5][%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res[6][%u] res[7][%u] res[8][%u] res[9][%u] res[10][%u] res[11][%u]",
                ...
                case SqeType::WRITE_VALUE_SQE_V2: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsWriteValueSqeV2_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(writeValueV2SqePtr->header, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] reg_addr_low[0x%08x] reg_addr_high[0x%08x] awsize[%u] snoop[%u] res2[%u] awcache[%u] awprot[%u] VA[%u]",  
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] write_val[0][%u] write_val[1][%u] write_val[2][%u] write_val[3][%u] write_val[4][%u] write_val[5][%u] write_val[6][%u] write_val[7][%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res[0][%u] res[1][%u] res[2][%u] res[3][%u]",
                ...
                case SqeType::EVENT_SQE_V2: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsEventSqeV2_t sqeType[%u]", sqeType);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] type[%u] ie[%u] pre_p[%u] post_p[%u] wr_cqe[%u] res0[%u] flag[%u] rt_stream_id[%u] task_id[%u] event_id[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res2[%u] res3[%u] kernel_credit[%u] res4[%u] offset[%u]",
                        eventV2SqePtr->res2, eventV2SqePtr->res3, eventV2SqePtr->kernel_credit, eventV2SqePtr->res4, eventV2SqePtr->offset);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res6[0][%u] res6[1][%u] res6[2][%u] res6[3][%u] res6[4][%u] res6[5][%u] res6[6][%u] res6[7][%u] res6[8][%u] res6[9][%u] res6[10][%u] res6[11][%u]",
                ...
                case SqeType::MEMCPY_ASYNC_SQE_V2: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsMemcpyAsyncSqeV2_t sqeType[%u]", sqeType);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] type[%u] ie[%u] pre_p[%u] post_p[%u] wr_cqe[%u] res0[%u] l2_lock[%u] l2_unlock[%u] res1[%u] rt_stream_id[%u] task_id[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res2[%u] res3[%u] kernel_credit[%u] res4[%u] opcode[%u] ie_dma[%u] sssv[%u] dssv[%u] sns[%u] dns[%u] qos[%u] sro[%u] dro[%u] overflow_en[%u] res5[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] src_streamid[%u] src_substreamid[%u] dst_streamid[%u] dst_substreamid[%u] length[%u]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] src_addr_low[0x%08x] src_addr_high[0x%08x] dst_addr_low[0x%08x] dst_addr_high[0x%08x] overflow_addr_low[0x%08x] overflow_addr_high[0x%08x]",
                ...
                case SqeType::FLIP_PLACEHOLDER_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] rtStarsPlaceHolderSqe_t sqeType[%u]", sqeType);
                    CHK_RET(DumpSqeHeader(placeholderSqePtr->header, forceDump));
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res1[%u] res2[%u] kernel_credit[%u] res3[%u]",
                        placeholderSqePtr->res1, placeholderSqePtr->res2, placeholderSqePtr->kernel_credit, placeholderSqePtr->res3);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] u.flip_task_info: flipNumReport[%u]",
                ...
                case SqeType::CACHE_MEMCPY_PLACEHOLDER_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res1[%u] res2[%u] kernel_credit[%u] res3[%u]",
                        placeholderSqePtr->res1, placeholderSqePtr->res2, placeholderSqePtr->kernel_credit, placeholderSqePtr->res3);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] u.cache_memcpy_task_info: src_addr_low[0x%08x] src_addr_high[0x%08x] dst_addr_low[0x%08x] dst_addr_high[0x%08x]",
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] u.cache_memcpy_task_info: kernel_credit[%u] linkType[%u]",
                ...
                case SqeType::CACHE_NOTIFY_PLACEHOLDER_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res1[%u] res2[%u] kernel_credit[%u] res3[%u]",
                        placeholderSqePtr->res1, placeholderSqePtr->res2, placeholderSqePtr->kernel_credit, placeholderSqePtr->res3);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] u.cache_notify_task_info: is_wait[%u] kernel_credit[%u] timeout[%u] notify_id[%u]",
                ...
                case SqeType::CACHE_WRITE_VALUE_PLACEHOLDER_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res1[%u] res2[%u] kernel_credit[%u] res3[%u]",
                        placeholderSqePtr->res1, placeholderSqePtr->res2, placeholderSqePtr->kernel_credit, placeholderSqePtr->res3);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] u.cache_write_value_task_info: write_addr_low[0x%08x] write_addr_high[0x%08x]",
                ...
                case SqeType::CACHE_MEMCPY_RECORD_PLACEHOLDER_SQE: {
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] res1[%u] res2[%u] kernel_credit[%u] res3[%u]",
                        placeholderSqePtr->res1, placeholderSqePtr->res2, placeholderSqePtr->kernel_credit, placeholderSqePtr->res3);
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] u.cache_memcpy_record_task_info: length[%u]"\
                    ...
                    HCCL_WARNING("[OpUnfoldCache][DumpSqeContent] u.cache_memcpy_record_task_info: opcode[%u]"\
    ...
    HcclResult OpUnfoldCache::DumpSqeHeader(const rtStarsSqeHeader_t& sqeHeader, const bool forceDump) {
        if (!forceDump) {
            ...
            HCCL_WARNING("[OpUnfoldCache][DumpSqeHeader] SQE header: type[%u] l1Lock[%u] l1Unlock[%u] ie[%u] preP[%u] postP[%u] wrCqe[%u]",
                sqeHeader.type, sqeHeader.l1Lock, sqeHeader.l1Unlock, sqeHeader.ie, sqeHeader.preP, sqeHeader.postP, sqeHeader.wrCqe);
            HCCL_WARNING("[OpUnfoldCache][DumpSqeHeader] SQE header: reserved[%u] numBlocks[%u] rtStreamId[%u] taskId[%u]",
                sqeHeader.reserved, sqeHeader.blockDim, sqeHeader.rtStreamId, sqeHeader.taskId);
        }
    ...
    HcclResult OpUnfoldCache::DumpSqeHeader(const rtStarsSqeHeaderV2_t& sqeHeader, const bool forceDump) {
        if (!forceDump) {
            ...
            HCCL_WARNING("[OpUnfoldCache][DumpSqeHeader] SQE header V2: type[%u] graph_lock[%u] graph_unlock[%u] ie[%u] pre_p[%u] post_p[%u] wr_cqe[%u]", sqeHeader.type, sqeHeader.graph_lock, sqeHeader.graph_unlock, sqeHeader.ie, sqeHeader.pre_p, sqeHeader.post_p, sqeHeader.wr_cqe);
            HCCL_WARNING("[OpUnfoldCache][DumpSqeHeader] SQE header V2: res0[%u] l2_lock[%u] l2_unlock[%u] res1[%u] rt_stream_id[%u] task_id[%u]", sqeHeader.res0, sqeHeader.l2_lock, sqeHeader.l2_unlock, sqeHeader.res1, sqeHeader.rt_stream_id, sqeHeader.task_id);
        }
