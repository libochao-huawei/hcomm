...
HcclResult DlRaFunction::DlRaFunctionRdmaInit()
{
    ...
    dlRaVerbsQpDestroy = (int(*)(QpHandle))HcclDlsym(handle_, "RaVerbsQpDestroy");
    CHK_SMART_PTR_NULL(dlRaVerbsQpDestroy);
    ...
    dlRaTypicalCqDestroy =
        (int(*)(RdmaHandle, unsigned int))HcclDlsym(handle_, "RaTypicalCqDestroy");
