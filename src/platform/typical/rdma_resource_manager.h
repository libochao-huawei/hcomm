...
public:
    ...
    HcclResult GetResvMemPoolIdByType(u32 type, u32& poolId, bool isCreateQp = true);
private:
    RdmaResourceManager();
    ~RdmaResourceManager();
    ...
    HcclResult InitResvMemInfo(bool isFirst, bool& isConfig);
private:
    s32 deviceLogicId_{};
    u32 devicePhyId_{};
    ...
    std::unordered_map<u32, std::pair<u32, u32>> resvMemInfo_{}; //type:<pollId, pageSize>
};
