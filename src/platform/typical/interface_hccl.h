...
*/
HcclResult hcclAscendPostSend(AscendVerbsQPInfo* qpInfo, struct AscendSendWr *sendWr, struct AscendSendWr **badWr, aclrtStream stream);
...
* @param badWr (out): 失败的WR头指针。
*/
HcclResult hcclAscendPostRecv(AscendVerbsQPInfo* qpInfo, struct AscendRecvWr *recvWr, struct AscendRecvWr **badWr, aclrtStream stream);
