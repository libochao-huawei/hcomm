...
public:
    ...
    void GetStreamException(StreamLite *curStream, string nullInfo, CommunicatorImplLite *aicpuComm, string additionInfo) const;
    ...
    int  GetException(StreamLite *curStream, uint32_t flag, CommunicatorImplLite *aicpuComm, string additionInfo = "") const;
