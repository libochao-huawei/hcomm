...
void CcuContextReduceMeshMem2Mem1D::CreateLocalCopyLoop()
{
...
void CcuContextReduceMeshMem2Mem1D::LocalCopyByLoopGroup(CcuRep::Memory dst, CcuRep::Memory src)
{
    CreateLocalCopyLoop();
                                                                    ...
                                                                    const CcuRep::Variable &dstAddr)
{
    ...
    CCU_IF (isInputOutputEqual_ == 0) {
        LocalCopyByLoopGroup(dstMem_, srcMem_);
    }
