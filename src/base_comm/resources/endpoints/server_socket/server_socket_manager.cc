...
void ServerSocketManager::DeInitDeviceSockets(ServerSocketManager& inst, u32 devPhyId)
{
...
void ServerSocketManager::DeInitHostSockets(ServerSocketManager& inst, u32 devPhyId)
{
...
void ServerSocketManager::DeInit(u32 devPhyId)
{
    ...
    DeInitDeviceSockets(inst, devPhyId);
    DeInitHostSockets(inst, devPhyId);
}
