...
public:
    ...
    MAKE_ENUM(TransStatus, INIT, SEND_SIZE, RECV_SIZE, SEND_DATA, RECV_DATA, PROCESS_DATA, SEND_ALL_INFO, RECV_ALL_INFO, SEND_TRANS_RES, RECV_TRANS_RES, SEND_FIN, RECV_FIN,
