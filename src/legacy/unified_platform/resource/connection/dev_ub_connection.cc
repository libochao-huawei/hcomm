...
extern const u32& GetExternalInputUBTimeOut();
extern const u32& GetExternalInputUboeTimeOut();
...
void DevUbConnection::GetTimeOut() // 直接基于环境变量控制
{
    ...
    uint8_t envValue = static_cast<uint8_t>(::hccl::GetExternalInputUBTimeOut());
    ...
    if (tpProtocol == TpProtocol::UBOE) {
        envValue = static_cast<uint8_t>(::hccl::GetExternalInputUboeTimeOut());
