...
bool HostUbConnection::GetTpInfo()
{
    ...
    auto ret = TpManager::GetInstance(devLogicId).GetTpInfo({locAddr, rmtAddr, tpProtocol}, tpInfo, true);
...
HostUbConnection::ConstructTaskUbSend(const HrtRaUbSendWrRespParam& sendWrResp, const SqeConfig& config)
{
...
uint64_t HostUbConnection::GetCqVa() { return cqInfo_.va; }

u64 HostUbConnection::GetJettyVa() { return jettyVa_; }

JettyHandle HostUbConnection::GetTJettyVa() { return remoteJettyVa_; }
