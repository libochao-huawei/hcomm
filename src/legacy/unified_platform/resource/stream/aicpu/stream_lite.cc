...
StreamLite::StreamLite(u32 id, u32 sqIds, u32 phyId, u32 cqIds, bool flag) : id(id), sqId(sqIds), devPhyId(phyId), cqId(cqIds)
{
    rtsq = std::make_unique<RtsqA5>(phyId, id, sqIds, flag);
}
