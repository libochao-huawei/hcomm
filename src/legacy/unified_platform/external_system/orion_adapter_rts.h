...
struct MsprofDpuHcclTrack {
    ...
    uint16_t dpuDevId;
#ifdef __cplusplus
    MsprofDpuHcclTrack() : timeStamp(0), durationEstimated(0),
        srcAddr(0xFFFFFFFFFFFFFFFF), dstAddr(0xFFFFFFFFFFFFFFFF),
        dataSize(0xFFFFFFFFFFFFFFFF), taskId(0), reserve(0),
        streamId(0), planeID(0), opType(0xFF),
        dataType(0xFF), linkType(0xFF),
        transportType(0xFF), rdmaType(0xFF),
        role(0xFF), workFlowMode(0),
        aicpu_task_id(0xFFFFFFFF), npuDevId(0xFFFF), dpuDevId(0xFFFF)
    {
    }
#endif
};
