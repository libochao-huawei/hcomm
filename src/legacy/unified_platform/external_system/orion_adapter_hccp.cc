...
JfcHandle HrtRaUbCreateJfcAndGetCqInfo(RdmaHandle handle, CqCreateInfo& cqInfo, HrtUbJfcMode mode)
{
    struct cq_info_t info {};
    ...
    HCCL_INFO("[HrtRaUbCreateJfcAndGetCqInfo] jfcId[%u], cqVA[%llx], cqeSize[%u], dbAddr[%llx]", 
