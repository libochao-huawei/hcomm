...
public:
    ...
    void Init();
    HcclResult GetTpInfo(const RaUbGetTpInfoParam &param, TpInfo &tpInfo, bool isHost = false);
...
private:
    ...
    */
    ...
    void StartGetTpInfoListRequest(const RaUbGetTpInfoParam &param, RequestCtx &reqCtx, bool isHost) const;
