...
#define INS_REGISTER_IMPL_HELPER(ctr, type, name, insCollAlgBase) \
    static HcclResult g_func_##name##_##ctr = InsCollAlgRegistry::Global()->Register(type, std::string(#name), DefaultCreator<insCollAlgBase>)
...
#define INS_REGISTER_IMPL_BY_TFOUR_TEMPS_HELPER_1(ctr, type, name, insCollAlgBase, AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3) \
    static HcclResult g_func_##name##_##ctr = InsCollAlgRegistry::Global()->Register(                                          \
...
#define INS_REGISTER_IMPL_BY_FOUR_TEMPS(type, name, insCollAlgBase, AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3) \
    INS_REGISTER_IMPL_BY_TFOUR_TEMPS_HELPER_1(__COUNTER__, type, name, insCollAlgBase, AlgTopoMatch, InsAlgTemplate0, \
