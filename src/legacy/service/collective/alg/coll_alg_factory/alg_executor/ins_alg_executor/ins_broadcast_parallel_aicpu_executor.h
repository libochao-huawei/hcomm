...
private:
    ...
    HcclResult WrapPrepResLinks(const RankGraph* resource, const LinkReq& linkReq, ResLinks& resLinks)
    {
        return PrepResLinks(myRank_, resource, linkPriority_, linkReq, resLinks);
    }
    HcclResult WrapPrepResLinks(ConnectedLinkMgr* resource, const LinkReq& linkReq, ResLinks& resLinks)
    {
        return PrepResLinks(myRank_, linkReq, resource, resLinks);
    }
    ...
    HcclResult PrepareRes(
        ResourceType* resource, AlgTempResReq& resReqIntraScatter, AlgTempResReq& resReqInterScatter,
        AlgTempResReq& resReqIntraAllReduce, AlgTempResReq& resReqInterAllReduce);
        ...
        InsAlgTemplate2& intraAllReduceTempAlg, InsAlgTemplate3& interAllReduceTempAlg)
    {
        ...
        stageProcAlgParaVec = {
            ...
            {[&](auto&... args) { return intraAllReduceTempAlg.GenExtIns(args...); },
             scratchOffset.intraAllReduceStage2, intraLinks_, intraQue_, // stage2 part0
             [&](auto&... args) { return interAllReduceTempAlg.GenExtIns(args...); },
             scratchOffset.interAllReduceStage2, interLinks_, interQue_}, // stage2 part1
            {[&](auto&... args) { return interAllReduceTempAlg.GenExtIns(args...); },
             scratchOffset.interAllReduceStage3, interLinks_, interQue_, // stage3 part0
             [&](auto&... args) { return intraAllReduceTempAlg.GenExtIns(args...); },
             scratchOffset.intraAllReduceStage3, intraLinks_, intraQue_}, // stage3 part1
        };
    }
