...
HcclResult InsCollAlgBase::CalcLocalRankSize(const RankId myRank, const std::vector<std::vector<RankId>> &virtRanks,
    u32 &rankSizeLevel0, u32 &rankSizeLevel1) const
{
    ...
    HCCL_INFO("[CalcLocalRankSize] localRankSize: myRank[%d] rankSizeLevel0_[%u] rankSizeLevel1_[%u]", myRank,
        rankSizeLevel0, rankSizeLevel1);
    return HcclResult::HCCL_SUCCESS;
};
