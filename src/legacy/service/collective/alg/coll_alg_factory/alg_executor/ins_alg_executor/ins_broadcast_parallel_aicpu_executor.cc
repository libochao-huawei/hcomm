        ...
        AlgTempResReq& resReqIntraAllReduce, AlgTempResReq& resReqInterAllReduce)
{
    ...
    CHK_RET(WrapPrepResLinks(resource, resReqIntraScatter.links, intraLinks_));
    CHK_RET(WrapPrepResLinks(resource, resReqInterScatter.links, interLinks_));
    CHK_RET(WrapPrepResLinks(resource, resReqIntraAllReduce.links, intraLinks_));
    CHK_RET(WrapPrepResLinks(resource, resReqInterAllReduce.links, interLinks_));
    HCCL_INFO(
