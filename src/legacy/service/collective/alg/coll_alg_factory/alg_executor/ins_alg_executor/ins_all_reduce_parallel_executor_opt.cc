...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
HcclResult InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::CalcResOffload(const RankGraph *rankGraph, const u64 &dataSize,
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
HcclResult InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::CalcRes(const RankGraph *rankGraph, CollAlgResReq &algResReq)
{
...
// 传入的insQue为一条主流
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
void InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::GenTemplateAlgParams0(
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
void InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::GenTemplateAlgParams1(
    const u64 dataOffset, const u64 dataCount, const u64 scratchOffset, TemplateDataParams &tempAlgParams) const
{
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
void InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::GenTemplateAlgParams2(
    const u64 dataOffset, const u64 dataCount, const u64 scratchOffset, TemplateDataParams &tempAlgParams) const
{
    tempAlgParams.buffInfo.inBuffType           = BufferType:OUTPUT;
    tempAlgParams.buffInfo.outBuffType          = BufferType::OUTPUT;
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
void InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::GetParallelDataSplitRate(
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
HcclResult InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::CalcLocalRankSize()
{
    ...
    const RankGraph *rankGraph, InsAlgTemplate0 &tempAlgIntraRS, InsAlgTemplate1 &tempAlgInterRS, InsAlgTemplate2 &tempAlgIntraAG, InsAlgTemplate3 &tempAlgInterAG)
{
    ...
    HCCL_INFO("[InsAllReduceParallelExecutor] intraRSLinks_ size[%zu], interRSLinks_ size[%zu], intraAGLinks_ size[%zu], interAGLinks_ size[%zu]",
        intraRSLinks_.size(),
        interRSLinks_.size()
        intraAGLinks_.size(),
        interAGLinks_.size());
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
HcclResult InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::PrepareResForTemplate(ConnectedLinkMgr *linkMgr,
                                                                                                               ...
                                                                                                               InsAlgTemplate1 &tempAlgInter)
{
    ...
    CHK_RET(tempAlgIntraRS.CalcRes(resReqIntra));
    CHK_RET(tempAlgInterRS.CalcRes(resReqInter));
    CHK_RET(tempAlgIntraAG.CalcRes(resReqIntra));
    CHK_RET(tempAlgInterAG.CalcRes(resReqInter));

    // 申请算法模板所需资源
    if(!(resReqIntra.queNum > 0 && resReqInter.queNum > 0 && resReqIntraAG.queNum > 0 && resReqInterAG.queNum > 0)) {
        HCCL_ERROR("resReqIntra.queNum and resReqInter.queNum must larger than 0.");
        return HcclResult::HCCL_E_INTERNAL;
    }
    u32 totalQueueNum = std::max(resReqIntraRS.queNum + resReqInterRS.queNum, resReqIntraAG.queNum + resReqInterAG.queNum);
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2, typename InsAlgTemplate3>
HcclResult InsAllReduceParallelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2, InsAlgTemplate3>::CalcSendDataSize(
    ...
    InsAlgTemplate0 &tempAlgIntraRS, InsAlgTemplate1 &tempAlgInterRS, InsAlgTemplate2 &tempAlgIntraAG, InsAlgTemplate3 &tempAlgInterAG)
{
    ...
    CalcSendDataSize(memBlockSize, dataSplitRate, multipleIntraRS, multipleInterRS);
    ...
    for (u32 loopIndex = 0; loopIndex < loopTimes; loopIndex++) {
        ...
        CHK_RET(tempAlgIntraRS.GenExtIns(tempFuncs, tempAlgParamsIntra0, intraLinks_, intraQue_));
        ...
        CHK_RET(tempAlgInterRS.GenExtIns(tempFuncs, tempAlgParamsInter0, interLinks_, interQue_));
        ...
        CHK_RET(tempAlgInterRS.GenExtIns(tempFuncs, tempAlgParamsInter1, interLinks_, interQue_));
        ...
        CHK_RET(tempAlgIntraRS.GenExtIns(tempFuncs, tempAlgParamsIntra1, intraLinks_, intraQue_));
        CHK_RET(PostSyncQues(syncQueues_, 0));
        ...
        tempAlgParamsIntra0.buffInfo.scratchBuffSize = Intra0ScratchSize;
        GenTemplateAlgParams0(dataOffset0, dataCountPerLoopAixs0, 0, tempAlgParamsIntra0);
        CHK_RET(tempAlgIntraAG.GenExtIns(tempFuncs, tempAlgParamsIntra0, intraLinks_, intraQue_));
        tempAlgParamsInter0.buffInfo.scratchBuffSize = Inter0ScratchSize;
        GenTemplateAlgParams0(dataOffset1, dataCountPerLoopAixs1, interScratchOffset0, tempAlgParamsInter0);
        CHK_RET(tempAlgInterAG.GenExtIns(tempFuncs, tempAlgParamsInter0, interLinks_, interQue_));
        CHK_RET(PostSyncQues(syncQueues_, 0));

        // 第四阶段：前50%的数据做框内框间AllGather，后50%的数据做框内AllGather
        CHK_RET(PreSyncQues(syncQueues_, 0));
        empAlgParamsInter1.buffInfo.scratchBuffSize = Inter1ScratchSize;
        GenTemplateAlgParams2(dataOffset0, dataCountPerLoopAixs0, interScratchOffset1, tempAlgParamsInter1);
        CHK_RET(tempAlgInterAG.GenExtIns(tempFuncs, tempAlgParamsInter1, interLinks_, interQue_));
        tempAlgParamsIntra1.buffInfo.scratchBuffSize = Intra1ScratchSize;
        GenTemplateAlgParams2(dataOffset1, dataCountPerLoopAixs1, 0, tempAlgParamsIntra1);
        CHK_RET(tempAlgIntraAG.GenExtIns(tempFuncs, tempAlgParamsIntra1, intraLinks_, intraQue_));
        CHK_RET(PostSyncQues(syncQueues_, 0));
    }
...
// 算法注册
INS_REGISTER_IMPL_BY_FOUR_TEMPS(OpType::ALLREDUCE, InsAllReduceFourTemplateMesh1DNHR, 
                               InsFourTemplateAllReduceExecutor,
                               TopoMatchMeshNHR, 
                               InsTempReduceScatterMesh1D, InsTempReduceScatterNHR,
                               InsTempAllGatherMesh1D, InsTempAllGatherNHR);

INS_REGISTER_IMPL_BY_FOUR_TEMPS(OpType::ALLREDUCE, InsAllReduceFourTemplateMesh2DNHR, 
                               InsFourTemplateAllReduceExecutor,
                               TopoMatchConcurrMeshNHR, 
