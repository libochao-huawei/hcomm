...
void ProfilingHandler::SetProfCommonInfo(const TaskInfo &taskInfo, HCCLReportData &hcclReportData) const
{
...
void ProfilingHandler::SetProfTaskSpecificInfo(const TaskInfo &taskInfo, HCCLReportData &hcclReportData) const
{
...
void ProfilingHandler::SetDpuProfInfo(const TaskInfo &taskInfo, HCCLReportData &hcclReportData) const
{
    const auto &taskType = taskInfo.taskParam_.taskType;
    const auto &taskPara = taskInfo.taskParam_.taskPara;
...
void ProfilingHandler::GetHCCLReportData(const TaskInfo &taskInfo, HCCLReportData &hcclReportData) const
{
    ...
    SetProfCommonInfo(taskInfo, hcclReportData);
    SetProfTaskSpecificInfo(taskInfo, hcclReportData);
    const auto &taskType = taskInfo.taskParam_.taskType;
    if (taskType == TaskParamType::TASK_DPU_INLINE_WRITE
        || taskType == TaskParamType::TASK_DPU_WRITE_WITH_NOTIFY
        || taskType == TaskParamType::TASK_DPU_NOTIFY_WAIT
        || taskType == TaskParamType::TASK_DPU_CHANNEL_FENCE) {
        SetDpuProfInfo(taskInfo, hcclReportData);
    }
