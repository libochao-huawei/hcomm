    ...
    const MsprofAicpuHcclTaskInfo& taskDetailsInfos, const TaskInfo& taskInfo) const
{
    ...
    HCCL_INFO(
        ...
        taskDetailsInfos.rankSize, taskDetailsInfos.stage, taskInfo.taskParam_.taskType.Describe().c_str(),
        taskDetailsInfos.srcAddr, taskDetailsInfos.dstAddr, taskDetailsInfos.dataSize, taskDetailsInfos.notifyID,
