...
public:
    ...
    void SetDeviceServerListenPortMap(const std::unordered_map<IpAddress, u32> &rankListenPortMap);
    ...
    u32 GetDeviceListenPort(const u32 &rankId, const IpAddress &ipAddress) const;
...
private:
    ...
    u32               devicePhyId;
    u32               deviceLogicId_;
    std::std::unordered_map<u32, unordered_map<IpAddress, u32>> rankListenPortMap_;
