...
public:
    ...
    static void SetDeviceServerListenPortMap(const std::unordered_map<IpAddress, u32> &rankListenPortMap);

    static std::unordered_map<IpAddress, u32>& GetDeviceServerListenPortMap();
