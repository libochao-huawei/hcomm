...
HcclResult HcomSupportDeterministicOptimV2(const char *group, bool &isDeterministicOptim)
{
    ...
    HCCL_WARNING("HcomSupportDeterministicOptimV2 is does not support at A5! set isDeterministicOptim to true.");
    return HCCL_SUCCESS;
}
...
HcclResult HcomSetQosCfgV2(const char *group, const u32 qosCfg)
{
    ...
    CHK_PRT_RET(GetHcclCommV2(group, hcclComm) == HCCL_E_NOT_FOUND, 
            ...
            HCCL_E_NOT_FOUND);
    (void)qosCfg;
    HCCL_WARNING("HcomSetQosCfgV2 is does not support at A5!");
    return HCCL_SUCCESS;
}
...
{
    HCCL_WARNING("HcclCommResetQosCfgV2 is does not support!");
    return HCCL_SUCCESS;
}

HcclResult HcomResetQosCfgV2()
{
    HCCL_WARNING("HcomGetCommCCLBufferSizeV2 is does not support!");
    return HCCL_SUCCESS;
}

HcclResult HcclCommSetQosCfgV2()
{
    HCCL_WARNING("HcclCommSetQosCfgV2 is does not support!");
    return HCCL_SUCCESS;
}
...
{
    HCCL_RUN_INFO("HcomSetAttachedStreamV2 is does not support!");
    return HCCL_SUCCESS;
}

HcclResult HcomReleaseSubCommsV2()
{
    HCCL_RUN_INFO("HcomReleaseSubCommsV2 is does not support!");
    return HCCL_SUCCESS;
}
