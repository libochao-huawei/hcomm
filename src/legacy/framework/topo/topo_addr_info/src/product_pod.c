...
static const UBEntityRule g_ubrules[] = {
    // NPU 0-3 的1die使用6个端口
    {MAIN_BOARD_ID_POD, PRODUCT_CLOS_LEVEL, 1, 2, {1,2,3,5,6}, 4, {0,1,2,3}, 4, "plane_pg_0"},
    // NPU 0-3 的0die使用2个端口
    {MAIN_BOARD_ID_POD, PRODUCT_CLOS_LEVEL, 0, 2, {1,2}, 2, {0,1,2,3}, 4, "plane_pg_1"},
    // NPU 4-7 的0 die使用6个端口
    {MAIN_BOARD_ID_POD, PRODUCT_CLOS_LEVEL, 0, 2, {0,1,2,3,5,6}, 6, {4,5,6,7}, 4, "plane_pg_0"},
    // NPU 4-7 的1 die使用2个端口
    {MAIN_BOARD_ID_POD, PRODUCT_CLOS_LEVEL, 1, 2, {1,2}, 6, {4,5,6,7}, 4, "plane_pg_0"},
    // NPU 0-3 的1die使用6个端口
    {MAIN_BOARD_ID_POD_2D, PRODUCT_CLOS_LEVEL, 1, 2, {1,2,3,5,6}, 4, {0,1,2,3}, 4, "plane_pg_0"},
    // NPU 0-3 的0die使用2个端口
    {MAIN_BOARD_ID_POD_2D, PRODUCT_CLOS_LEVEL, 0, 2, {1,2}, 2, {0,1,2,3}, 4, "plane_pg_1"},
    // NPU 4-7 的0 die使用6个端口
    {MAIN_BOARD_ID_POD_2D, PRODUCT_CLOS_LEVEL, 0, 2, {0,1,2,3,5,6}, 6, {4,5,6,7}, 4, "plane_pg_0"},
    // NPU 4-7 的1 die使用2个端口
    {MAIN_BOARD_ID_POD_2D, PRODUCT_CLOS_LEVEL, 1, 2, {1,2}, 6, {4,5,6,7}, 4, "plane_pg_0"},
};
...
int PodGetRootinfo(int npu_id, unsigned mainboard_id, void *buf, size_t *len)
{
    ...
    int localId = (npu_id % 8) + ((spod_info.server_index % 8) * 8);
