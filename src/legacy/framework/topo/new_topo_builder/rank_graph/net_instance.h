...
public:
    ...
    const std::unordered_map<u32, std::shared_ptr<TopoInstance>>& GetTopoInsts() const;
    void AddTopoInst(std::unordered_map<u32, std::shared_ptr<TopoInstance>> topoInsts);
