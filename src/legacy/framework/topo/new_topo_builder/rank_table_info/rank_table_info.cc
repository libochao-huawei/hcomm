...
void RankTableInfo::Check()
{
    ...
    CheckAddrs(devPhyId, localRankInfo, localEidSet);
}

void RankTableInfo::CheckAddrs(const u32 devPhyId, const NewRankInfo &localRankInfo, const std::unordered_set<Eid> &localEidSet) const
{
