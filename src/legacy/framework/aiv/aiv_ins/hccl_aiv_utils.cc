...
static std::vector<AivKernelInfo> g_aivKernelInfoList = {
    ...
    {"aiv_scatter_mxfp8_t", HcclCMDType::HCCL_CMD_SCATTER, DataType::MXFP8},
    ...
    {"aiv_all_gather_mxfp8_t", HcclCMDType::HCCL_CMD_ALLGATHER, DataType::MXFP8},
    //allreduce
    ...
    {"aiv_broadcast_mxfp8_t", HcclCMDType::HCCL_CMD_BROADCAST, DataType::MXFP8},
    // allreduce two shot
    ...
    {"aiv_alltoall_mxfp8_t", HcclCMDType::HCCL_CMD_ALLTOALL, DataType::MXFP8},
    // alltoallv
    ...
    {"aiv_alltoallv_mxfp8_t", HcclCMDType::HCCL_CMD_ALLTOALLV, DataType::MXFP8},
    // reduce
    ...
    {"aiv_send_mxfp8_t", HcclCMDType::HCCL_CMD_SEND, DataType::MXFP8},
    // recv
    ...
    {"aiv_recv_mxfp8_t", HcclCMDType::HCCL_CMD_RECEIVE, DataType::MXFP8},
    // batchSendRecv
    ...
    {"aiv_batchSendRecv_mxfp8_t", HcclCMDType::HCCL_CMD_BATCH_SEND_RECV, DataType::MXFP8},
};
