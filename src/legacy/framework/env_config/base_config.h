...
private:
    ...
    CfgField<u32> execTimeOut{"HCCL_EXEC_TIMEOUT", static_cast<u32>(NOTIFY_DEFAULT_WAIT_TIME),
    ...
    CfgField<double> aivExecTimeOut{"HCCL_EXEC_TIMEOUT", double(AIV_TIMEOUT_DEFAULT),
...
private:
    ...
    CfgField<DfsConfig> dfsConfig{"HCCL_DFS_CONFIG", DfsConfig(), CastDfsConfig};
};
