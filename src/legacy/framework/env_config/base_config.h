...
inline std::ostream& operator<<(std::ostream& os, const IpAddress& hcclIfIp)
{
    os << hcclIfIp.Describe();
    return os;
}

inline std::ostream& operator<<(std::ostream& os, const std::vector<SocketPortRange>& rangeVec)
{
    os << "{";
...
inline std::ostream& operator<<(std::ostream& os, const std::map<OpType, std::vector<HcclAlgoType>>& map)
{
    os << "{";
