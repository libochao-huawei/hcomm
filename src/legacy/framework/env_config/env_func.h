...
std::ostream& operator<<(std::ostream& os, const SocketIfName& socketIfName)
{
    os << "[ifNames:";
    bool isFirst = true;
    ...
    os << "; isSearch:" << (socketIfName.searchNot ? "true" : "false") 
        ...
        << "; configIfName:" << sockedIfName.configIfNameStr << "]";
    return os;
}
...
std::ostream& operator<<(std::ostream& os, const DfsConfig& dfsConfig)
{
...
std::ostream& operator<<(std::ostream& os, const SocketPortRangeDef& range)
{
