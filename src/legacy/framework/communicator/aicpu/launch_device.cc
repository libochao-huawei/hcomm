...
class LoadCleanupGuard {
    LoadCleanupGuard(AicpuBinaryHolder &holder, bool active): holder_(holder), active_(active)
    {
    }
...
void AicpuBinaryHolder::Load()
{
    ...
    //register base Func
    LoadCleanupGuard aicpuKernelGuard(*this, true);
    ...
    aicpuKernelGuard.setActive(false);
