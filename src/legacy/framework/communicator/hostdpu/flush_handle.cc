...
HcclResult FlushHandle::Init(const IpAddress &ip, const u32 &devPhyId)
{
    // 获取 RDMA handle
...
HcclResult FlushHandle::GetRdmaHandle(const IpAddress &ip, const u32 &devPhyId, void **rdmaHandle)
{
    *rdmaHandle =
