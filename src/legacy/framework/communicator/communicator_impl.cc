...
void CommunicatorImpl::InitDataBufferManager()
{
    ...
    if (rankSize > 1) {
        ...
        HrtMemset(aivOffloadTagBuffer->GetAddr(), aivOffloadTagBuffer->GetSize(), aivOffloadTagBuffer->GetSize());
        ...
        HrtMemset(aivTagBuffer->GetAddr(), aivTagBuffer->GetSize(), aivTagBuffer->GetSize());
        CreateCommCclBuf();
    }
