...
{
    CHK_RET(HrtGetDeviceInfo(devLogicId, DEV_MODULE_TYPE::MODULE_TYPE_SYSTEM, ACL_DEV_ATTR_HD_CONNECT_TYPE, connectType_));
    accessVA_ = nullptr;
    va_ = nullptr;
    ...
    if (connectType_ == ACL_HOST_DEVICE_CONNECT_TYPE_PCIE) {
        prop.location.type = ACL_MEM_LOCATION_TYPE_DEVICE;
    } else if (connectType_ == ACL_HOST_DEVICE_CONNECT_TYPE_UB) {
