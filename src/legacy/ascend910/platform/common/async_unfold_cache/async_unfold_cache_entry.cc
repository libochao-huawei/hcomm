...
namespace hccl {
    ...
    // 注意: 与dispatcher_aicpu.cc中的HCCL_PER_LAUNCH_SQE_CNT保持一致
    ...
    HcclResult AsyncUnfoldCacheEntry::AllocAsyncUnfoldSqeArray(const size_t sqeCount, const int32_t streamId, size_t& arrayIdx,
        ...
        HCCL_INFO("[AsyncUnfoldCacheEntry][AllocAsyncUnfoldSqeArray] allocate %uth async sqe array "
            "with sqeCount of %u and streamId of %d", arrayIdx, sqeCount, streamId);
    ...
    HcclResult AsyncUnfoldCacheEntry::MemcpyAsyncUnfoldSqeArray(const size_t arrayIdx, const size_t sqeStartIdx,
        ...
        HCCL_INFO("[AsyncUnfoldCacheEntry][MemcpyAsyncUnfoldSqeArray] memcpy %uth async sqe array[%u:%u]",
        ...
        if (profL1Enable) {
            ...
            CHK_SAFETY_FUNC_RET(memcpy_s(dstProfTimestampArray + sqeStartIdx,
                ...
                profTimestamps, profTimestampBytes));
        }
