...
set(MAKESELF_INSTALL_PATH ${CMAKE_BINARY_DIR}/makeself)
...
if (NOT EXISTS "${MAKESELF_INSTALL_PATH}/makeself-header.sh" OR
    NOT EXISTS "${MAKESELF_INSTALL_PATH}/makeself.sh")
    ...
    FetchContent_Declare(
        ...
        SOURCE_DIR ${MAKESELF_INSTALL_PATH}  # 直接解压到此目录
    )
    FetchContent_MakeAvailable(${MAKESELF_NAME})
    execute_process(
        COMMAND chmod 700 "${MAKESELF_INSTALL_PATH}/makeself.sh"
        COMMAND chmod 700 "${MAKESELF_INSTALL_PATH}/makeself-header.sh"
