...
FetchContent_Declare(
    ...
    SOURCE_DIR "${RDMA_CORE_SRC_DIR}/src"
    BINARY_DIR "${RDMA_CORE_SRC_DIR}/build"
)

set(NO_MAN_PAGES ON CACHE BOOL "禁用man页生成" FORCE)
set(ENABLE_RESOLVE_NEIGH OFF CACHE BOOL "禁用resolve-neigh功能" FORCE)
set(NO_PYVERBS ON CACHE BOOL "禁用Python绑定" FORCE)
set(ENABLE_STATIC OFF CACHE BOOL "禁用静态库编译" FORCE)
set(ENABLE_SHARED OFF CACHE BOOL "禁用动态库编译" FORCE)
set(ENABLE_PROVIDERS OFF CACHE BOOL "禁用硬件驱动编译" FORCE)
set(BUILD_TESTING OFF CACHE BOOL "禁用测试用例" FORCE)
set(CMAKE_SKIP_RPATH ON CACHE BOOL "禁用RPATH" FORCE)
FetchContent_MakeAvailable(rdma_core)

set(RDMA_CORE_INCLUDE_DIR ${RDMA_CORE_SRC_DIR}/build/include)