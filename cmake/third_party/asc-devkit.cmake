...
set(ASC_DEVKIT_TAG_ID master CACHE STRING "asc-devkit git ref for mc2_client")
...
set(ASC_DEVKIT_MC2_BUILD_DIR ${CMAKE_BINARY_DIR}/asc-devkit-mc2-client-build)
set(ASC_DEVKIT_MC2_INSTALL_DIR ${CMAKE_BINARY_DIR}/asc-devkit-mc2-client-install)
set(ASC_DEVKIT_MC2_CLIENT_FILE
    ${ASC_DEVKIT_MC2_INSTALL_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/lib64/libmc2_client.so)
if(NOT JOBS)
    set(JOBS 8)
endif()

set(ASC_DEVKIT_MC2_CMAKE_ARGS
...
foreach(var CMAKE_SYSTEM_NAME CMAKE_SYSTEM_PROCESSOR CMAKE_C_COMPILER CMAKE_CXX_COMPILER
    ...
    if(DEFINED ${var} AND NOT "${${var}}" STREQUAL "")
        list(APPEND ASC_DEVKIT_MC2_CMAKE_ARGS -D${var}=${${var}})
    endif()
endforeach()

ExternalProject_Add(asc_devkit_mc2_client
    SOURCE_DIR ${ASC_DEVKIT_SOURCE_PATH}
    BINARY_DIR ${ASC_DEVKIT_MC2_BUILD_DIR}
    CMAKE_ARGS ${ASC_DEVKIT_MC2_CMAKE_ARGS}
    BUILD_COMMAND ${CMAKE_COMMAND} --build <BINARY_DIR> --target mc2_client --parallel ${JOBS}
    INSTALL_COMMAND ${CMAKE_COMMAND}
        -DINPUT=<BINARY_DIR>/impl/adv_api/detail/hccl/cc/src/libmc2_client.so
        -DOUTPUT=${ASC_DEVKIT_MC2_CLIENT_FILE}
        -P ${HCOMM_DIR}/cmake/copy_file.cmake
    BUILD_ALWAYS TRUE
)
