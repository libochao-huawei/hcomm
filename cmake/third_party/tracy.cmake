...
set(TRACY_KERNEL_COMPILE_DEFINITIONS
    HCCD
    CCL_KERNEL
    CCL_KERNEL_AICPU
...
if(tracy_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    set(TRACY_CLIENT_DEFINES -DTRACY_ENABLE)
    if(NOT BUILD_OPEN_PROJECT OR (BUILD_OPEN_PROJECT AND KERNEL_MODE))
        foreach(tracy_def IN LISTS TRACY_KERNEL_COMPILE_DEFINITIONS)
            list(APPEND TRACY_CLIENT_DEFINES -D${tracy_def})
        endforeach()
    endif()
    ...
    ExternalProject_Add(third_party_tracy_client
        ...
        BUILD_COMMAND
            ...
            ${CMAKE_CXX_COMPILER} ${TRACY_CXXFLAGS} ${TRACY_CLIENT_DEFINES} -I<SOURCE_DIR>/public -c <SOURCE_DIR>/public/TracyClient.cpp -o <BINARY_DIR>/TracyClient.o &&
...
if(NOT BUILD_OPEN_PROJECT OR (BUILD_OPEN_PROJECT AND KERNEL_MODE))
    target_compile_definitions(tracy_client PRIVATE
    ${TRACY_KERNEL_COMPILE_DEFINITIONS})
endif()
