...
set(HCOMM_UTILS_FILE "cann-hcomm-utils_${HCOMM_UTILS_VERSION}_linux-${HCOMM_UTILS_ARCH}_c10.tar.gz")
...
if(hcomm_utils_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    elseif(HCOMM_UTILS_ARCH MATCHES "aarch64|ARM64|arm64")
        set(HCOMM_UTILS_URL_HASH "SHA256=cbb87cf45c0bd1a1c8c782d7edb500a5cb69a3307794adb2070d81c1fa81baa1")
    else()
        set(HCOMM_UTILS_URL_HASH "SHA256=fe1e42e01d3a560cc14d5462fbbecbef726ca10e7d2ec9fdc4ff8375b0e0bb69")
    endif()
