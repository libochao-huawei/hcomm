...
function(generate_filelist_csv JSON_FILE OUTPUT_CSV)
    ...
    # 重要: relative_install_path 必须使用完整文件路径，而不是目录
    # 参考原有Python代码: relative_install_path = path_join(install_path, target_name)

    # version.info - 在包中的位置是share/info/hcomm/version.info
    string(APPEND CSV_LINE "config,copy,share/info/hcomm/version.info,share/info/hcomm/version.info,")
    string(APPEND CSV_LINE "TRUE,440,\${username}:\${usergroup},all,NA,")
    string(APPEND CSV_LINE "all,N,FALSE,NA,CommLib,NA,all,FALSE\n")

    # scene.info - 在包中的位置是share/info/hcomm/scene.info
    string(APPEND CSV_LINE "config,copy,share/info/hcomm/scene.info,share/info/hcomm/scene.info,")
    string(APPEND CSV_LINE "TRUE,440,\${username}:\${usergroup},all,NA,")
    string(APPEND CSV_LINE "all,N,FALSE,NA,CommLib,NA,all,FALSE\n")
