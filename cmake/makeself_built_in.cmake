...
# 执行安装到临时目录
execute_process(
    COMMAND "${CMAKE_COMMAND}" --install "${CPACK_CMAKE_BINARY_DIR}" --component hcomm --prefix "${STAGING_DIR}"
...
configure_file(
    ${NN_VERSION_OUT_PUT}
    ${STAGING_DIR}/${CMAKE_SYSTEM_PROCESSOR}-linux/include/version/hcomm_version.h
    COPYONLY
)
