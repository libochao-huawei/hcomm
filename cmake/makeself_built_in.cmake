...
if(COPY_RESULT)
    message(FATAL_ERROR "Failed to copy filelist.csv: ${COPY_ERROR}")
endif()
message(STATUS "Copied filelist.csv to staging directory")
...
if(COPY_RESULT)
    message(FATAL_ERROR "Failed to copy scene.info: ${COPY_ERROR}")
endif()
message(STATUS "Copied scene.info to staging directory")
...
if(COPY_RESULT)
    message(FATAL_ERROR "Failed to copy hcomm_version.h: ${COPY_ERROR}")
endif()
message(STATUS "Copied hcomm_version.h to staging directory")
...
if(COPY_RESULT)
    message(FATAL_ERROR "Failed to copy version.info: ${COPY_ERROR}")
endif()
message(STATUS "Copied version.info to staging directory")

# 验证文件存在
if(NOT EXISTS "${STAGING_DIR}/share/info/hcomm/version.info")
    message(FATAL_ERROR "version.info not found in staging directory after copy!")
endif()
