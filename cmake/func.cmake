...
function(sign_file)
    ...
    if(EXISTS "${SIGN_SCRIPT}")
        ...
        elseif(${EXT} STREQUAL ".py")
            ...
            set(sign_cmd python3 ${root_dir}/scripts/sign/add_header_sign.py ${signatures_dir} ${root_dir} ${sign_flag} --bios_check_cfg=${ARG_CONFIG} --sign_script=${SIGN_SCRIPT} --version=${VERSION_INFO})
        endif()
    else()
        set(sign_cmd )
    endif()
