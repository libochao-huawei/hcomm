 ...
 */
extern HcommResult HcommTcpSocketGetVnicIp(EndpointLoc location, struct in_addr *addr);
 ...
 * @return 执行状态码 HcommResult
 */
extern HcommResult HcommTcpSocketCreate(EndpointLoc location, int32_t domain,
