...
/**
 * @brief 创建Socket通信实例
 * @param[in] HcommTcpSocketLocation 网卡部署位置
 ...
 */
extern HcommResult HcommTcpSocketCreate(HcommTcpSocketLocation location, int32_t devicePhyId, int domain,
 ...
 * @return 执行状态码 HcommResult
 */
extern HcommResult HcommTcpSocketWhiteListAdd(HcommTcpSocket socket, HcommTcpSocketWlistInfo *whitelists, uint32_t num);
 ...
 * @return 执行状态码 HcommResult
 */
extern HcommResult HcommTcpSocketWhiteListDel(HcommTcpSocket socket, HcommTcpSocketWlistInfo *whitelists, uint32_t num);
