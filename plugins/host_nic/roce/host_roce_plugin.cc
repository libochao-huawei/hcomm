...
struct HostRocePluginTraits {
    using EndpointT = hcomm_host_nic::CpuRoceEndpoint;
    using ChannelT = hcomm_host_nic::HostCpuRoceChannel;
...
using PluginOps = hcomm_host_nic::HostNicPluginOps<HostRocePluginTraits>;
