...
function(add_run_command TARGET_NAME TASK_NUM)
    add_custom_command(
        TARGET ${TARGET_NAME}
        POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E env LD_LIBRARY_PATH=$ENV{LD_LIBRARY_PATH}:/srv/workspace/ltm/work_code/hcomm/output/third_party/gtest_shared/lib/:/srv/workspace/ltm/work_code/hcomm/output/third_party/mpich_shared/lib ASAN_OPTIONS=detect_leaks=0 timeout -s SIGKILL ${LLT_KILL_TIME}s /srv/workspace/ltm/work_code/hcomm/output/third_party/mpich_shared/bin/mpirun -np ${TASK_NUM} ./${TARGET_NAME} --gtest_output=xml:${report_dir}/${TARGET_NAME}.xml
