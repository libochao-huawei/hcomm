...
class TransportDeviceP2pAiCpu_ST : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "\033[36m--TransportDeviceP2pAiCpu_ST SetUP--\033[0m" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "\033[36m--TransportDeviceP2pAiCpu_ST TearDown--\033[0m" << std::endl;
    }
...
TEST_F(TransportDeviceP2pAiCpu_ST, constructor_and_init)
{
    transDevP2pData.transportAttr.linkType = LinkType::LINK_HCCS_SW;
...
TEST_F(TransportDeviceP2pAiCpu_ST, transport_init_A3_between_servers)
{
    transDevP2pData.transportAttr.linkType = LinkType::LINK_HCCS_SW;
    transDevP2pData.transportAttr.relationship |= HCCL_TRANSPORT_RELATIONSHIP_SAME_SUPERPOD;
