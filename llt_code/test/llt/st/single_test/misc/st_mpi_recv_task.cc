...
TEST_F(MPI_RecvTask_Test, st_recv_RecvDataCb)
{
...
TEST_F(MPI_RecvTask_Test, st_recv_task_init)
{
...
TEST_F(MPI_RecvTask_Test, st_recv_Deinit)
{
...
TEST_F(MPI_RecvTask_Test, st_recv_task_RecvData)
{
    HcclResult ret;
...
TEST_F(MPI_RecvTask_Test, st_recv_task_SetRecvTask)
{
    struct socket_peer_info fdHandle;
    fdHandle.fd = 1;
    fdHandle.phy_id = 1;
