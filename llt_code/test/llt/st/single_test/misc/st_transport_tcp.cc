...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_EschedAckCallback)
{
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_Init)
{
    MOCKER(hrtHalSubmitEvent)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_RegisterEschedAckCallback)
{
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_ReportSendComp)
{
    MOCKER(hrtHalSubmitEvent)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_ReportEnvelpComp)
{
    MOCKER(hrtHalSubmitEvent)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_ReportRecvComp)
{
    MOCKER(hrtHalSubmitEvent)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_EnterStateProcess)
{
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_LoopStateProcess)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogEventTcp> transportHeterogTcp(new (nothrow) TransportHeterogEventTcp("test_collective", invalidIp, invalidIp, 18000, 0, 0, transportResourceInfo));
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_SendNoBlock)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogEventTcp> transportHeterogTcp(new (nothrow) TransportHeterogEventTcp("test_collective", invalidIp, invalidIp, 18000, 0, 0, transportResourceInfo));
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_epoll_adapters)
{
    int event_handle;
    FdHandle fd_handle;
    int opcode;
    ...
    ret = hrtRaCtlEventHandle(event_handle, fd_handle, opcode, event);
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_Connect)
{
    HcclIpAddress invalidIp;
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_BlockSend)
{
    MOCKER(hrtRaSocketBatchClose)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_NoBlockRecv)
{
    s32 res = 0;
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_WaitEvents)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogEventTcp> transportHeterogTcp(new (nothrow) TransportHeterogEventTcp("test_collective", invalidIp, invalidIp, 18000, 0, 0, transportResourceInfo));
    hccl::TransportHeterogEventTcp::EpollEventInfo epollEventInfo;
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_BlockRecv)
{
    MOCKER(hrtRaSocketBatchClose)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_TCP_TEST, st_transportTcp_SocketSend)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogEventTcp> transportHeterogTcp(new (nothrow) TransportHeterogEventTcp("test_collective", invalidIp, invalidIp, 18000, 0, 0, transportResourceInfo));
