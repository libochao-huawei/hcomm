...
#if 1
TEST_F(LoadBackupIpTest, st_hrtRaGetDeviceAllNicIP)
{
    ...
    struct interface_info ifAddrInfos[1];
...
#if 1
TEST_F(LoadBackupIpTest, st_topo_detect_backup_ip)
{
...
#if 1
TEST_F(LoadBackupIpTest, st_topo_detect_backup_ip_fail)
{
    HcclRootHandle rootHandle;
    shared_ptr<TopoInfoDetect> topoDetectServer = make_shared<TopoInfoDetect>();
...
#if 1
TEST_F(LoadBackupIpTest, st_topo_exchange_verify_backup_ip)
{
...
#if 1
TEST_F(LoadBackupIpTest, st_cluster_info_backup_ip)
{
...
#if 1
TEST_F(LoadBackupIpTest, st_cluster_info_backup_ip_fail_e_para)
{
    nlohmann::json rank_table =
    {
        {"status", "completed"},
...
#if 1
TEST_F(LoadBackupIpTest, st_GetSingleDevicePort)
{
    nlohmann::json rank_table =
    {
        {"status", "completed"},
...
#if 1
TEST_F(LoadBackupIpTest, st_GetSingleDevicePort_Vnic)
{
    nlohmann::json rank_table =
    {
        {"status", "completed"},
...
TEST_F(LoadBackupIpTest, st_topo_exchange_verify_superPodId)
{
    HcclIpAddress localIp(1694542016);
    HcclNetDevCtx netDevCtx;
    HcclBasicRankInfo localRankInfo;
...
TEST_F(LoadBackupIpTest, st_GetSingleServer_failed)
{
    nlohmann::json rank_table;
