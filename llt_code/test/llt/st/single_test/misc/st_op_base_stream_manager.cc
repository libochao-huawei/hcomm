...
TEST_F(OpBaseStreamManagerTest, st_register_alloc_and_get_master)
{
...
TEST_F(OpBaseStreamManagerTest, st_get_one_slave)
{
...
TEST_F(OpBaseStreamManagerTest, st_get_muti_slaves)
{
...
TEST_F(OpBaseStreamManagerTest, st_get_zero_slave)
{
...
TEST_F(OpBaseStreamManagerTest, st_get_slave_exceed_fail)
{
...
TEST_F(OpBaseStreamManagerTest, st_get_slave_stream_alloc_fail)
{
