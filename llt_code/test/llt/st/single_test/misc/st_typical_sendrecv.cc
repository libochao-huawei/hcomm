...
public:
    struct mr_info testlocalWindowMem_;
    struct mr_info testremoteWindowMem_;

    struct mr_info testlocalSyncMemPrepare_;
    struct mr_info testlocalSyncMemDone_;
    struct mr_info testlocalSyncMemAck_;

    struct mr_info testremoteSyncMemPrepare_;
    struct mr_info testremoteSyncMemDone_;
    struct mr_info testremoteSyncMemAck_;

    struct mr_info testnotifySrcMem_;

};

HcclResult hrtRaRecvWrlistMock(QpHandle handle, struct recv_wrlist_data *wr, unsigned int recvNum,
...
TEST_F(TypicalSendRecvTest, st_TypicalSendRecv_send)
{
    QpHandle qpHandle;
...
TEST_F(TypicalSendRecvTest, st_TypicalSendRecv_recv)
{
    QpHandle fakeQpHandle = (void *)0x1000000;
    HcclResult ret;
...
TEST_F(TypicalSendRecvTest, st_TypicalSendRecv_send_when_user_addr_overlapped_with_window_mem_then_success)
{
    QpHandle qpHandle;
    QpHandle fakeQpHandle = (void *)0x1000000;
    HcclResult ret;
...
TEST_F(TypicalSendRecvTest, st_TypicalSendRecv_put)
{
    QpHandle fakeQpHandle = (void *)0x1000000;
    HcclResult ret;
...
TEST_F(TypicalSendRecvTest, st_TypicalSendRecv_batchput)
{
    QpHandle fakeQpHandle = (void *)0x1000000;
    HcclResult ret;
