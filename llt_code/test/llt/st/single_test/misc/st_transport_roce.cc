...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_SendAsync)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_Send_Success)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transport("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_Send_Fail)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transport("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    MOCKER_CPP_VIRTUAL(transport, &TransportHeterogRoce::Isend)
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_WaitSendAsyncComplete)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transport("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    HcclStatus compState = {0};
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_Recv_Success)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transport("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_Recv_Fail)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transport("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogRoce transport("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_SendRecv_Success)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transport("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogRoce transport("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_SendRecv_Fail)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transport("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogRoce transport("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_WaitCompletion)
{
    struct ibv_cq cq;
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TaskExec)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_isSupportTransportWithReduce)
{
    MachinePara machinePara;
    std::chrono::milliseconds timeout;
    HcclIpAddress invalidIp;
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_RxWithReduce)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TxWithReduce)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_GetRemoteMem)
{
    MachinePara machinePara;
    std::chrono::milliseconds timeout;
    HcclIpAddress invalidIp;
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_RxWaitDone)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TxWaitDone)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TaskExecCallback)
{
    MOCKER(hrtSetDevice)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_RxAck)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TxAck)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_RxAsync)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_RxAsync_alltoallv)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TxAsync_alltoallv)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TxAsync)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_RxDataSignal)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_TxDataSignal)
{
    MOCKER(hrtGetStreamId)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_DeInit)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_RegUserMem)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_GetRemoteAddr)
{
    MemMsg mrMsg;
    void *dataPtr = &mrMsg;
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_InitMem)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_CreateCqAndQp)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_DestroyCqAndQp)
{
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_GetNicHandle)
{
    MachinePara machinePara;
    std::chrono::milliseconds timeout;
    HcclIpAddress invalidIp;
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_TransportRoce_Init)
{
    MOCKER(hrtGetDevice)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_ROCE_TEST, st_hrtIbvGetCqEvent_err)
{
