...
TEST_F(OffloadStreamManagerTest, st_register_and_get_one_slave)
{
...
TEST_F(OffloadStreamManagerTest, st_register_and_get_muti_slaves)
{
    s32 ret = HCCL_SUCCESS;
    std::vector<Stream> outStream;
...
TEST_F(OffloadStreamManagerTest, st_register_and_get_zero_slave)
{
    s32 ret = HCCL_SUCCESS;
    std::vector<Stream> outStream;
...
TEST_F(OffloadStreamManagerTest, st_get_zero_slave_no_register)
{
    s32 ret = HCCL_SUCCESS;
    std::vector<Stream> outStream;
...
TEST_F(OffloadStreamManagerTest, st_register_slave_fail)
{
    s32 ret = HCCL_SUCCESS;
    std::vector<Stream> outStream;
...
TEST_F(OffloadStreamManagerTest, st_get_slave_exceed_fail)
{
    s32 ret = HCCL_SUCCESS;
    std::vector<Stream> outStream;
...
TEST_F(OffloadStreamManagerTest, st_get_slave_invalid_tag_fail)
{
    s32 ret = HCCL_SUCCESS;
    std::vector<Stream> outStream;
...
TEST_F(OffloadStreamManagerTest, st_register_and_get_master)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(OffloadStreamManagerTest, st_get_unregistered_master_fail)
{
    s32 ret = HCCL_SUCCESS;
    Stream master(StreamType::STREAM_TYPE_OFFLINE);
    Stream outStream;
