...
TEST_F(OpRetryConnTest, st_opretry_connection_setget)
{
    bool enable = true;
...
TEST_F(OpRetryConnTest, st_opretry_connection_default_root)
{
...
TEST_F(OpRetryConnTest, st_opretry_connection)
{
    OpRetryConnection conn;
    u32 rankId = 0;
    u32 rankSize = 1;
...
TEST_F(OpRetryConnTest, st_invalid_params)
{
    u32 rankId = 2;
    u32 rankSize = 1;
    u32 rootRank = 0;
...
TEST_F(OpRetryConnTest, st_opretry_connection_whitelist)
{
    OpRetryConnection conn;
    u32 rankId = 0;
    u32 rankSize = 1;
...
TEST_F(OpRetryConnTest, st_opretry_connection_static_init)
{
    u32 rankId = 0;
    u32 rankSize = 1;
    u32 rootRank = 0;
...
TEST_F(OpRetryConnTest, st_opretry_connect_error)
{
    u32 rankId = 0;
    u32 rankSize = 1;
    u32 rootRank = 0;
...
TEST_F(OpRetryConnTest, st_opretry_wait_error)
{
