...
TEST_F(OpbaseMultiThreadTest, st_HcclAllReduce)
{
    int ret = HCCL_SUCCESS;
    uint32_t ndev = 1;
...
#if 0 //执行失败Unknown comm devType
TEST_F(OpbaseMultiThreadTest, st_HcclAllGather)
{
    int ret = HCCL_SUCCESS;
    uint32_t ndev = 1;
    int32_t devices[ndev] = {0};
...
#if 0 //执行失败Unknown comm devType
TEST_F(OpbaseMultiThreadTest, st_HcclBroadCast)
{
    int ret = HCCL_SUCCESS;
    uint32_t ndev = 1;
    int32_t devices[ndev] = {0};
...
#if 0 //执行失败Unknown comm devType
TEST_F(OpbaseMultiThreadTest, st_HcclReduceScatter)
{
    int ret = HCCL_SUCCESS;
    uint32_t ndev = 1;
    int32_t devices[ndev] = {0};
...
#if 0 //执行失败Unknown comm devType
TEST_F(OpbaseMultiThreadTest, st_HcclReduce)
{
    int ret = HCCL_SUCCESS;
    uint32_t ndev = 1;
    int32_t devices[ndev] = {0};
