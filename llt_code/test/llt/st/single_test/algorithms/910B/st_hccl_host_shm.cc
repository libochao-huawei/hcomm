...
void* impl_host_shm_broadcast_task(void* parg)
{
    ...
    if (stream_list_size > 0) {
        ...
        ret = hcom_info.pComm->SetWorkspaceResource("tag_impl_host_shm_broadcast_task", memptr, memSize, streamList);
        EXPECT_EQ(ret, HCCL_SUCCESS);
    }
    ...
    ret = hcom_info.pComm->Broadcast("tag_impl_host_shm_broadcast_task",
                                      para_info->sendbuff,
                                      para_info->count,
                                      para_info->datatype,
                                      para_info->root,
    ...
    // ret = NetworkManager::GetInstance(devicePhyId).StopVnic();
    // EXPECT_EQ(ret, HCCL_SUCCESS);
    // ret = NetworkManager::GetInstance(devicePhyId).DeInit(NICDeployment::NIC_DEPLOYMENT_DEVICE);
    // EXPECT_EQ(ret, HCCL_SUCCESS);
    return (NULL);
}
...
void* impl_host_shm_all_reduce_task(void* parg)
{
    ...
    if (stream_list_size > 0) {
        ...
        ret = hcom_info.pComm->SetWorkspaceResource("tag_impl_host_shm_all_reduce_task", memptr, memSize, streamList);
        EXPECT_EQ(ret, HCCL_SUCCESS);
    }
    //-----------------Get Workspace Resource End------------------//
    bool swapped;
    ...
    ret =  hcom_info.pComm->AllReduce("tag_impl_host_shm_all_reduce_task",
                               para_info->sendbuff,
                               para_info->recvbuff,
                               para_info->count,
                               para_info->datatype,
...
void* impl_host_shm_reduce_scatter_task(void* parg)
{
    HcclResult ret = HCCL_SUCCESS;
    para_t* para_info = (para_t*)parg;
    s32 rank_num_tmp;
    ...
    if (stream_list_size > 0) {
        ...
        ret = hcom_info.pComm->SetWorkspaceResource("tag_impl_host_shm_reduce_scatter_task", memptr, memSize, streamList);
        EXPECT_EQ(ret, HCCL_SUCCESS);
    }
    //-----------------Get Workspace Resource End------------------//
    rank_num_tmp = *(para_info->sync_addr) - 1;
    ...
    ret =  hcom_info.pComm->ReduceScatter("tag_impl_host_shm_reduce_scatter_task",
                               para_info->sendbuff,
                               para_info->recvbuff,
                               para_info->count,
                               para_info->datatype,
...
void* impl_host_shm_all_gather_task(void* parg)
{
    HcclResult ret = HCCL_SUCCESS;
    para_t* para_info = (para_t*)parg;
    s32 rank_num_tmp;
    ...
    ret = hcom_info.pComm->SetWorkspaceResource("tag_impl_host_shm_all_gather_task", memptr, memSize, streamList);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    //-----------------Get Workspace Resource End------------------//
    rank_num_tmp = *(para_info->sync_addr) - 1;
    ...
    ret =  hcom_info.pComm->AllGather("tag_impl_host_shm_all_gather_task",
                               para_info->sendbuff,
                               para_info->recvbuff,
                               para_info->count,
                               para_info->datatype,
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_host_shm_impl_610_2rank_1server_all_gather_float)
{
    char file_name_t[] = "./st_hccl_host_shm_impl_610_2rank_1server_all_gather_float.json";
   ...
   for (s32 i = 0; i < ndev; ++i)
 {
    ...
    for (s32 i = 0; i < ndev; i++)
    {
        tid[i] = sal_thread_create("thread", impl_host_shm_all_gather_task, (void*)&para_info[i]);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_2rank_1server_host_shm_reduce_scatter_float)
{
    char file_name_t[] = "./st_hccl_impl_610_2rank_1server_host_shm_reduce_scatter_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
   ...
   for (s32 i = 0; i < ndev; ++i)
 {
    ...
    for (s32 i = 0; i < ndev; i++)
    {
        tid[i] = sal_thread_create("thread", impl_host_shm_reduce_scatter_task, (void*)&para_info[i]);
        EXPECT_NE(tid[i], (sal_thread_t )NULL);
    }
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_8rank_1server_allreduce_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_8rank_1server_allreduce_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_8rank_1server_allreduce_float)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_8rank_1server_allreduce_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_5rank_1server_allreduce_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_5rank_1server_allreduce_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_4rank_1server_allreduce_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_4rank_1server_allreduce_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_2rank_1server_allreduce_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_allreduce_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_3rank_1server_allreduce_float)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_3rank_1server_allreduce_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_2rank_1server_allreduce_float)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_allreduce_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_8rank_1server_broadcast_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_8rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_8rank_1server_broadcast_float)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_8rank_1server_broadcast_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_2rank_1server_broadcast_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_2rank_1server_broadcast_float)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#endif
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_3rank_1server_broadcast_float)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#endif
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_3rank_1server_broadcast_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#endif
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_5rank_1server_broadcast_float)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#endif
#if 1
TEST_F(HcclImplCommonTest, st_hccl_impl_610_host_shm_5rank_1server_broadcast_char)
{
    char file_name_t[] = "./st_hccl_impl_610_host_shm_2rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
#if 1
TEST_F(HcclImplCommonTest, st_hccl_host_shm_test)
{
