...
TEST_F(ExchangerNetworkTest, st_init_rdma)
{   
...
TEST_F(ExchangerNetworkTest, st_init_1_dev)
{
    s32 ret = HCCL_SUCCESS;
...
#if 1
TEST_F(ExchangerNetworkTest, st_thread_init_2_dev)
{
    s32 ret = HCCL_SUCCESS;
    HcclRootInfo commId;
...
TEST_F(ExchangerNetworkTest, st_init_input_invalid)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ExchangerNetworkTest, st_thread_invalid_send_recv_para)
{
    s32 ret;
    HcclRootInfo commId;
...
TEST_F(ExchangerNetworkTest, st_deinit_failed)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ExchangerNetworkTest, st_NetworkManager_GetInstance)
{
    s32 device_id = 64;
    NetworkManager::GetInstance(device_id);
}

TEST_F(ExchangerNetworkTest, st_MemNameRepository_GetInstance)
{
    s32 device_id = 64;
    MemNameRepository::GetInstance(device_id);
}

TEST_F(ExchangerNetworkTest, st_init_2_dev_nic_fail)
{
    s32 ret = HCCL_SUCCESS;
