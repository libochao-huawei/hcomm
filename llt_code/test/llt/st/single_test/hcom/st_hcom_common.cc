...
protected:
    ...
    {
        std::cout << "HcomCommon_ST SetUP--\033[0m" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "HcomCommon_ST TearDown--\033[0m" << std::endl;
    }
...
TEST_F(HcomCommonTest, st_hcom_common_HcomGetSecAddrCopyFlag)
{
    bool ret;
...
TEST_F(HcomCommonTest, st_hcom_HcomCreateCommCCLbuffer)
{
...
TEST_F(HcomCommonTest, st_hcom_common_HcomGetAicpuOpStreamNotify)
{   
...
TEST_F(HcomCommonTest, st_hcom_common_HcomMc2AiCpuStreamAllocAndGet)
{   
    std::string identifier = "aa";
