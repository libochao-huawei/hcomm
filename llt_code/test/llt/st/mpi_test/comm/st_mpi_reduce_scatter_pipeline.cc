...
TEST_F(MPI_ReduceScatterInter_910B_Test, st_mpi_pipeline_reduce_scatter_4ranks_2server)
{
    RankConsistentcyChecker::GetInstance().ClearCheckInfo();
    nlohmann::json rank_table = rank_table_910_2server_4rank;
    char file_name_t[] = "./st_mpi_pipeline_reduce_scatter_4ranks_2server.json";
...
TEST_F(MPI_ReduceScatterInter_910B_Test, st_mpi_pipeline_reduce_scatter_4ranks_2server_prod)
{
    RankConsistentcyChecker::GetInstance().ClearCheckInfo();
    nlohmann::json rank_table = rank_table_910_2server_4rank;
    char file_name_t[] = "./st_mpi_pipeline_reduce_scatter_4ranks_2server_prod.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
