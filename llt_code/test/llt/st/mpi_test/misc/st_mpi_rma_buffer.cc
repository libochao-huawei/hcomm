...
TEST_F(RmaBufferTest, st_rma_buffer_multi_process)
{
    s32 size, rank;
...
TEST_F(RmaBufferTest, st_rma_buffer_single_process)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(RmaBufferTest, st_mem_mapping_error)
{
...
TEST_F(RmaBufferTest, st_getDevVA_isBackup)
{
    DlHalFunction::GetInstance().DlHalFunctionInit();
    DlHalFunction::GetInstance().handle_ = nullptr;
    unsigned long long int SMALL_PAGE_SIZE = 4096;
