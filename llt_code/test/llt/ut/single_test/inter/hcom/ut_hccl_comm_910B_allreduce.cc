...
TEST_F(HcclCommTest910BAllReduce, ut_allreduce_4p_mesh_big_count_80)
{
    ResetInitState();
    InitExternalInput();
...
TEST_F(HcclCommTest910BAllReduce, ut_allreduce_8p_mesh_big_count_80)
{
    ...
    RankConsistent::GetInstance().ClearCheckInfo();
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_allreduce_8p_ring.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
//71 8p AIV 单算子
TEST_F(HcclCommTest910BAllReduce, ut_allreduce_8p_mesh_aiv_opbase)
{
