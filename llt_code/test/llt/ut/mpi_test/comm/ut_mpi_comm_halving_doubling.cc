...
class MPI_CommBinaryBlocksHD_Test : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MPI_CommBinaryBlocksHD_Test SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "MPI_CommBinaryBlocksHD_Test TearDown" << std::endl;
    }
...
void* InitRaNicResourceHD(u32 deviceId, const char *deviceIp)
{
    HcclResult ret;
    ...
    CHK_PRT_RET(ret, HCCL_ERROR("errNo[0x%016llx] deviceId[%d] socket init failed", HCCL_ERROR_CODE(ret), deviceId), nullptr);
    return socketHandle;
}

void* InitRaVnicResourceHD(u32 deviceId)
{
    struct rdev nicRdevInfo;
    nicRdevInfo.phy_id = deviceId;
    nicRdevInfo.family = AF_INET;
    nicRdevInfo.local_ip.addr.s_addr = deviceId;
    void *socketHandle = nullptr;
