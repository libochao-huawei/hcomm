...
TEST_F(MC2AicpuRetry_UT, st_suspend_in_once_stopLaunch)
{
...
TEST_F(MC2AicpuRetry_UT, st_suspend_in_once_Error)
{
...
TEST_F(MC2AicpuRetry_UT, st_stopExec_in_once_stopExec)
{
...
TEST_F(MC2AicpuRetry_UT, st_stopExec_in_once_End)
{
...
TEST_F(MC2AicpuRetry_UT, st_stopExec_in_once_Error)
{
...
TEST_F(MC2AicpuRetry_UT, st_clean_in_once_clean)
{
...
TEST_F(MC2AicpuRetry_UT, st_clean_in_once_End)
{
...
TEST_F(MC2AicpuRetry_UT, st_clean_in_once_Error)
{
...
TEST_F(MC2AicpuRetry_UT, st_cleanEnd_in_once_End)
{
...
TEST_F(MC2AicpuRetry_UT, st_UnRegisterBackGroundThread_success){
    HcclCommunicator *hcclCommunicator = new HcclCommunicator();
...
TEST_F(MC2AicpuRetry_UT, st_aicpuHdc)
{
    AicpuHdc aicpuHdc;
...
TEST_F(MC2AicpuRetry_UT, st_destroy_aicpu_comm)
{
...
TEST_F(MC2AicpuRetry_UT, st_Handle_Resume_ChangeLink)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
