...
TEST_F(RankGraph64Plus1Test, test_4p_without_backup)
{
    ...
    string topoFilePath{HCOMM_CODE_ROOT_DIR "/test/orion/ut/framework/topo/new_topo_builder/rank_graph_64_plus_1/topo_4p.json"};
...
TEST_F(RankGraph64Plus1Test, test_RankGraph_Build_without_Backup)
{
    // 直接启动，不使用备份D
    RankGraphBuilder rankGraphBuilder;
    string topoFilePath{HCOMM_CODE_ROOT_DIR "/test/orion/ut/framework/topo/new_topo_builder/rank_graph_64_plus_1/topo_2x2plus1.json"};
...
TEST_F(RankGraph64Plus1Test, test_checkpoint_normal_to_backup)
{
    ...
    // 更新 rankTableInfo
    string changeInfoFilePath{HCOMM_CODE_ROOT_DIR "/test/orion/ut/framework/topo/new_topo_builder/rank_graph_64_plus_1/changeInfo_2x2_normal_to_backup.json"};
...
TEST_F(RankGraph64Plus1Test, test_checkpoint_normal_switch_pod_without_backup)
{
    ...
    // 更新 rankTableInfo
    string changeInfoFilePath{HCOMM_CODE_ROOT_DIR "/test/orion/ut/framework/topo/new_topo_builder/rank_graph_64_plus_1/changeInfo_normal_switch_pod_without_backup.json"};
    EXPECT_EQ(DiffRankUpdater(changeInfoFilePath.c_str(), rankTableInfo), HcclResult::HCCL_SUCCESS);
