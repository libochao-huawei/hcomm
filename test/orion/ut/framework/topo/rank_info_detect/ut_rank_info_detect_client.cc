...
std::string filePath{HCOMM_CODE_ROOT_DIR "/test/orion/ut/framework/topo/rank_info_detect/rootinfo.json"};
...
TEST_F(RankInfoDetectClientTest, Ut_ConstructRankTable_When_Normal_Expect_Success)
{
    ...
    RankTableInfo localRankTable;
    std::string testJsonPath{HCOMM_CODE_ROOT_DIR "/test/orion/ut/framework/topo/rank_info_detect/rootInfo.json"};
