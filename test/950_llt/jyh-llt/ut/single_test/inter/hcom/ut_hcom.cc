...
#include "hccl/framework/hcom/hcom_private.h"
#include "config.h"
#include "sal.h"
#include "stream_pub.h"
...
TEST_F(HcomTest, ut_HcclCommGlobalWorkSpace_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
...
TEST_F(HcomTest, should_return_substream_num_when_910c_allgather_graph_pipeline)
{
    HcclCommunicator comm;
...
TEST_F(HcomTest, ut_HcclCommGraphSetAivCoreLimit_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
...
TEST_F(HcomTest, ut_HcomCalcTaskNum_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
    ...
    HcomOpParam opParam;
    u32 taskNum = 0;
    HcclResult result = HcomCalcTaskNum(&opParam, taskNum);
    EXPECT_EQ(result, HCCL_SUCCESS);
    result = HcclCommCalcTaskNum(&opParam, taskNum);
    EXPECT_EQ(result, HCCL_SUCCESS);
    GlobalMockObject::verify();
#define OPEN_BUILD_PROJECT
}

TEST_F(HcomTest, ut_MakeEnumToDevType_When_Normal_Expect_ReturnlsDEV_TYPE_910)
{  
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
...
TEST_F(HcomTest, ut_MakeEnumToDevType_not_Find_When_Abnormal_Expect_ReturnlsDEV_TYPE_NOSOC)
{
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
...
TEST_F(HcomTest, ut_HcomCheckCommValidity_When_Abnormal_Expect_ReturnlsHCCL_E_PTR)
{
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
...
TEST_F(HcomTest, ut_HcomSetQosCfg_When_Abnormal_Expect_ReturnlsHCCL_E_PTR)
{
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
...
TEST_F(HcomTest, ut_HcomGetandClearOverFlowTasks_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
...
TEST_F(HcomTest, ut_HcclCommGetandClearOverFlowTasks_When_Normal_Expect_ReturnlsHCCL_SUCCESS)
{
#ifdef OPEN_BUILD_PROJECT
#undef OPEN_BUILD_PROJECT
#endif
