...
class AllGatherRingDirectTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        ...
        std::cout << "\033[36m--AllGatherRingDirectTest SetUP--\033[0m" << std::endl;
    }
    static void TearDownTestCase()
    {
        ...
        std::cout << "\033[36m--AllGatherRingDirectTest TearDown--\033[0m" << std::endl;
    }
...
HcclDispatcher AllGatherRingDirectTest::dispatcherPtr = nullptr;
DispatcherPub *AllGatherRingDirectTest::dispatcher = nullptr;

TEST_F(AllGatherRingDirectTest, destructor_D0)
{
    ...
    AlgTemplateBase *tempAlg = new AllGatherRingDirect(dispatcher);
    ret = tempAlg->Prepare(&opInfo, userRank, userMemInputSlices);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(AllGatherRingDirectTest, run_async_00)
{
    s32 ret = HCCL_SUCCESS;
    ...
    AlgTemplateBase *tempAlg = new AllGatherRingDirect(dispatcher);
    ret = tempAlg->Prepare(&opInfo, userRank, tmpUserMemInputSlices);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(AllGatherRingDirectTest, run_async_01)
{
    s32 ret = HCCL_SUCCESS;
