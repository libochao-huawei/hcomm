...
{
    run_async_test_bcast_nhr(dispatcher, /*rank=*/0, /*rankSize=*/4, /*root=*/0, /*nLinks=*/3);
}
#endif
...
{
    run_async_test_bcast_nhr(dispatcher, /*rank=*/1, /*rankSize=*/8, /*root=*/0, /*nLinks=*/-1, /*barrier=*/false);
}

#if 1
// rankszie>1, root = rank, root=0
TEST_F(BroadcastNHRInterTest, run_async_08)
{
