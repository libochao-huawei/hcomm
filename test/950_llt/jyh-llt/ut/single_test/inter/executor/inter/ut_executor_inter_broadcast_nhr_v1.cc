...
{
    run_async_test_bcast_nhr_v1(dispatcher, /*rank=*/0, /*rankSize=*/4, /*root=*/0, /*nLinks=*/3);
}
#endif
...
{
    run_async_test_bcast_nhr_v1(dispatcher, /*rank=*/2, /*rankSize=*/8, /*root=*/2);
}
#endif
...
{
    run_async_test_bcast_nhr_v1(dispatcher, /*rank=*/0, /*rankSize=*/8, /*root=*/2);
}
#endif
...
{
    run_async_test_bcast_nhr_v1(dispatcher, /*rank=*/2, /*rankSize=*/8, /*root=*/0);
}
#endif
...
{
    run_async_test_bcast_nhr_v1(dispatcher, /*rank=*/1, /*rankSize=*/8, /*root=*/0, /*nLinks=*/-1, /*barrier=*/false);
}