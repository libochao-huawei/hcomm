...
class ScatterNBInterTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        ...
        std::cout << "\033[36m--ScatterNBInterTest SetUP--\033[0m" << std::endl;
    }
    static void TearDownTestCase()
    {
        ...
        std::cout << "\033[36m--ScatterNBInterTest TearDown--\033[0m" << std::endl;
    }
...
HcclDispatcher ScatterNBInterTest::dispatcherPtr = nullptr;
DispatcherPub *ScatterNBInterTest::dispatcher = nullptr;

#if 1
TEST_F(ScatterNBInterTest, destructor_D0)
{
    ...
    ScatterNB* tempAlg = new ScatterNB(dispatcher);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
#endif
#if 1
TEST_F(ScatterNBInterTest, run_async_00)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterNBInterTest, run_async_01)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterNBInterTest, run_async_02)
{
     s32 ret = HCCL_SUCCESS;
...
#if 1
//  chunksize不够128字节均分
TEST_F(ScatterNBInterTest, run_async_03)
{
    s32 ret = HCCL_SUCCESS;
...
#if 1
// ranksize ==1 分支?
TEST_F(ScatterNBInterTest, run_async_04)
{
     s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterNBInterTest, run_async_05)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterNBInterTest, run_async_06)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterNBInterTest, run_async_linkerr_1)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterNBInterTest, run_async_linkerr_2)
{
    s32 ret = HCCL_SUCCESS;
...
void run_async_test_scatter_nb(DispatcherPub *dispatcher, u32 rank, u32 rankSize, u32 root, s32 nLinks = -1,
...
// ranksize=1
TEST_F(ScatterNBInterTest, run_async_000)
{
    run_async_test_scatter_nb(dispatcher, /*rank=*/0, /*rankSize=*/1, /*root=*/0);
}

// ranksize>1, links.size() < rankSize
TEST_F(ScatterNBInterTest, run_async_001)
{
    run_async_test_scatter_nb(dispatcher, /*rank=*/0, /*rankSize=*/4, /*root=*/0, /*nLinks=*/3);
}

// rankszie=8, root=0, rank=0
TEST_F(ScatterNBInterTest, run_async_002)
{
    run_async_test_scatter_nb(dispatcher, /*rank=*/0, /*rankSize=*/8, /*root=*/0);
}

// rankszie=8, root=0, rank=1
TEST_F(ScatterNBInterTest, run_async_003)
{
    run_async_test_scatter_nb(dispatcher, /*rank=*/1, /*rankSize=*/8, /*root=*/0);
}

// rankszie=8, root=0, rank=7
TEST_F(ScatterNBInterTest, run_async_004)
{
    run_async_test_scatter_nb(dispatcher, /*rank=*/7, /*rankSize=*/8, /*root=*/0);
}

// rankszie=8, root=0, rank=0, nicRankList={0}
TEST_F(ScatterNBInterTest, run_async_006)
{
    std::vector<u32> nicRankList = {0};
    run_async_test_scatter_nb(dispatcher, /*rank=*/0, /*rankSize=*/8, /*root=*/0, /*nLinks=*/-1, nicRankList);
}

// rankszie=8, root=0, rank=0, nicRankList={1}
TEST_F(ScatterNBInterTest, run_async_007)
{
...
TEST_F(ScatterNBInterTest, run_async_008)
{
    std::vector<u32> nicRankList = {0};
    run_async_test_scatter_nb(dispatcher, /*rank=*/1, /*rankSize=*/8, /*root=*/0, /*nLinks=*/-1, nicRankList);
}

// rankszie=8, root=0, rank=1, nicRankList={1}
TEST_F(ScatterNBInterTest, run_async_009)
{
    std::vector<u32> nicRankList = {1};
    run_async_test_scatter_nb(dispatcher, /*rank=*/1, /*rankSize=*/8, /*root=*/0, /*nLinks=*/-1, nicRankList);
}
