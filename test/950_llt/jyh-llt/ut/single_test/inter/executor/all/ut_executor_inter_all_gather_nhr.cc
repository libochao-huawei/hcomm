...
class AllGatherNHRInterTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        ...
        std::cout << "\033[36m--AllGatherNHRInterTest SetUP--\033[0m" << std::endl;
    }
    static void TearDownTestCase()
    {
        ...
        std::cout << "\033[36m--AllGatherNHRInterTest TearDown--\033[0m" << std::endl;
    }
...
HcclDispatcher AllGatherNHRInterTest::dispatcherPtr = nullptr;
DispatcherPub *AllGatherNHRInterTest::dispatcher = nullptr;

TEST_F(AllGatherNHRInterTest, destructor_D0)
{
    ...
    AlgTemplateBase * tempAlg = new AllGatherNHR(dispatcher);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
#if 1
//对应代码中，ranksize ==1
TEST_F(AllGatherNHRInterTest, run_async_00)
{
    s32 ret = HCCL_SUCCESS;
    u32 rank = 0;
    u32 rankSize = 1;
...
#if 1
//对应代码中，ranksize ==1
TEST_F(AllGatherNHRInterTest, run_async_01)
{
    s32 ret = HCCL_SUCCESS;
    u32 rank = 0;
    u32 rankSize = 1;
...
#if 1
//对应代码中，ranksize ==1
TEST_F(AllGatherNHRInterTest, run_async_02)
{
    s32 ret = HCCL_SUCCESS;
    u32 rank = 0;
    u32 rankSize = 1;
...
#if 1
//对应代码中，ranksize ==1
TEST_F(AllGatherNHRInterTest, run_async_03)
{
    s32 ret = HCCL_SUCCESS;
    u32 rank = 0;
    u32 rankSize = 1;
...
TEST_F(AllGatherNHRInterTest, test_RunAsyncWithReorder)
{
    s32 ret = HCCL_SUCCESS;
    u32 rank = 1;
    u32 rankSize = 8;
