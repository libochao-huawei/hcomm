...
void* inter_all_gather_task(void* parg)
{
    ...
    ret = RankConsistentcyChecker::GetInstance().RecordOpPara(HcclCMDType::HCCL_CMD_ALLGATHER, "tag", para_info->count, para_info->datatype, HcclReduceOp::HCCL_REDUCE_SUM,
        0, 0, 0, groupName.c_str(), 0);
