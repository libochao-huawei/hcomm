...
TEST_F(LinkIbvExpTest, ut_transport_ibv_multi_qp_configpath)
{
    ...
    transportIbverbs.machinePara_.srcPorts = std::vector<std::uint16_t>(3, 0);
...
TEST_F(LinkIbvExpTest, ut_transport_ibv_fence_test)
{
    ...
    MOCKER_CPP(&TransportIbverbs::RdmaSendAsyncHostNIC, HcclResult(TransportIbverbs::*)(struct SendWrlistDataExt&, Stream&, WqeType, u64))
    .stubs()
    .will(returnValue(HCCL_SUCCESS));
