...
TEST_F(CollAllGatherInterTest, ut_mesh)
{
...
TEST_F(CollAllGatherInterTest, ut_mesh_opbase)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollAllGatherInterTest, ut_CheckRankIpFamily_ERROR)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(CollAllGatherInterTest, ut_mesh_UseInterServerNHRAlgo)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollAllGatherInterTest, ut_mesh_UseInterServerNHRV1Algo)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollAllGatherInterTest, ut_mesh_UseInterServerNBAlgo)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
#if 1
TEST_F(CollAllGatherInterTest, ut_allgather_mesh_smallcount_aiv)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollAllGatherInterTest, ut_allgather_mesh_smallcount_aiv_clear_buffer)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
#if 1
TEST_F(CollAllGatherInterTest, ut_allgather_mesh_aiv)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollAllGatherInterTest, ut_allgather_mesh_aiv_clear_buffer)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
