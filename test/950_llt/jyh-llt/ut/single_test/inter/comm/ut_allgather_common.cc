...
void* impl_common_all_gather_task(void* parg)
{
    ...
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ret = CfgGetClusterInfo(rankTableM, para_info->identify, g_hcom_info.params, g_hcom_info.rankTable);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    sal_memcpy(g_hcom_info.params.id.internal, sizeof(HcclRootInfo), &para_info->rootInfo, sizeof(HcclRootInfo));

    g_hcom_info.pComm.reset(new(std::nothrow) hccl::hcclComm(209715200, 209715200));
    CommConfig commConfig("WORLD_GROUP_01");
    ret = g_hcom_info.pComm->init(g_hcom_info.params, commConfig, g_hcom_info.rankTable);
    if (ret != HCCL_SUCCESS)
    {
    ...
    ret = g_hcom_info.pComm->GetWorkspaceSubStreamNum(stream_list_size);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    u32 rankSize = 0;
    ret = g_hcom_info.pComm->GetRankSize(rankSize);
    EXPECT_EQ(ret, HCCL_SUCCESS);

    u64 memSize = 0;
    ret = g_hcom_info.pComm->GetWorkspaceMemSize(HCCL_KERNEL_OP_TYPE_ALLGATHER, para_info->count, para_info->datatype, rankSize, memSize);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    ret = g_hcom_info.pComm->SetWorkspaceResource("tag_impl_common_all_gather_task_inter", memptr, memSize, streamList);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    ret =  g_hcom_info.pComm->AllGather("tag_impl_common_all_gather_task_inter",
                               para_info->sendbuff,
                               para_info->recvbuff,
                               para_info->count,
                               para_info->datatype,
    ...
    {
        HCCL_ERROR("rank[%d] task allgather falis", g_hcom_info.params.rank);
    }
    //--------------Resource destroy----------------//
    for (s32 i = 0; i < stream_list_size; i++)
    {
...
{
    char file_name_t[] = "./ut_hccl_impl_610_8rank_1server_all_gather_char.json";
...
{
    char file_name_t[] = "./ut_hccl_impl_610_8rank_1server_all_gather_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_5rank_1server_all_gather_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_4rank_1server_all_gather_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_2rank_1server_all_gather_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_3rank_1server_all_gather_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_2rank_1server_all_gather_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_8rank_1server_all_gather_memsampler_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
