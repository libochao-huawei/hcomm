...
#if 1
TEST_F(CollReduceScatterInterTest, ut_reducescatter_mesh_smallcount_aiv)
{
...
TEST_F(CollReduceScatterInterTest, ut_reducescatter_mesh_smallcount_aiv_clear_buffer)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
#if 1
TEST_F(CollReduceScatterInterTest, ut_reducescatter_mesh_aiv)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollReduceScatterInterTest, ut_reducescatter_mesh_aiv_clear_buffer)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollReduceScatterInterTest, ut_reducescatter_mesh_aiv_clear_buffer_zerocopy)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
