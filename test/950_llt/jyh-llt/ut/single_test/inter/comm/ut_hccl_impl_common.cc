...
void* impl_common_broadcast_task(void* parg)
{
    ...
    ret = hcom_info.pComm->Broadcast("tag_impl_common_broadcast_task_inter",
                                      para_info->sendbuff,
                                      para_info->count,
                                      para_info->datatype,
                                      para_info->root,
...
void* impl_common_all_reduce_task(void* parg)
{
    ...
    ret =  hcom_info.pComm->AllReduce("tag_impl_common_all_reduce_task_inter",
                               para_info->sendbuff,
                               para_info->recvbuff,
                               para_info->count,
                               para_info->datatype,
...
TEST_F(HcclImplCommonTest, ut_hccl_impl_610_8rank_1server_allreduce_char)
{
    ...
    char file_name_t[] = "./ut_hccl_impl_610_8rank_1server_allreduce_char.json";
...
{
    char file_name_t[] = "./ut_hccl_impl_610_8rank_1server_allreduce_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_5rank_1server_allreduce_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_4rank_1server_allreduce_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_2rank_1server_allreduce_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_3rank_1server_allreduce_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_2rank_1server_allreduce_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_8rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    setenv("PROFILING_MODE", "true", 1);
    char file_name_t[] = "./ut_hccl_impl_610_8rank_1server_broadcast_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_2rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_2rank_1server_broadcast_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_3rank_1server_broadcast_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_3rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_5rank_1server_broadcast_float.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
{
    char file_name_t[] = "./ut_hccl_impl_610_5rank_1server_broadcast_char.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
