...
#if 1
TEST_F(CollBatchSendRecvExecutorTest, test_BatchSendRecv_host_unfold)
{
...
TEST_F(CollBatchSendRecvExecutorTest, ut_aicpu_unfold_SetRetryEnable)
{
    (void) SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
...
TEST_F(CollBatchSendRecvExecutorTest, ut_execop_aivmode)
{
    (void) SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
...
TEST_F(CollBatchSendRecvExecutorTest, ut_execop_cache)
{
    (void) SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
...
TEST_F(CollBatchSendRecvExecutorTest, ut_execop_cache_alltoall)
{
    (void) SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
...
#if 1
TEST_F(CollBatchSendRecvExecutorTest,  ut_BatchSendRecv_create_link_incrementally)
{
    (void) SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
...
TEST_F(CollBatchSendRecvExecutorTest, ut_GetPairWiseList_AllSend){
    (void) SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollBatchSendRecvExecutorTest, ut_GetPairWiseList_SendRecvNormal){
    (void) SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollBatchSendRecvExecutorTest, ut_GetPairWiseList_paraError){
