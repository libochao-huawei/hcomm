...
TEST_F(OneSidedUt, ut_exception_handler)
{
    try {
...
HcclResult ut_rma_buffer_mgr_test()
{
    EXCEPTION_HANDLE_BEGIN
...
TEST_F(OneSidedUt, ut_rma_buffer_mgr)
{
    EXPECT_EQ(ut_rma_buffer_mgr_test(), HCCL_SUCCESS);
}

TEST_F(OneSidedUt, ut_one_sided_service_mem_regDereg_enable_disable_roce)
{
...
TEST_F(OneSidedUt, ut_test_rma_buffer_impl)
{
    int ret = HCCL_SUCCESS;
    s8* localbuf;
    s8* remotebuf;
...
TEST_F(OneSidedUt, ut_test_rma_buffer_SetIpcMem_noOffset)
{
   int ret = HCCL_SUCCESS;
    s8* localbuf;
    s8* remotebuf;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_regDereg_enable_disable_ipc)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_regDereg_enable_disable_a3_rdma)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_exchange)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_exchange_create_socket_failed)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_exchange_sendReceive_roce_0)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_BatchPut_BatchPut_error_param)
{
    ...
    ret = HcclBatchPut(comm, 1, desc, MAX_DESC_NUM + 1, stream);
    EXPECT_EQ(ret, HCCL_E_PARA);

    ret = HcclBatchGet(comm, 1, desc, MAX_DESC_NUM + 1, stream);
    EXPECT_EQ(ret, HCCL_E_PARA);
...
TEST_F(OneSidedUt, ut_one_sided_service_HcclBatchPut_HcclBatchGet_success_roce)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_HcclBatchPut_HcclBatchGet_success_ipc)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_HcclBatchPut_HcclBatchGet_mem_not_found)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_DeinitOneSidedCtx)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_RegHostMemMax)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_RegDevMemMax)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_RegUnRegDevMemMaxCnt)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_RegUnRegDevMemMaxCnt_multi_remoteRank)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_InitNetDevCtx_Fail)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_InitNetDevCtx_HostDeployment)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_setNetDevCtx)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_init_devIpAddrEmpty)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_BatchPut_Rma_Buffer_test)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_opbase_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_RemapRegistedMemory_roce_01)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_RemapRegistedMemory_roce_02)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_conn_conect)
{
    NetDevContext devContext;
    devContext.nicType_ = NicType::DEVICE_NIC_TYPE;
    devContext.localIpcRmaBufferMgr_ = std::make_shared<LocalIpcRmaBufferMgr>();
    ...
    EXPECT_EQ(ret, HCCL_SUCCESS);
    connPtr->CleanSocketResource(commIdentifier);

    GlobalMockObject::verify();
}

TEST_F(OneSidedUt, ut_one_sided_service_prepare_fail)
{
    int ret = HCCL_SUCCESS;
...
TEST_F(OneSidedUt, regmem_without_deregmem)
{
    int ret = HCCL_SUCCESS;
...
TEST_F(OneSidedUt, remap_ipc_mem)
{
    int ret = HCCL_SUCCESS;
...
TEST_F(OneSidedUt, ipc_mem_regmem_deregmem)
{
    NetDevContext devContext;
    devContext.nicType_ = NicType::VNIC_TYPE;
    devContext.localIpcRmaBufferMgr_ = std::make_shared<LocalIpcRmaBufferMgr>();
...
TEST_F(OneSidedUt, roce_mem_regmem_deregmem)
{
    NetDevContext devContext;
    devContext.nicType_ = NicType::DEVICE_NIC_TYPE;
    devContext.localIpcRmaBufferMgr_ = std::make_shared<LocalIpcRmaBufferMgr>();
...
TEST_F(OneSidedUt, ut_one_sided_service_batchput_batchget_err)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_batchget_aicpu_rdma)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_opbase_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(OneSidedUt, ut_HcclBatchGetPut_When_SdmaAicpuUnflod_Expect_Success)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_opbase_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(OneSidedUt, ut_one_sided_service_bind_mem)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
...
TEST_F(OneSidedUt, ut_one_sided_globally_bind_mem)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_test_prepare)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_test_RegisterBoundMems)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_service_mem_test_Exchange_and_enable_Mem)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, regmem_without_memExport)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedUt, ut_one_sided_DeregisterGlobalMem_When_2_comms_Expect_ReturnIsHCCL_SUCCESS)
{
    nlohmann::json rank_table = rank_table_910_1server_2rank;
    std::string clusterString = rank_table.dump();
    ...
    HcclCommConfig commConfig1;
    HcclCommConfigInit(&commConfig1);
    commConfig1.hcclBufferSize=800;
    strcpy_s(commConfig1.hcclCommName, COMM_NAME_MAX_LENGTH, "comm1");

    ret = HcclCommInitClusterInfoMemConfig(const_cast<char*>(clusterString.c_str()), rankIdInComm1, &commConfig1, &comm1);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    hccl::hcclComm* hcclComm1 = static_cast<hccl::hcclComm *>(comm1);

    HcclCommConfig commConfig2;
    HcclCommConfigInit(&commConfig2);
    commConfig2.hcclBufferSize=800;
    strcpy_s(commConfig2.hcclCommName, COMM_NAME_MAX_LENGTH, "comm2");

    ret = HcclCommInitClusterInfoMemConfig(const_cast<char*>(clusterString.c_str()), rankIdInComm2, &commConfig2, &comm2);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    hccl::hcclComm* hcclComm2 = static_cast<hccl::hcclComm *>(comm2);

    IHcclOneSidedService *iService1 = nullptr;
    hcclComm1->GetOneSidedService(&iService1);
    EXPECT_NE(iService1, nullptr);
    iService1->netDevIpcCtx_ = nullptr;

    IHcclOneSidedService *iService2 = nullptr;
    hcclComm1->GetOneSidedService(&iService2);
    EXPECT_NE(iService2, nullptr);
    iService2->netDevIpcCtx_ = nullptr;
    ...
    // Service绑定一块内存
    ret = HcclCommBindMem(comm1, memHandle1);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ret = HcclCommBindMem(comm2, memHandle1);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    HcclPrepareConfig config;
    config.topoType = HcclTopoType::HCCL_TOPO_FULLMESH;
    ret = HcclCommPrepare(comm1, &config, 120);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    static_cast<HcclOneSidedService*>(iService1)->prepared_ = false;
    ...
    // 解绑内存
    ret = HcclCommUnbindMem(comm1, memHandle1);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ret = HcclCommUnbindMem(comm2, memHandle1);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    ret = HcclCommDestroy(comm1);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ret = HcclCommDestroy(comm2);
    EXPECT_EQ(ret, HCCL_SUCCESS);
}