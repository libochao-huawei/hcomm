...
class CollScatterUT : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        DlRaFunction::GetInstance().DlRaFunctionInit();
        std::cout << "CollScatterUT set up." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "CollScatterUT tear down" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        std::cout << "A Test case in CollScatterUT SetUp" << std::endl;
    }

    virtual void TearDown()
    {
        std::cout << "A Test case in CollScatterUT TearDown" << std::endl;
...
#if 1
TEST_F(CollScatterUT, CollScatterMeshTest)
{
...
#if 1
TEST_F(CollScatterUT, CollScatterRingTest)
{
    MOCKER(hrtCtxSetCurrent)
    .stubs()
    .with(any())
...
#if 1
TEST_F(CollScatterUT, CollScatterRingFor91093Test)
{
    MOCKER(hrtCtxSetCurrent)
    .stubs()
    .with(any())
...
#if 1
TEST_F(CollScatterUT, CollScatterRingFor91093TestV2)
{
    MOCKER(hrtCtxSetCurrent)
    .stubs()
    .with(any())
...
#if 1
TEST_F(CollScatterUT, CollScatterCommTest)
{
    MOCKER(hrtCtxSetCurrent)
    .stubs()
    .with(any())
