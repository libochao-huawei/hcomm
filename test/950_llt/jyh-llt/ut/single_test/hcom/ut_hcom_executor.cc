...
protected:
    ...
    {
        NetworkManager::GetInstance(0).Destroy();
...
TEST_F(HcomExecutorTest, ut_executor_initgroup1)
{
    ...
    // 走1910 4pring
    char* rank_table_file = "./ut_executor_initgroup1.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_initgroup1_error)
{
    ...
    // 走1910 4pring
    char* rank_table_file = "./ut_executor_initgroup1_error.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_broadcast)
{
    ...
    // 走1910 4pring
    char* rank_table_file = "./ut_executor_broadcast.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_allreduce)
{
    ...
    char* rank_table_file = "./ut_executor_allreduce.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_allreduce_mix)
{
    ...
    char* rank_table_file = "./ut_executor_equeue_allreduce_mix.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_allreduce)
{
    ...
    char* rank_table_file = "./ut_executor_equeue_allreduce.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_reduce_scatter)
{
    ...
    char* rank_table_file = "./ut_executor_equeue_reduce_scatter.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_broardcast)
{
    ...
    char* rank_table_file = "./ut_executor_equeue_broardcast.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_allgather)
{
    ...
    char* rank_table_file = "./ut_executor_equeue_allgather.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_allgather_mutiInit)
{
    ...
    char* rank_table_file = "./ut_executor_equeue_allgather_mutiInit.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_mutiInit)
{
    ...
    char* rank_table_file = "./ut_executor_equeue_mutiInit.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, ut_executor_equeue_alltoallv)
{
    ...
    char *rankTableFile = "./ut_executor_equeue_alltoallv.json";
    ...
    void* comm;
    std::shared_ptr<hccl::hcclComm> hcclComm;
    ret = HcomGetCommByGroup(HCCL_WORLD_GROUP, hcclComm);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    comm = hcclComm.get();
    ret = hccl::HcomExecutor::GetInstance().InitHcclComm(nullptr, comm);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(HcomExecutorTest, ut_executor_equeue_alltoallvc)
{
    ...
    char *rankTableFile = "./ut_executor_equeue_alltoallvc.json";
    ret = HcomInitByFile(rankTableFile, identify);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(HcomExecutorTest, ut_executor_equeue_gather_alltoallv)
{
    ...
    char *rankTableFile = "./ut_executor_equeue_gather_alltoallv.json";
    ret = HcomInitByFile(rankTableFile, identify);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(HcomExecutorTest, ut_executor_reduce)
{
    ...
    char* rank_table_file = "./ut_executor_reduce.json";
    char* rank_ID = "0";
