...
class AllReduceChunkMeshTest : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        ...
        std::cout << "\033[36m--AllReduceChunkMeshTest SetUP--\033[0m" << std::endl;
    }
    static void TearDownTestCase()
    {
        ...
        std::cout << "\033[36m--AllReduceChunkMeshTest TearDown--\033[0m" << std::endl;
    }
...
HcclDispatcher AllReduceChunkMeshTest::dispatcherPtr = nullptr;
DispatcherPub *AllReduceChunkMeshTest::dispatcher = nullptr;


void run_async_test_all_reduce_chunk_mesh_nhr(DispatcherPub *dispatcher, u32 rank, u32 rankSize, u32 root, s32 nLinks = -1, bool barrier = true)
{
    ...
    AllReduceChunkMesh *tempAlg = new AllReduceChunkMesh(dispatcher);
    tempAlg->Prepare(
...
TEST_F(AllReduceChunkMeshTest, run_async_01)
{
    run_async_test_all_reduce_chunk_mesh_nhr(dispatcher, /*rank=*/0, /*rankSize=*/4, /*root=*/0, /*nLinks=*/3);
}
#endif
