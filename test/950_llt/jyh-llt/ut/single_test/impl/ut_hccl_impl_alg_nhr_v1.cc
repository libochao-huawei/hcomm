...
class HcclImplAlgTestNHRV1 : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        ...
        std::cout << "HcclImplAlgTestNHRV1 SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        ...
        std::cout << "HcclImplAlgTestNHRV1 TearDown" << std::endl;
    }
...
HcclDispatcher HcclImplAlgTestNHRV1::dispatcherPtr = nullptr;
DispatcherPub *HcclImplAlgTestNHRV1::dispatcher = nullptr;
...
TEST_F(HcclImplAlgTestNHRV1, ut_ReduceScatterComm_NHR_V1)
{
    ...
    algConfigurator->algType_[HcclCMDType::HCCL_CMD_REDUCE_SCATTER].algoLevel1 = AlgTypeLevel1::ALG_LEVEL1_NHR_V1;
...
TEST_F(HcclImplAlgTestNHRV1, ut_AllGatherComm_NHR_V1)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
    ...
    algConfigurator->algType_[HcclCMDType::HCCL_CMD_ALLGATHER].algoLevel1 = AlgTypeLevel1::ALG_LEVEL1_NHR_V1;
...
TEST_F(HcclImplAlgTestNHRV1, ut_AllReduceComm_NHR)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
    ...
    algConfigurator->algType_[HcclCMDType::HCCL_CMD_ALLREDUCE].algoLevel1 = AlgTypeLevel1::ALG_LEVEL1_NHR_V1;
...
TEST_F(HcclImplAlgTestNHRV1, ut_ReduceMeshExecutor_NHR_V1)
{
    HcclResult ret = HCCL_SUCCESS;
    ...
    algConfigurator->algType_[HcclCMDType::HCCL_CMD_REDUCE].algoLevel1 = AlgTypeLevel1::ALG_LEVEL1_NHR_V1;
