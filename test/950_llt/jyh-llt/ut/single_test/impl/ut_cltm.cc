...
protected:
    ...
    {
        std::cout << "CltmTest SetUP" << std::endl;
        //(void)rt_stop_sequence_thread();
    }
    static void TearDownTestCase()
    {
        //(void)rt_start_sequence_thread();
        std::cout << "CltmTest TearDown" << std::endl;
    }
    virtual void SetUp()
    {
...
TEST_F(CltmTest, ut_invalid_Property)
{
    nlohmann::json rank_table =
    {
        {"group","1"},
...
TEST_F(CltmTest, ut_invalid_ArrayProperty)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, ut_invalid_ArrayjsonProperty)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
