...
TEST_F(HcclImplAlgTestNB, ut_AllReduceComm_NB)
{
    ...
    impl->deviceLogicId_ = 0;
    impl->deviceType_ = DevType::DEV_TYPE_910;
    algConfigurator->algType_[HcclCMDType::HCCL_CMD_ALLREDUCE].algoLevel0 = AlgTypeLevel0::ALG_LEVEL0_4P_MESH;
...
TEST_F(HcclImplAlgTestNB, ut_AllReduceComm_NB_small)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1;
    ...
    u64 sliceNum = 0;
    executor->GetSliceNum(256, false, sliceNum);
    EXPECT_EQ(ret, 0);
