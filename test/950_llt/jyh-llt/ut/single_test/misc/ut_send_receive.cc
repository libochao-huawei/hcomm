...
class UT_Send_Receive_Test : public testing::Test
{
protected:
    static void SetUpTestCase()
    {
        std::cout << "UT_Send_Receive_Test SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "UT_Send_Receive_Test TearDown" << std::endl;
    }
...
TEST_F(UT_Send_Receive_Test, ut_send_receive_8ranks_1server_float)
{
...
TEST_F(UT_Send_Receive_Test, ut_send_receive_8ranks_1server_float_1)
{
