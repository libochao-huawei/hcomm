...
protected:
    ...
    {
        std::cout << "MPI_AllReduceInter_910B_Test SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "MPI_AllReduceInter_910B_Test TearDown" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        std::cout << "A MPI_AllReduceInter_910B_Test SetUP" << std::endl;
    }
    virtual void TearDown()
    {
        MPI_Barrier(MPI_COMM_WORLD);
        std::cout << "A MPI_AllReduceInter_910B_Test TearDown" << std::endl;
    }
};
...
#if 1
TEST_F(MPI_AllReduceInter_910B_Test, ut_mpi_pipeline_all_reduce_4ranks_2server)
{
    RankConsistentcyChecker::GetInstance().ClearCheckInfo();
    nlohmann::json rank_table = rank_table_910_2server_4rank;
    char file_name_t[] = "./ut_mpi_pipeline_all_reduce_4ranks_2server.json";
...
TEST_F(MPI_AllReduceInter_910B_Test, ut_mpi_pipeline_all_reduce_4ranks_2server_prod)
{
    RankConsistentcyChecker::GetInstance().ClearCheckInfo();
    nlohmann::json rank_table = rank_table_910_2server_4rank;
    char file_name_t[] = "./ut_mpi_pipeline_all_reduce_4ranks_2server_prod.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
