...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_init)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_aicpuMc2_link_exp_init)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_notify_test1)
{
    s32 ret;
    s32 size, rank;
    ...
    auto begin = link_exp->mapQpnRemoteRank_.begin();
    u32 remoteRank;
    link_exp->GetRemoteRankByQpn(std::make_pair(localDeviceId, begin->first), remoteRank);
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_client_tx_81)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_client_writereduce_81)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_op_base)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_server_tx)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_create_link)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_get_qp_status_timeout)
{
    s32 ret;
    s32 size, rank;
    MPI_Comm_size(MPI_COMM_WORLD, &size);
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_RevAndCheckCrcInfo_status_timeout)
{
    s32 ret,resRet;
    s32 size, rank;
    MPI_Comm_size(MPI_COMM_WORLD, &size);
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_multi)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_multi_msg)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_sender_reducer_multi_msg)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_multi_v81)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_multi_msg_v81)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Link_Exp_Test, ut_mpi_link_exp_init_multi_qp)
{
    s32 ret;
    s32 size, rank;
    ...
    EXPECT_EQ(ret, HCCL_SUCCESS);
    u32 qpsNum = link_exp->GetQpsPerConnection();
    ...
    machine_para.deviceType = DevType::DEV_TYPE_910;
    link_exp.reset(new TransportIbverbs(dispatcher, notifyPool, machine_para, timeout));
    qpsNum = link_exp->GetQpsPerConnection();
    EXPECT_EQ(qpsNum, HCCL_QPS_PER_CONNECTION_DEFAULT);
    link_exp = nullptr;
