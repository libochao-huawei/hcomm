...
typedef enum tagRtChipType {
    ...
    CHIP_LHISI = 3,
    CHIP_DC = 4,
    CHIP_CLOUD_V2 = 5, // deprecated, use CHIP_910_B_93 instead
    CHIP_910_B_93 = 5,
    CHIP_NO_DEVICE = 6,
    CHIP_MINI_V3 = 7,
...
enum devdrvHardwareVersion {
    DEVDRV_PLATFORM_ASCEND310P = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V200, hccl::rtChipType_t::CHIP_DC, RT_VER_NA),
    DEVDRV_PLATFORM_CLOUD_V2 = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD_V2, RT_VER_NA),
    DEVDRV_PLATFORM_CLOUD_V2_B1 = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD_V2, RT_VER_BIN1),
    DEVDRV_PLATFORM_CLOUD_V2_B2 = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD_V2, RT_VER_BIN2),
    DEVDRV_PLATFORM_CLOUD_V2_B3 = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD_V2, RT_VER_BIN3),
    DEVDRV_PLATFORM_CLOUD_V2_B4 = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD_V2, RT_VER_NA),
    DEVDRV_PLATFORM_CLOUD_V2_B2C = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD_V2, RT_VER_BIN8),
    DEVDRV_PLATFORM_CLOUD_V3 = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD_V2, hccl::rtVersion_t::VER_NA),
    DEVDRV_PLATFORM_CLOUD_V1 = PLAT_COMBINE(hccl::rtArchType_t::ARCH_V100, hccl::rtChipType_t::CHIP_CLOUD, hccl::rtVersion_t::VER_NA),
    DEVDRV_PLATFORM_END
};
