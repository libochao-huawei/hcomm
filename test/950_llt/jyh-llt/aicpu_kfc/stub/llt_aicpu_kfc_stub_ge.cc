...
#include "llt_aicpu_kfc_stub_ge.h"
...
namespace ge {
    ...
    const std::string ATTR_NAME_ATTACHED_RESOURCE_FORCE_REUSE = "_name_attached_resource_force_reuse";
class NodeDummy : public ge::Node {
    ...
    // void ge::GeTensorDesc::Update(const GeShape& shape, Format format = FORMAT_NCHW, DataType dt = DT_FLOAT) {}
    // ge::GeTensorDesc::~GeTensorDesc() {}
    ...
    // ge::OpDesc::OpDesc(std::string const&, std::string?const&){}
    GeShape::~GeShape(){}
