...
rtError_t rtsSetDeviceTaskAbortCallback(const char *moduleName, rtsDeviceTaskAbortCallback callback, void *args)
{
...
std::map<std::string, void*> dlRaFuntionPtrMap = {
    ...
    {"RaInit", (void*)&RaInit},
    {"RaIsFirstUsed", (void*)&RaIsFirstUsed},
    {"RaIsLastUsed", (void*)&RaIsLastUsed},
...
const std::unordered_map<std::string, DevType> SOC_VER_CONVERT_KFC{
...
HcclResult __hrtGetDeviceTypeStub(DevType &devType)
{
    ...
    auto iter = SOC_VER_CONVERT_KFC.find(reinterpret_cast<char *>(targetChipVer));
    if (iter == SOC_VER_CONVERT_KFC.end()) {
