...
class MC2AicpuAllreduce_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MC2AicpuAllreduce_ST SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "MC2AicpuAllreduce_ST TearDown" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        MOCKER(hrtGetHccsPortNum)
            ...
            .will(returnValue(HCCL_SUCCESS));
        std::cout << "MC2AicpuAllreduce_ST Test SetUP" << std::endl;
    }
    virtual void TearDown()
    {
        ResetMC2Context();
        GlobalMockObject::verify();
        std::cout << "MC2AicpuAllreduce_ST Test TearDown" << std::endl;
    }
};
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_fp16)
{
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_fp16_with_profiling)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_bfp16)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_fp16Deterministic)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_fp16_only_aicpu)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_fp16_only_aicpu_commorder0)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_fp16_commorder0)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_fp16_unfold) // 单allreduce不带计算 aicpu展开
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_PrepareRingSlice)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
// 补充覆盖率用例
TEST_F(MC2AicpuAllreduce_ST, allreduce_RunAlgorithm)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    AicpuComContext *ctx = AicpuGetComContext();
    ctx->rankNum = 1;
...
// 补充覆盖率用例
TEST_F(MC2AicpuAllreduce_ST, allreduce_RunAllReduce_fail)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    AicpuComContext *ctx = AicpuGetComContext();
    ctx->rankNum = 0;
...
// 补充覆盖率用例
TEST_F(MC2AicpuAllreduce_ST, allreduce_RunAllReduceTwoShot1Stream)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    AicpuComContext *ctx = AicpuGetComContext();
    ctx->rankNum = 0;
...
// 补充覆盖率用例
TEST_F(MC2AicpuAllreduce_ST, allreduce_RunAllReduceAL)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    AicpuComContext *ctx = AicpuGetComContext();
...
TEST_F(MC2AicpuAllreduce_ST, retryEnale_false)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, retryEnale_true)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_mc2Api)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_mc2Api_turn2)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuAllreduce_ST, allreduce_mc2Api_repeat)
{
    MOCKER_CPP(&AicpuKfcRpcServerV2::ReadAddrMsg).stubs().will(returnValue(true));
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
