...
TEST_F(RankGraphTest, St_GetEndpointNum_When_Normal_Expect_SUCCESS)
{
    auto rankGraph = create4pRankGraph(myRank);
    uint32_t num = 0;
...
TEST_F(RankGraphTest, St_GetEndpointDesc_When_Normal_Expect_SUCCESS) {
    auto rankGraph = create4pRankGraph(myRank);
    uint32_t layer = 0;
    uint32_t num = 2;
    uint32_t topoInstId = 0;
...
TEST_F(RankGraphTest, St_GetInfo_When_Normal_Expect_SUCCESS)
{
    auto rankGraph = create4pRankGraph(myRank);
    uint32_t layer = 0;
    uint32_t num = 2;
