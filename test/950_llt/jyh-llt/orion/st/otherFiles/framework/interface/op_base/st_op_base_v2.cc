...
TEST_F(OpbaseTestV2, st_HcclGetHeterogModeV2_When_Normal_Expect_ReturnIsHCCL_SUCCESS)
{
    Hccl::CommParams commParams;
    std::unique_ptr<Hccl::HcclCommunicator> communicator = std::make_unique<Hccl::HcclCommunicator>(commParams);
    HcclComm comm = static_cast<HcclComm>(communicator.get());
...
TEST_F(OpbaseTestV2, St_HcclRankGraphGetEndpointNumV2_When_Valid_Expect_ReturnHCCL_SUCCESS)
{
    Hccl::CommParams commParams;
    std::shared_ptr<Hccl::HcclCommunicator> hcclComm = std::make_shared<Hccl::HcclCommunicator>(commParams);
    HcclComm comm = static_cast<HcclComm>(hcclComm.get());
...
TEST_F(OpbaseTestV2, St_HcclRankGraphGetEndpointDescV2_When_Valid_Expect_ReturnHCCL_SUCCESS)
{
    Hccl::CommParams commParams;
    std::shared_ptr<Hccl::HcclCommunicator> hcclComm = std::make_shared<Hccl::HcclCommunicator>(commParams);
    HcclComm comm = static_cast<HcclComm>(hcclComm.get());
...
TEST_F(OpbaseTestV2, St_HcclRankGraphGetEndpointInfoV2_When_Valid_Expect_ReturnHCCL_SUCCESS)
{
    Hccl::CommParams commParams;
    std::shared_ptr<Hccl::HcclCommunicator> hcclComm = std::make_shared<Hccl::HcclCommunicator>(commParams);
    HcclComm comm = static_cast<HcclComm>(hcclComm.get());
