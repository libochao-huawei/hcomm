...
#include "ccu_temp_all_reduce_mesh_1D.cc"
#include "ccu_context_all_reduce_mesh1d.cc"
...
{
    // ====== 配置用例基本信息 ======
    using CurrentExecutorType = InsAllReduceSoleExecutor<TopoMatchMesh, CcuTempAllReduceMesh1D>;
    using CurrentCcuInstructionType = CcuInstructionAllReduceMesh1D;
    using CuurentCcuContextType = CcuContextAllReduceMesh1D;
...
TEST(CommunicatorImplTest, St_GetEndpointNum_When_Valid_Return_HCCL_SUCCESS)
{
    CommunicatorImpl comm;
    comm.devLogicId = 0;
    HcclCommConfig config;
...
TEST(CommunicatorImplTest, St_GetEndpointDesc_When_Valid_Return_HCCL_SUCCESS)
{
    CommunicatorImpl comm;
    comm.devLogicId = 0;
...
TEST(CommunicatorImplTest, St_GetInfo_When_BW_COEFF_Return_Success)
{
    CommunicatorImpl comm;
    comm.devLogicId = 0;
