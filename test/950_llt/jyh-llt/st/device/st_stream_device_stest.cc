...
class Stream_Device_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "Stream_Device_ST SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "Stream_Device_ST TearDown" << std::endl;
    }
...
TEST_F(Stream_Device_ST, StreamDeviceTest) {
...
TEST_F(Stream_Device_ST, EnvDeviceTest) {
...
TEST_F(Stream_Device_ST, OpBaseDeviceTest) {
    aclrtStream stream;
