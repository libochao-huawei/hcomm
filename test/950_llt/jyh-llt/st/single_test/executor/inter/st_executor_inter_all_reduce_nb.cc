...
TEST_F(AllReduceNBInterTest, destructor_D0)
{
  u64 reduceAttrBitMap = 0x01;
    ...
    std::unique_ptr<AlgTemplateBase> tempAlg = AlgTemplateRegistry::Instance().GetAlgTemplate(
        TemplateType::TEMPLATE_ALL_REDUCE_NB, dispatcher);
	...
	// 转换子类指针
    AllReduceNB *alg = dynamic_cast<AllReduceNB *>(tempAlg.get());
	// 校验成员变量
...
TEST_F(AllReduceNBInterTest, run_async_07)
{
    ...
    run_async_test_allreduce_nb(dispatcher, /*rank=*/2, /*rankSize=*/6,/*staged*/false);
