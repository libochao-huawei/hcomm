...
class HccnRping_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "HccnRping_ST SetUP" << std::endl;
    }
 
    static void TearDownTestCase()
    {
        std::cout << "HccnRping_ST TearDown" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        MOCKER(hrtGetHccsPortNum)
            ...
            .will(returnValue(HCCL_SUCCESS));
        std::cout << "HccnRping_ST Test SetUP" << std::endl;
    }
 
    virtual void TearDown()
    {
        GlobalMockObject::verify();
        std::cout << "HccnRping_ST Test TearDown" << std::endl;
    }
...
TEST_F(HccnRping_ST, st_HccnRping)
{
...
TEST_F(HccnRping_ST, st_HccnRping_RpingAddTargetV2)
{
    MOCKER_CPP(&PingMesh::GetDeviceLogicId)
    .stubs()
    .with(any())
...
TEST_F(HccnRping_ST, st_HccnRping_RpingAddTargetV2_err)
{
    HccnRpingAddTargetConfig config;
...
TEST_F(HccnRping_ST, st_HccnRpingHandleCheck)
{
    MOCKER_CPP(&PingMesh::GetDeviceLogicId)
    .stubs()
    .with(any())
...
TEST_F(HccnRping_ST, st_HccnRpingAdapter)
{
    // 补充覆盖率
    char dst[10] {0};
    uint64_t destMax = 10;
