...
class PingMesh_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "PingMesh_ST SetUP" << std::endl;
    }
 
    static void TearDownTestCase()
    {
        std::cout << "PingMesh_ST TearDown" << std::endl;
    }
    ...
    virtual void TearDown()
    {
        ...
        std::cout << "PingMesh_ST Test TearDown" << std::endl;
    }
};

TEST_F(PingMesh_ST, st_PingMeshInit)
{
    u32 deviceId = 1;
...
TEST_F(PingMesh_ST, st_PingMeshAddDelTarget)
{
...
TEST_F(PingMesh_ST, st_PingMeshAddDelTargetPatch)
{
    MOCKER_CPP(&PingMesh::RpingRecvTargetInfo)
    .stubs()
    .with(any())
...
TEST_F(PingMesh_ST, st_PingMeshAddDelTargetPatch1)
{
    MOCKER_CPP(&PingMesh::RpingRecvTargetInfo)
    .stubs()
    .with(any())
...
TEST_F(PingMesh_ST, st_PingMeshAddDelTargetPatch2)
{
    MOCKER_CPP(&PingMesh::RpingRecvTargetInfo)
    .stubs()
    .with(any())
...
TEST_F(PingMesh_ST, st_PingMeshAddDelTargetPatch3)
{
    MOCKER_CPP(&PingMesh::RpingRecvTargetInfo)
    .stubs()
    .with(any())
...
TEST_F(PingMesh_ST, st_PingMeshStartStopPing)
{
    u32 deviceId = 1;
    u32 mode = static_cast<u32>(LinkType::LINK_ROCE);
    HcclIpAddress ipAddr = HcclIpAddress(0x7F000001);
...
TEST_F(PingMesh_ST, st_PingMeshGetResult)
{
    u32 deviceId = 1;
    u32 mode = static_cast<u32>(LinkType::LINK_ROCE);
    HcclIpAddress ipAddr = HcclIpAddress(0x7F000001);
...
TEST_F(PingMesh_ST, st_PingMeshStateCheck)
{
    u32 deviceId = 1;
    u32 mode = static_cast<u32>(LinkType::LINK_ROCE);
    HcclIpAddress ipAddr = HcclIpAddress(0x7F000001);
...
TEST_F(PingMesh_ST, st_PingMeshSendRecvInfo)
{
    u32 deviceId = 1;
    u32 mode = static_cast<u32>(LinkType::LINK_ROCE);
    HcclIpAddress ipAddr = HcclIpAddress(0x7F000001);
...
TEST_F(PingMesh_ST, st_PingMeshSendRecvInfoPatch)
{
    // 补充覆盖率
    u32 deviceId = 1;
    u32 mode = static_cast<u32>(LinkType::LINK_ROCE);
