...
#if 0
TEST_P(HcclCommTest910B, st_allgather_inter_char)
{
...
TEST_P(HcclCommTest910B, st_allgather_outplace_4p_mesh)
{
...
TEST_F(HcclCommTest910B, st_reducescatter_4p_mesh_atomic_opbase)
{
    setenv("HCCL_DETERMINISTIC", "true", 1);
    ResetInitState();
    InitExternalInput();
...
#if 1
TEST_F(HcclCommTest910B, st_reducescatter_4p_mesh)
{
    setenv("HCCL_DETERMINISTIC", "true", 1);
    ResetInitState();
    InitExternalInput();
...
TEST_F(HcclCommTest910B, st_SetAlgType_module_8server_1dev_ring_ring)
{
    HcclResult ret;
    ...
    EXPECT_EQ(ret, HCCL_SUCCESS);
    CommConfig commConfig("hccl_world_group");
    HcclCommunicator implstub(commConfig);
...
#if 1
TEST_F(HcclCommTest910B, st_reducescatter_4p_mesh_atomic_single_operator)
{
...
TEST_F(HcclCommTest910B, st_allgather_outplace_4p_mesh_single_operator)
{
    setenv("HCCL_OP_EXPANSION_MODE", "AI_CPU", 1);
    RankConsistentcyChecker::GetInstance().ClearCheckInfo();
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(HcclCommTest910B, st_reducescatter_8p_mesh_undeterministic_small_count_opbase)
{
  ResetInitState();
  InitExternalInput();
...
TEST_F(HcclCommTest910B, st_reducescatter_4p_atomic_single_operator)
{
