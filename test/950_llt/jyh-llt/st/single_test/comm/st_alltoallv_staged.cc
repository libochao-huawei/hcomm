...
#include "sal.h"     //FIXME!! why include private .h files
...
#if 1
TEST_F(AlltoAllVStagedCalculatorTest, st_alltoallv_staged_static)
{
...
TEST_F(AlltoAllVStagedCalculatorTest, st_alltoallv_staged_static_int16)
{
    u32 userRankSize = 12;
...
TEST_F(AlltoAllVStagedCalculatorTest, st_alltoallv_staged_static_size_0)
{
    u32 userRankSize = 8;
    for (u32 rankIndex = 0; rankIndex < userRankSize; rankIndex++) {
