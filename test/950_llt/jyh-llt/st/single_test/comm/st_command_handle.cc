...
TEST_F(CommandHandleTest, st_command_handle_init)
{
...
TEST_F(CommandHandleTest, st_command_handle_start)
{
    struct rtProfCommandHandle handle;
...
TEST_F(CommandHandleTest, st_command_handle_stop)
{
    struct rtProfCommandHandle handle;
...
TEST_F(CommandHandleTest, st_command_handle_finalize)
{
    struct rtProfCommandHandle handle;
...
TEST_F(CommandHandleTest, st_command_handle_subscribe)
{
    struct rtProfCommandHandle handle;
...
TEST_F(CommandHandleTest, st_command_handle_unsubscribe)
{
    struct rtProfCommandHandle handle;
...
TEST_F(CommandHandleTest, st_es_command_handle_start)
{
    struct rtProfCommandHandle handle;
    EsCommandHandle(RT_PROF_CTRL_REPORTER, static_cast<void *>(&handle), 0);

    handle.type = PROF_COMMANDHANDLE_TYPE_START;
    handle.profSwitch = PROF_TASK_TIME;
    rtError_t ret = EsCommandHandle(RT_PROF_CTRL_SWITCH, static_cast<void *>(&handle), PROF_TASK_TIME);
    EXPECT_EQ(ret, SUCCESS);
}

TEST_F(CommandHandleTest, st_es_command_handle_stop)
{
    struct rtProfCommandHandle handle;
    handle.type = PROF_COMMANDHANDLE_TYPE_STOP;
...
TEST_F(CommandHandleTest, st_es_command_handle_finalize)
{
    struct rtProfCommandHandle handle;
    handle.type = PROF_COMMANDHANDLE_TYPE_FINALIZE;
    rtError_t ret = EsCommandHandle(RT_PROF_CTRL_SWITCH, static_cast<void *>(&handle), 0);
...
TEST_F(CommandHandleTest, st_es_command_handle_subscribe)
{
    struct rtProfCommandHandle handle;
    handle.type = PROF_COMMANDHANDLE_TYPE_MODEL_SUBSCRIBE;
    rtError_t ret = EsCommandHandle(RT_PROF_CTRL_SWITCH, static_cast<void *>(&handle), 0);
...
TEST_F(CommandHandleTest, st_es_command_handle_unsubscribe)
{
    struct rtProfCommandHandle handle;
    handle.type = PROF_COMMANDHANDLE_TYPE_MODEL_UNSUBSCRIBE;
    rtError_t ret = EsCommandHandle(RT_PROF_CTRL_SWITCH, static_cast<void *>(&handle), 0);
...
TEST_F(CommandHandleTest, st_hcclProfilingAdditionalinfo_test)
{
...
TEST_F(CommandHandleTest, st_command_handle_ctrl_reporter)
{
    struct rtProfCommandHandle handle;
...
TEST_F(CommandHandleTest, st_hcclProfilingCompactInfo_test)
{
    auto &profilingManager = hccl::ProfilingManager::Instance();
...
TEST_F(CommandHandleTest, st_NodeInfo_Test)
{
