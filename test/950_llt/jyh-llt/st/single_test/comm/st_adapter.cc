...
TEST_F(RuntimeTest, st_ra_deinit_timeout)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_rt_ra_send_wr_timeout)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, test_GetMsTimeFromExecTimeout)
{
    ...
    EXPECT_EQ(HCCL_SUCCESS, ret);
    execTimeoutActual = GetMsTimeFromExecTimeout(INPUT_MIN);
    ...
    ret = SetHccLExecTimeOut(setTimeOutValue.c_str(), HcclExecTimeoutSet::HCCL_EXEC_TIMEOUT_SET_BY_ENV);
    EXPECT_EQ(HCCL_SUCCESS, ret);
    execTimeoutActual = GetMsTimeFromExecTimeout(INPUT_MAX);
    ...
    ret = SetHccLExecTimeOut(setTimeOutValue.c_str(), HcclExecTimeoutSet::HCCL_EXEC_TIMEOUT_SET_BY_ENV);
    EXPECT_EQ(HCCL_SUCCESS, ret);
    execTimeoutActual = GetMsTimeFromExecTimeout(rand()%INPUT_MAX);
    bool flag = false;
...
TEST_F(RuntimeTest, st_rt_ra_epoll)
{
    HcclResult ret;
...
TEST_F(RuntimeTest, st_rt_hrt_notify_reset_test)
{
    int nty = 1;
...
TEST_F(RuntimeTest, st_rt_hrt_Resource_Clean_test)
{
    int32_t devId = 1;
...
TEST_F(RuntimeTest, st_hrtRaRdevGetPortStatus)
{
...
TEST_F(RuntimeTest, st_hrtRaGetCqeErrInfoList)
{
    DlRaFunction::GetInstance().DlRaFunctionInit();
    int a = 0;
    RdmaHandle handle = &a;
...
TEST_F(RuntimeTest, st_hrtGetPairDevicePhyId_0)
{
...
TEST_F(RuntimeTest, st_hrtGetPairDevicePhyId_16)
{
    DevType devType = DevType::DEV_TYPE_910_93;
    MOCKER(hrtGetDeviceType)
    .stubs()
...
TEST_F(RuntimeTest, st_ra_socket_listen_stop_timeout)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_hrtRaSocketNonBlockBatchConnect)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(RuntimeTest, st_ra_socket_batch_close_timeout)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_hrtRaNonBlockGetSockets)
{
    HcclResult ret = HCCL_SUCCESS;
    u32 role = 0;
    SocketInfoT conn;
...
TEST_F(RuntimeTest, st_ra_init_timeout)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_ra_socket_listen_stop_error)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_hrtMemAsyncCopyWithoutCheckKind)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(RuntimeTest, st_hrtGetDeviceRefresh) 
{
    s32 deviceLogicId = 0;
    HcclResult ret;
...
TEST_F(RuntimeTest, st_hrtGetDeviceTypeBySocVersion)
{
...
TEST_F(RuntimeTest, st_hrtGetDeviceType_910_95_return_ok)
{
    CallBackInitRts();
    MOCKER(rtGetSocVersion)
    .stubs()
...
TEST_F(RuntimeTest, st_hrtGetDeviceTypeBySocVersion_910_95_return_ok)
{
    log_level_set_stub(3);
    DevType deviceType;
...
TEST_F(RuntimeTest, st_hrtRaTypicalSendWr)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(RuntimeTest, st_hrtRaQpDestroy)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(RuntimeTest, st_hrtRaSendWr)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(RuntimeTest, st_hrtRaDeInit)
{
    s32 ret = HCCL_SUCCESS;
    ...
    struct RaInitConfig raConfig;
    raConfig.phyId = 0;
    raConfig.nicPosition = 0;
    ret = HrtRaDeInit(&raConfig);
}

TEST_F(RuntimeTest, st_hrtRaSocketListenStart)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(RuntimeTest, st_rt_ra_socket_batch_connect)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(RuntimeTest, st_IsSupportRaSocketAbort_Support)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_IsSupportRaSocketAbort_NoSupport_Version0)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_IsSupportRaSocketAbort_NoSupport)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_ra_socket_listen_start_timeout)
{
    HcclResult ret;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_test_hrtRaNormalQpCreate)
{
    HcclResult ret = HCCL_SUCCESS;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_test_hrtRaNormalQpDestroy)
{
    HcclResult ret = HCCL_SUCCESS;
    ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(RuntimeTest, st_hrtCtxGetCurrent_null_ctx)
{
