...
// 8p AlltoAllV
TEST_F(HcclImplAlltoAllAIVTest, st_alltoallv_8p_mesh_aiv)
{
...
TEST_F(HcclImplAlltoAllAIVTest, st_alltoallv_8p_mesh_aiv_capture)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test_test_test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlltoAllAIVTest, st_alltoallv_8p_mesh_aiv_capture_multi_op)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test_test_test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
// 8p AlltoAllVC
TEST_F(HcclImplAlltoAllAIVTest, st_alltoallvc_8p_mesh_aiv)
{
    HcclResult ret = HCCL_SUCCESS;
...
// rmda AlltoAll
TEST_F(HcclImplAlltoAllAIVTest, st_alltoall_rdma_mesh_aiv)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test_test_test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
