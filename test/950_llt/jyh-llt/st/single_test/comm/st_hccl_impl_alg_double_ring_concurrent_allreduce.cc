...
TEST_F(HcclImplAlgTestDoubleRingConcurrentallreduce, st_CollAllReduceDoubleRingConcurrentExecutor_Ring)
{
...
TEST_F(HcclImplAlgTestDoubleRingConcurrentallreduce, st_CollAllReduceDoubleRingConcurrentExecutor_superpod_Ring)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRingConcurrentallreduce, st_CollAllReduceDoubleRingConcurrentExecutor_Ring_ffts)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRingConcurrentallreduce, st_CollAllReduceDoubleRingConcurrentExecutor_Ring_1server)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRingConcurrentallreduce, st_CollAllReduceDoubleRingConcurrentExecutor_Ring_Largesize)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 67108872;
