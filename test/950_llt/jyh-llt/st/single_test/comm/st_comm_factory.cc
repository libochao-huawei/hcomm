...
TEST_F(CommFactoryTest, st_init)
{
...
TEST_F(CommFactoryTest, st_create_comm)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommFactoryTest, st_create_comm_ranksize_7)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommFactoryTest, st_init_with_err_input)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommFactoryTest, st_init_with_err_topo)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommFactoryTest, st_init_with_err_rank_size)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommFactoryTest, st_create_comm_suppod)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommFactoryTest, st_create_commmesh_combined_1server_16p)
{
    s32 ret = HCCL_SUCCESS;
