...
TEST_F(AllreduceMeshOpbaseTest, st_impl_alg)
{
...
TEST_F(AllreduceMeshOpbaseTest, st_impl_alg2)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(AllreduceMeshOpbaseTest, st_impl_alg3)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(AllreduceMeshOpbaseTest, st_impl_alg4)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(AllreduceMeshOpbaseTest, st_impl_alg5)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(AllreduceMeshOpbaseTest, st_slice)
{
