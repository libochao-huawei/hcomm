...
TEST_F(HcclImplAlgTestNB, st_ReduceScatterComm_NB)
{
...
TEST_F(HcclImplAlgTestNB, st_AllGatherComm_NB)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestNB, st_AllReduceComm_NB)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestNB, st_ReduceScatterRingExecutor_NB)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestNB, st_ReduceScatterMeshExecutor_NB)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestNB, st_AllReduceReducePlusBcast_NB)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
