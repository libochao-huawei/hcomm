...
TEST_F(CltmTest, st_V80_1group_1server_1dev)
{
...
TEST_F(CltmTest, st_V80_1group_2server_8dev)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_invalid_ip_addr)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_invalid_device_id)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_same_server_id)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_invalid_device_ip_addr)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_repeat_device_ip_addr)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_same_group_name_fail)
{
    nlohmann::json rank_table =
    {
        {"group_count","2"},
...
TEST_F(CltmTest, st_invlid_data_type)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_json_property_is_not_exist)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_invalid_array)   //////////////////////////////////////
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_json_string_property_is_not_exist)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_json_array_string_property_is_not_exist)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_json_array_string_property_is_not_string)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_json_array_length_not_equal_to_number)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_too_long_input_json)
{
...
TEST_F(CltmTest, st_output_buffer_is_not_enough)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_illegal_input_para)
{
...
TEST_F(CltmTest, st_V80_illegal_input_json_info)
{
    char* inputRes = (char*)sal_malloc(MAX_BUF_SIZE);
...
TEST_F(CltmTest, st_V80_duplicate_deviceid_in_same_server)
{
    nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(CltmTest, st_group_count_invalid)
{
    nlohmann::json rank_table =
    {
        {"group_count",""},
...
TEST_F(CltmTest, st_invalid_group_count_invalid1)
{
    nlohmann::json rank_table =
    {
        {"group_count","#"},
...
TEST_F(CltmTest, st_group_count_too_long)
{
    nlohmann::json rank_table =
    {
