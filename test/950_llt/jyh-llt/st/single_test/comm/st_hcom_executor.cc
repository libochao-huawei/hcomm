...
TEST_F(HcomExecutorTest, st_executor_initgroup1)
{
    ...
    // 走1910 4pring
    char* rank_table_file = "./st_executor_initgroup1.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, st_executor_initgroup1_error)
{
    ...
    // 走1910 4pring
    char* rank_table_file = "./st_executor_initgroup1_error.json";
    char* rank_ID = "0";
...
TEST_F(HcomExecutorTest, st_executor_allreduce_on_created_comm)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
    char file_name_t[] = "./st_executor_equeue_allreduce.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
