...
TEST_F(HcclImplAlgTestDoubleRingConcurrent, st_CollReduceScatterDoubleRingConcurrentExecutor_Ring)
{
...
TEST_F(HcclImplAlgTestDoubleRingConcurrent, st_CollAllGatherDoubleRingConcurrentExecutor_Ring)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRingConcurrent, st_SetInterAlgoToRingIfConcurrentOn)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplAlgTestDoubleRingConcurrent, st_GetRingsOrderByTopoType)
{
    HcclResult ret = HCCL_SUCCESS;
    ret = InitEnvVarParam();
    ...
    std::vector<std::vector<u32>> res = GetRingsOrderByTopoType(rankSize, topoType, nicList);
...
TEST_F(HcclImplAlgTestDoubleRingConcurrent, st_env_test)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplAlgTestDoubleRingConcurrent, st_CollReduceScatterDoubleRingConcurrentExecutor_Ring_op)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
