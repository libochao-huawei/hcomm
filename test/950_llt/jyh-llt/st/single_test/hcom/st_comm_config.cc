...
TEST_F(CommConfigTest, stCommConfig_load)
{
...
TEST_F(CommConfigTest, stCommConfig_magicword_verify)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_version_compatibility_v0)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_version_compatibility_v1)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_default_env_config)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_op_expansion)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_op_expansion_v0)
{
    DevType deviceType = DevType::DEV_TYPE_910B;
    MOCKER(hrtGetDeviceType)
    .stubs()
...
TEST_F(CommConfigTest, stCommConfig_deterministic_strcit)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_deterministic_strcit_fail)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_exec_timeout)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
...
TEST_F(CommConfigTest, stCommConfig_hccl_algo)
{
    MOCKER(GetExternalInputCCLBuffSize)
    .stubs()
    .will(returnValue(static_cast<u64>(200 * HCCL_CCL_COMM_FIXED_CALC_BUFFER_SIZE)));
    ...
    CommConfig commConfig("comm_ID");
    CommConfigInfo configInfo = { sizeof(CommConfigHandle), COMM_CONFIG_MAGIC_WORD, 11, { 0 } };
    CommConfigHandle configHandle = { configInfo, 300, 1, "comm_ID", "Unspecified", 3, 132, 4, 0, 0, 0, 1000, "level0:NA;level1:ring"};
