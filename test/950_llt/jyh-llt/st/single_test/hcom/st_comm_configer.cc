...
TEST_F(CommConfigerTest, st_comm_configer_execTimeOut)
{
...
TEST_F(CommConfigerTest, st_comm_configer_hccl_algo)
{
    HcclResult ret = HCCL_SUCCESS;
    ...
    strcpy_s(userConfig.hcclCommName, COMM_NAME_MAX_LENGTH, "test_comm1");
    ...
    std::string identifier = "test_comm1";
    CommConfig commConfig(identifier);
