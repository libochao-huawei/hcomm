...
TEST_F(SuperFastKernelTest, st_gradient_fusion_HcomGraphOptimizer_jobType){
    ge ::Status ge_ret;
    std::map<std::string,std::string> options;
...
TEST_F(SuperFastKernelTest, st_hcom_GenerateGroupHash)
{
    std::string group = "group1";
...
TEST_F(SuperFastKernelTest, st_hcom_HcomSelectAlg)
{
...
TEST_F(SuperFastKernelTest, st_GetAivCoreLimit)
{
    ...
    EXPECT_EQ(ge::AttrUtils::SetStr(nodeGroup, "group_op_vectorcore_num", group), true);
