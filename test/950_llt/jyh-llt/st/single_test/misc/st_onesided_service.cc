...
TEST_F(OneSidedSt, st_exception_handler)
{
    try {
...
TEST_F(OneSidedSt, st_rma_buffer_mgr)
{
    EXPECT_EQ(st_rma_buffer_mgr_test(), HCCL_SUCCESS);
}

TEST_F(OneSidedSt, st_one_sided_service_mem_regDereg_enable_disable_roce)
{
...
TEST_F(OneSidedSt, st_test_rma_buffer_impl)
{
    int ret = HCCL_SUCCESS;
    s8* localbuf;
    s8* remotebuf;
...
TEST_F(OneSidedSt, st_test_rma_buffer_SetIpcMem_noOffset)
{
   int ret = HCCL_SUCCESS;
    s8* localbuf;
    s8* remotebuf;
...
TEST_F(OneSidedSt, st_one_sided_service_mem_regDereg_enable_disable_ipc)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_mem_regDereg_enable_disable_a3_rdma)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_mem_exchange)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_mem_exchange_create_socket_failed)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_mem_exchange_sendReceive_roce_0)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_BatchPut_BatchPut_error_param)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_HcclBatchPut_HcclBatchGet_success_ipc)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_HcclBatchPut_HcclBatchGet_mem_not_found)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_DeinitOneSidedCtx)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_RegHostMemMax)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_RegDevMemMax)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_RegUnRegDevMemMaxCnt)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_RegUnRegDevMemMaxCnt_multi_remoteRank)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_InitNetDevCtx_Fail)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_InitNetDevCtx_HostDeployment)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_setNetDevCtx)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_init_devIpAddrEmpty)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_BatchPut_Rma_Buffer_test)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_opbase_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(OneSidedSt, st_one_sided_service_mem_RemapRegistedMemory_roce_01)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_conn_conect)
{
    NetDevContext devContext;
    devContext.nicType_ = NicType::DEVICE_NIC_TYPE;
    devContext.localIpcRmaBufferMgr_ = std::make_shared<LocalIpcRmaBufferMgr>();
...
TEST_F(OneSidedSt, st_one_sided_service_prepare_fail)
{
    int ret = HCCL_SUCCESS;
...
TEST_F(OneSidedSt, st_one_sided_service_batchput_batchget_err)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_batchput_aicpu_rdma)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_opbase_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(OneSidedSt, st_one_sided_service_batchput_batchget_aicpu_rdma)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_opbase_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(OneSidedSt, st_HcclBatchGetPut_When_SdmaAicpuUnflod_Expect_Success)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
    char file_name_t[] = "./ut_opbase_test.json";
    std::ofstream outfile(file_name_t, std::ios::out | std::ios::trunc | std::ios::binary);
...
TEST_F(OneSidedSt, st_one_sided_service_bind_mem)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
...
TEST_F(OneSidedSt, st_one_sided_globally_bind_mem)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
...
TEST_F(OneSidedSt, st_one_sided_service_mem_test_prepare)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_mem_test_RegisterBoundMems)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_one_sided_service_mem_test_Exchange_and_enable_Mem)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(OneSidedSt, st_hcclComm_InitNic_IsOneSidedBackupInit)
{
    setenv("HCCL_INTRA_ROCE_ENABLE", "1", 1);
...
TEST_F(OneSidedSt, st_one_sided_DeregisterGlobalMem_When_2_comms_Expect_ReturnIsHCCL_SUCCESS)
{
    nlohmann::json rank_table = rank_table_910_1server_2rank;
    std::string clusterString = rank_table.dump();
