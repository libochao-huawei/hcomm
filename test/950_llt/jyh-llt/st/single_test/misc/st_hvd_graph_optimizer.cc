...
protected:
    static void SetUpTestCase()
    {
        ...
        char file_name[] = "./st_HvdGraphOptimizerTest.json";
...
TEST_F(HvdGraphOptimizerTest, st_Finalize)
{
...
TEST_F(HvdGraphOptimizerTest, st_OptimizeOriginalGraph)
{
    HvdGraphOptimizer optimizer;
    HcclResult ret;
...
TEST_F(HvdGraphOptimizerTest, st_OptimizeGraphPrepare)
{
    HvdGraphOptimizer optimizer;
    HcclResult ret;
    ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test_graph");
...
TEST_F(HvdGraphOptimizerTest, st_AssignNewStream)
{
...
TEST_F(HvdGraphOptimizerTest, st_AddControlAnchor)
{
    ge::NodePtr nodeptr(new NodeTest);
...
TEST_F(HvdGraphOptimizerTest, st_AddDependence)
{
    HvdGraphOptimizer optimizer;
    ge::NodePtr nodeptr(new NodeTest);
    ge::NodePtr addedNodePtr(new NodeTest);
...
TEST_F(HvdGraphOptimizerTest, st_OptimizeWholeGraph)
{
    HvdGraphOptimizer optimizer;
    ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test_graph");
    const string type = "HorovodBroadcast";
...
TEST_F(HvdGraphOptimizerTest, st_GetAttributes)
{
    HvdGraphOptimizer optimizer;
    ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test_graph");
    const string type = "HorovodBroadcast";
...
TEST_F(HvdGraphOptimizerTest, st_OptimizeFusedGraph)
{
    HvdGraphOptimizer optimizer;
    HcclResult ret;
    ge::ComputeGraphPtr graph = std::make_shared<ge::ComputeGraph>("test_graph");
...
TEST_F(HvdGraphOptimizerTest, st_CalcOpRunningParam)
{
    HvdGraphOptimizer optimizer;
    ge::Node node;
...
TEST_F(HvdGraphOptimizerTest, st_SetOpOutputMemSize)
{
    HvdGraphOptimizer optimizer;
...
TEST_F(HvdGraphOptimizerTest, st_CalcHCCLOutputMemSize)
{
    HvdGraphOptimizer optimizer;
    std::string sCollectiveType ="";
    int64_t memSize = 2;
...
TEST_F(HvdGraphOptimizerTest, st_SetOpMemAttr)
{
    HvdGraphOptimizer optimizer;
    std::string sCollectiveType ="";
    ge::Node node;
...
TEST_F(HvdGraphOptimizerTest, st_SetOpAtomicInputIndex)
{
    HvdGraphOptimizer optimizer;
...
TEST_F(HvdGraphOptimizerTest, st_CalcOpRunningParam_1)
{
