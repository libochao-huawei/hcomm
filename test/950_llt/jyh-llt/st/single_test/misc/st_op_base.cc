...
TEST_P(OpbaseTest, st_hcclBroadcast)
{
...
TEST_F(OpbaseTest, st_hcclAllReduce)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_PluginRunner_not_support) {
...
TEST_F(OpbaseTest, st_hcclAllReduce_capture)
{   
    rtStreamCaptureStatus captureStatus = rtStreamCaptureStatus::RT_STREAM_CAPTURE_STATUS_ACTIVE;
    int mockModel = 0;
    void *pmockModel = &mockModel;    
...
TEST_F(OpbaseTest, st_hcclAllReduce_capture_rdma)
{   
    rtStreamCaptureStatus captureStatus = rtStreamCaptureStatus::RT_STREAM_CAPTURE_STATUS_ACTIVE;
    int mockModel = 0;
    void *pmockModel = &mockModel;    
...
TEST_F(OpbaseTest, st_hcclReducescatter)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcclReducescatter_capture)
{   
    rtStreamCaptureStatus captureStatus = rtStreamCaptureStatus::RT_STREAM_CAPTURE_STATUS_ACTIVE;
    int mockModel = 0;
    void *pmockModel = &mockModel;    
...
TEST_F(OpbaseTest, st_hcclScatter_Ring_1rank)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_P(OpbaseTest, st_hcclScatter_inptr_EQ_outPtr)
{
    bool fftsSwitch = GetParam();
    if (fftsSwitch) {
        SetFftsSwitch(true);
...
TEST_P(OpbaseTest, st_HcclReduce_inptr_EQ_outPtr)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_HcclAllGatherOutPlace310P_ranksize_1)
{
...
TEST_F(OpbaseTest, st_HcclAllGatherOutPlace_mix_ranksize_1_capture)
{
...
TEST_F(OpbaseTest, st_hcclAllGather)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcclAllGather_capture)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcclAllGather_capture_rdma)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcclAllGatherV)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcomAllGatherV)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_HcclReduceScatterV)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcomReduceScatterV)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcclAllGatherVFor310P3)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_HcclReduceScatterVFor310P3)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_BighcclAllReduce)
{
...
TEST_F(OpbaseTest, st_BighcclReducescatter)
{
...
TEST_F(OpbaseTest, st_BighcclAllGather)
{
...
TEST_F(OpbaseTest, st_BIGhcclBroadcast)
{
...
TEST_F(OpbaseTest, st_multi_hcclAllReduce)
{
...
TEST_F(OpbaseTest, st_hcclCommInitRank_single_server_1p_success_security)
{
...
TEST_F(OpbaseTest, st_HcclGetCommName_1)
{
    char *group;
    HcclRootInfo id;
    HcclResult ret = HcclGetRootInfo(&id);
...
TEST_F(OpbaseTest, st_HcclGetCommName_2)
{
    char *group;
    HcclComm newcomm;
...
TEST_F(OpbaseTest, st_hcclsend_hcclrecv)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_HcclCommInitClusterInfo)
{
    setenv("HCCL_WHITELIST_DISABLE", "1", 1);
...
TEST_F(OpbaseTest, st_check_alltoallv_external_mem)
{
...
TEST_F(OpbaseTest, st_HcclConfig_deterministic_fail)
{
    union HcclConfigValue hcclConfigValue;
    DevType deviceType = DevType::DEV_TYPE_910_93;
    MOCKER(hrtGetDeviceType).stubs().with(outBound(deviceType)).will(returnValue(HCCL_SUCCESS));
...
TEST_F(OpbaseTest, st_HcclHostmemFree)
{
...
TEST_F(OpbaseTest, st_gather_alltoallv)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_GetLocalHostIP)
{
...
TEST_P(OpbaseTest, st_HcclAlltoAll)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_HcclCommGetAsyncError)
{
    nlohmann::json rank_table =
    {
        {"status", "completed"},
...
TEST_F(OpbaseTest, st_HcclGetErrorString)
{
...
TEST_F(OpbaseTest, st_HcclAiCpuResource91093)
{
    HcclRootInfo id;
    char group[ROOTINFO_INDENTIFIER_MAX_LENGTH] = {0};
    void *commContext = nullptr;
...
TEST_F(OpbaseTest, st_HcclAiCpuResource)
{
    DevType deviceType = DevType::DEV_TYPE_910B;
    MOCKER(hrtGetDeviceType)
    .stubs()
...
TEST_F(OpbaseTest, st_HcclAiCpuResourceByTiling)
{
    HcclRootInfo id;
    char group[ROOTINFO_INDENTIFIER_MAX_LENGTH] = {0};
    void *commContext = nullptr;
...
TEST_F(OpbaseTest, st_HcclAiCpuResourceByTiling_A3)
{
    HcclRootInfo id;
    char group[ROOTINFO_INDENTIFIER_MAX_LENGTH] = {0};
    void *commContext = nullptr;
...
TEST_F(OpbaseTest, st_GetHcclOpInfoCtx_cover_bottom_false)
{
...
TEST_F(OpbaseTest, st_GetHcclOpInfoCtx_cover_bottom_true)
{
...
TEST_F(OpbaseTest, st_opbaseinit_hcomstream)
{
    int ret = HCCL_SUCCESS;
    uint32_t ndev = 1;
...
TEST_F(OpbaseTest, st_BatchSendRecv_self)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
#if 1
TEST_F(OpbaseTest, st_BatchSendRecv_2rank_send)
{
...
TEST_F(OpbaseTest, st_BatchSendRecv_2rank_send_91093_aicpu_bigsize)
{
...
#if 1
TEST_F(OpbaseTest, st_BatchSendRecv_2rank_recv)
{
...
#if 1
TEST_P(OpbaseTest, st_BatchSendRecv_4rank_send_recv)
{
...
#if 1
TEST_F(OpbaseTest, st_BatchSendRecv_4rank_send_multitimes)
{
...
#if 1
TEST_F(OpbaseTest, st_hcclGetRootInfo_91093_single_server_success_normal_3)
{
    setenv("HCCL_WHITELIST_DISABLE", "1", 1);
...
TEST_F(OpbaseTest, st_HcclAiCpuUnfold310P)
{
    setenv("HCCL_OP_EXPANSION_MODE", "AI_CPU", 1);
...
TEST_F(OpbaseTest, st_hcclGetRootInfo_single_server_fail_empty_allowlist)
{
    char *buffer;
    //也可以将buffer作为输出参数
...
TEST_F(OpbaseTest, st_HcclAiCpuUnfold910B)
{
    setenv("HCCL_OP_EXPANSION_MODE", "AI_CPU", 1);
    s8* sendBuf;
    s8* recvBuf;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfoConfig_default)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfoConfig_user_config)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfoConfig_user_config_world_group)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfoConfig_duplicate_comm_name)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_HcclGetCommConfigCapability)
{
...
TEST_F(OpbaseTest, st_SetDynamicTilingDataAlltoall)
{
    HcclCommunicator impl;
    OpParam opParam;
...
TEST_F(OpbaseTest, st_initWithConfig)
{
...
TEST_F(OpbaseTest, st_initSubComm)
{
...
TEST_F(OpbaseTest, st_HcclCommInitClusterInfoConfig_user_config_configer)
{
...
TEST_F(OpbaseTest, st_FreeScratchMemOnOpBaseMode)
{
    HcclCommunicator impl;
    OpParam opParam;
...
TEST_F(OpbaseTest, st_CheckDataTypeAllBranch)
{
...
TEST_F(OpbaseTest, st_310P3CommonFrontLogPrint)
{
    MOCKER(Is310P3Common)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_HcclCommInitClusterInfoMemConfig_multiple_comm)
{
...
TEST_F(OpbaseTest, st_HcclCommInitClusterInfoMemConfig_multiple_comm_configer)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
...
TEST_F(OpbaseTest, st_HcclCommInitClusterInfoMemConfig_single_comm)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
...
TEST_F(OpbaseTest, st_HcclCommInitClusterInfoMemConfig_single_comm_configer)
{
    typedef HcclResult (*HcclOneSideServiceCallBack)(std::unique_ptr<hccl::IHcclOneSidedService> &,
    std::unique_ptr<hccl::HcclSocketManager> &, std::unique_ptr<hccl::NotifyPool> &);
...
TEST_F(OpbaseTest, st_HcclCommInitClusterInfoMemConfig_no_commname)
{
    nlohmann::json rank_table = rank_table_910_1server_2rank;
    std::string clusterString = rank_table.dump();
...
TEST_F(OpbaseTest, st_topoInfoExchangeServer_timeout)
{
...
TEST_F(OpbaseTest, st_topoInfoExchangeServer_ErrTCP)
{
    setenv("HCCL_CONNECT_TIMEOUT", "5", 1);
     MOCKER(GetExternalInputHcclLinkTimeOut)
    .stubs()
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfoConfig_op_expansion_mode)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfoConfig_user_config_configer)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfoConfig_user_config_world_group_configer)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_hcclAllGatherV_capture)
{
    rtStreamCaptureStatus captureStatus = rtStreamCaptureStatus::RT_STREAM_CAPTURE_STATUS_ACTIVE;
    int mockModel = 0;
    void *pmockModel = &mockModel;
...
TEST_F(OpbaseTest, st_topoInfoExchangeServer_PreemptPortManager_releaseSocket)
{
    HcclIpAddress hostIP("127.0.0.1");
    u32 hostPort = 61111;
    std::vector<HcclIpAddress> whitelist ;
...
TEST_F(OpbaseTest, st_PreemptDevSocket)
{
...
TEST_F(OpbaseTest, st_PreemptBackupNicSocket)
{
    TopoInfoDetect topoDetectAgent;
    MOCKER_CPP(&PreemptPortManager::ListenPreempt)
    .stubs()
...
TEST_F(OpbaseTest, st_hcomAllGatherV_91093)
{
    MOCKER(GetExternalInputHcclEnableEntryLog)
    .stubs()
    .with(any())
...
TEST_F(OpbaseTest, st_hcclGetRootInfo_hierarchical_rank_0)
{
    setenv("HCCL_WHITELIST_DISABLE", "1", 1);
...
TEST_F(OpbaseTest, st_hcclGetRootInfo_hierarchical_rank_1)
{
    setenv("HCCL_WHITELIST_DISABLE", "1", 1);
...
TEST_F(OpbaseTest, st_hcclGetRootInfo_hierarchical_root)
{
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfo_SetupGroupMember)
{
    TopoInfoDetect topoDetectAgent;
    HcclResult ret;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfo_SetupTopoGroupLeader_error0)
{
    TopoInfoDetect topoDetectAgent;
    HcclResult ret;
...
TEST_F(OpbaseTest, st_HcclCommInitRootInfo_SetupTopoGroupLeader_error1)
{
    TopoInfoDetect topoDetectAgent;
    HcclResult ret;
...
TEST_F(OpbaseTest, st_ExchangeCommUserMem_When_Mem_Valid_Expect_ReturnSuccess)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_ExchangeCommUserMem_When_ranksNum_Valid_Expect_ReturnE_PARA)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_ExchangeCommUserMem_When_usedRDMA_Expect_ReturnE_NOT_SUPPORT)
{
    HcclRootInfo id;
...
TEST_F(OpbaseTest, st_cclbuf_op)
{
    hcclComm comm;
...
TEST_F(OpbaseTest, st_cclbuf_op_check_size)
{
    hcclComm comm;
    comm.communicator_ = make_unique<HcclCommunicator>();
    HcclComm commoPtr = &comm;
...
TEST_F(OpbaseTest, st_topo_getNetLayer)
{
    hcclComm comm;
    comm.communicator_ = make_unique<HcclCommunicator>();
    HcclComm commoPtr = &comm;
...
TEST_F(OpbaseTest, st_GroupLeaderAccept_When_Accept_E_Connect_Then_ReturnE_Connect)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER_CPP(&HcclSocket::Accept)
    .stubs()
...
TEST_F(OpbaseTest, st_TryGetGroupTopoInfo_When_HcclCommInitClusterInfoConfig_Expect_ReturnIsTrue)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
    ...
    bool ge_ret = ge::HcomTopoInfo::Instance().TryGetGroupTopoInfo(pComm->GetIdentifier().c_str(), topoInfo);
    EXPECT_EQ(ge_ret, true);
...
TEST_F(OpbaseTest, st_TryGetGroupTopoInfo_When_HcclCreateSubCommConfig_Expect_ReturnIsTrue)
{
    nlohmann::json rank_table = rank_table_910_1server_1rank;
