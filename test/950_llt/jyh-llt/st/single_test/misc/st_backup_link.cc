...
#if 1
TEST_F(BackupLinkTest, st_DestroyAlgResource)
{
...
#if 1
TEST_F(BackupLinkTest, st_DestroyNetworkResources)
{
...
#if 1
TEST_F(BackupLinkTest, st_DeinitNic)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
#if 1
TEST_F(BackupLinkTest, st_GetRemoteRankList)
{
    HcclResult ret = HCCL_SUCCESS;
...
#if 1
TEST_F(BackupLinkTest, st_GetIncreRemoteRankList)
{
    HcclResult ret = HCCL_SUCCESS;
...
#if 1
TEST_F(BackupLinkTest, st_SetMachinePara)
{
    HcclResult ret = HCCL_SUCCESS;
...
#if 1
TEST_F(BackupLinkTest, st_RefreshAlgResponseTransportRes)
{
    HcclResult ret = HCCL_SUCCESS;
...
#if 1
TEST_F(BackupLinkTest, st_HcclOpExecChangeLinkProcess)
{
    HcclResult ret = HCCL_SUCCESS;
...
#if 1
TEST_F(BackupLinkTest, st_CloseHccpProcess)
{
    HcclResult ret = HCCL_SUCCESS;
...
#if 1
TEST_F(BackupLinkTest, st_TsdProcessOpen)
{
    HcclResult ret = HCCL_SUCCESS;
...
#if 1
TEST_F(BackupLinkTest, st_ReAllocTransportResource)
{
    /*
...
#if 1
TEST_F(BackupLinkTest, st_InitRaResource_notSupportChangelink)
{
    std::unique_ptr<HcclCommunicator> communicator(new (std::nothrow) HcclCommunicator());
...
#if 1
TEST_F(BackupLinkTest, st_InitRaResource_SupportChangelink)
{
    std::unique_ptr<HcclCommunicator> communicator(new (std::nothrow) HcclCommunicator());
    std::unique_ptr<HcclSocketManager> socketManager(new (std::nothrow) HcclSocketManager(
        NICDeployment::NIC_DEPLOYMENT_DEVICE, 0, 0, 0));
