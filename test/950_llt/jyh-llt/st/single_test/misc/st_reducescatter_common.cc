...
#if 1
TEST_P(ReduceScatterCommonTest, st_hccl_impl_610_8rank_1server_reduce_scatter_char)
{
...
#if 1
TEST_F(ReduceScatterCommonTest, st_hccl_impl_610_8rank_1server_reduce_scatter_float)
{
...
#if 1
TEST_F(ReduceScatterCommonTest, st_hccl_impl_610_5rank_1server_reduce_scatter_char)
{
...
#if 1
TEST_F(ReduceScatterCommonTest, st_hccl_impl_610_4rank_1server_reduce_scatter_char)
{
...
#if 1
TEST_F(ReduceScatterCommonTest, st_hccl_impl_610_2rank_1server_reduce_scatter_char)
{
...
#if 1
TEST_F(ReduceScatterCommonTest, st_hccl_impl_610_3rank_1server_reduce_scatter_float)
{
...
#if 1
TEST_F(ReduceScatterCommonTest, st_hccl_impl_610_2rank_1server_reduce_scatter_float)
{
...
#if 1
TEST_F(ReduceScatterCommonTest, st_hccl_impl_610_8rank_1server_reduce_scatter_memsampler_char)
{
