...
TEST_F(HvdOpsKernelInfoStoreTest, st_GetSupportedOP)
{
...
TEST_F(HvdOpsKernelInfoStoreTest, st_HCCLOpsKernel)
{
    HvdOpsKernelInfoStore InfoStore;
...
TEST_F(HvdOpsKernelInfoStoreTest, st_HvdWaitOpKernel)
{
    HvdOpsKernelInfoStore InfoStore;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
    sal_memset(sendbuf, 10 * sizeof(float), 0, 10 * sizeof(float));
...
TEST_F(HvdOpsKernelInfoStoreTest, st_LoadTask)
{
    HvdOpsKernelInfoStore InfoStore;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
    sal_memset(sendbuf, 10 * sizeof(float), 0, 10 * sizeof(float));
...
TEST_F(HvdOpsKernelInfoStoreTest, st_UnloadTask)
{
    HvdOpsKernelInfoStore InfoStore;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
    sal_memset(sendbuf, 10 * sizeof(float), 0, 10 * sizeof(float));
...
TEST_F(HvdOpsKernelInfoStoreTest, st_GetEvent)
{
    HvdOpsKernelInfoStore InfoStore;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
    sal_memset(sendbuf, 10 * sizeof(float), 0, 10 * sizeof(float));
...
TEST_F(HvdOpsKernelInfoStoreTest, st_DestroyEvent)
{
    HvdOpsKernelInfoStore InfoStore;
...
TEST_F(HvdOpsKernelInfoStoreTest, st_GetDataTypeFromTaskInfo)
{
    HvdOpsKernelInfoStore InfoStore;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
    sal_memset(sendbuf, 10 * sizeof(float), 0, 10 * sizeof(float));
...
TEST_F(HvdOpsKernelInfoStoreTest, st_HvdBroadcastOpKernel)
{
    HvdOpsKernelInfoStore InfoStore;
    ge::GETaskInfo task;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
...
TEST_F(HvdOpsKernelInfoStoreTest, st_HvdAllReduceOpKernel)
{
    HvdOpsKernelInfoStore InfoStore;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
    sal_memset(sendbuf, 10 * sizeof(float), 0, 10 * sizeof(float));
...
TEST_F(HvdOpsKernelInfoStoreTest, st_HvdAllGatherOpKernel)
{
    HvdOpsKernelInfoStore InfoStore;
    s8* sendbuf = (s8*)sal_malloc(10 * sizeof(float));
    sal_memset(sendbuf, 10 * sizeof(float), 0, 10 * sizeof(float));
