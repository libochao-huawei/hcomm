...
TEST_F(HcclHDCTest, st_hccl_hdc_init_host_d2h)
{
    u32 devid = 0;
...
TEST_F(HcclHDCTest, st_hccl_hdc_init_host_h2d)
{
    u32 devid = 0;
...
TEST_F(HcclHDCTest, st_hccl_hdc_init_device_d2h)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_D2H;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_init_device_h2d)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_H2D;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_h2d)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_H2D;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_h2d_multi)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_H2D;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_h2d_multi_put_single_get)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_H2D;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_h2d_single_put_multi_get)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_H2D;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_d2h)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_D2H;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_d2h_multi)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_D2H;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_d2h_multi_put_single_get)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_D2H;
    u32 buffLen = 8 * 1024;
...
TEST_F(HcclHDCTest, st_hccl_hdc_d2h_single_put_multi_get)
{
    u32 devid = 0;
    u32 flag = HCCL_HDC_TYPE_D2H;
    u32 buffLen = 8 * 1024;
