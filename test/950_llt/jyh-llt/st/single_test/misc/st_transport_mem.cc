...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_TransportMem_Init_Roce)
{
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_TransportMem_Init_Ipc)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
    s32 rank = 0;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_ipc_mem_exchange)
{
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_ipc_mem_enable_disable_mem_access)
{
    std::unique_ptr<NotifyPool> notifyPool = std::make_unique<NotifyPool>();
    NetDevContext devContext;
    HcclNetDevCtx netDevCtx = &devContext;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_ipc_mem_read_write)
{
    HcclResult ret;
    rtStream_t stream;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_ipc_mem_get_trans_info)
{
    HcclResult ret;
    HcclQpInfoV2 qpInfo;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_ipc_mem_wait_op_frence)
{
    HcclResult ret;
    std::shared_ptr<TransportMem> transport = CreateIpcMemTransport();
    rtStream_t stream;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_roce_mem_exchange)
{
    std::unique_ptr<NotifyPool> notifyPool = std::make_unique<NotifyPool>();
    NetDevContext devContext;
    HcclNetDevCtx netDevCtx = &devContext;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_roce_mem_CheckRaSendNormalWrlistSupport)
{
    std::unique_ptr<NotifyPool> notifyPool = std::make_unique<NotifyPool>();
    NetDevContext devContext;
    HcclNetDevCtx netDevCtx = &devContext;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_roce_mem_CheckRaSendNormalWrlistSupport2)
{
    std::unique_ptr<NotifyPool> notifyPool = std::make_unique<NotifyPool>();
    NetDevContext devContext;
    HcclNetDevCtx netDevCtx = &devContext;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_roce_mem_enable_disable_mem_access)
{
    std::unique_ptr<NotifyPool> notifyPool = std::make_unique<NotifyPool>();
    NetDevContext devContext;
    HcclNetDevCtx netDevCtx = &devContext;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_roce_mem_read_write)
{
    HcclResult ret;
    rtStream_t stream;
    rtError_t rt_ret = rtStreamCreate(&stream, 0);
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_roce_mem_qp_info_get)
{
    HcclResult ret;
    HcclQpInfoV2 qpInfo;
...
TEST_F(ST_MPI_TRANSPORT_MEM_TEST, st_transport_device_roce_mem_qp_info_get)
{
    HcclResult ret;
