...
TEST_F(HcclImplTest, st_AllocTransport910B_When_OOM_Expect_ReturnIsHCCL_E_OOM)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_AllocTransport910C_When_OOM_Expect_ReturnIsHCCL_E_OOM)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(HcclImplTest, st_CheckSubCommLinkThreadsStatus_910C_When_OOM_Expect_ReturnIsHCCL_E_OOM)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
