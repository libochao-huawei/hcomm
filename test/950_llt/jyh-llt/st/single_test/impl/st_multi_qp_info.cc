...
class MulTiQpInfoSt : public testing::Test {
protected:
...
TEST_F(MulTiQpInfoSt, St_DEVMulQp)
{
...
TEST_F(MulTiQpInfoSt, St_DEVNSLBMulQp)
{
...
TEST_F(MulTiQpInfoSt, St_ConfigPath)
{
...
TEST_F(MulTiQpInfoSt, St_perconnection)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(MulTiQpInfoSt, St_QpFileNotExist)
{
