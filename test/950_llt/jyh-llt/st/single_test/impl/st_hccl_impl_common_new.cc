...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_postSync)
{
    u64 one = 1;
...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_AicpuKfcTilingDataLaunchExt_ReduceScatter_PostSync)
{
    u64 one = 1;
    MOCKER_CPP(&HcclCommunicator::CalcOpTilingDynamicDataSize)
        .stubs()
...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_AicpuKfcTilingDataLaunchExt_Allreduce_PreSync)
{
    u64 one = 1;
    MOCKER_CPP(&HcclCommunicator::CalcOpTilingDynamicDataSize)
        .stubs()
...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_AicpuKDataLaunch)
{
    GlobalMockObject::verify();
...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_AicpuKDataLaunch_Capture)
{
    GlobalMockObject::verify();
...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_GetStreamCaptureInfo)
{
    GlobalMockObject::verify();
    // 非单算子场景
...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_AddStreamToModel)
{
    MOCKER(rtStreamAddToModel)
    .stubs()
    .with(any())
...
TEST_F(HcclImplCommonNewTest, st_HcclCommunicator_GetModelId)
{
    MOCKER(rtModelGetId)
    .stubs()
    .with(any())
