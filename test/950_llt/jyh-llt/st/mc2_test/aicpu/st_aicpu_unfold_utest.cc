...
TEST_F(AicpuUnfold_ST, UpdateNotifyWaitTimeOut)
{
...
TEST_F(AicpuUnfold_ST, InitSlaveStreamObjs)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
...
TEST_F(AicpuUnfold_ST, InitTopoInfoAndInitResByTag)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, InitLocalTagRes)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, InitRemoteTagRes)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, GetStreamData)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, InitCclbuffer)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, GetSdmaLinksByRankAndTag)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, GetSdmaLinksByRankAndTag_HcclPlusSio)
{
...
TEST_F(AicpuUnfold_ST, GetLinksByRankAndTagException)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    std::string tag = "hcom_aicpu_unfold1";
    std::shared_ptr<Transport> link = make_shared<Transport>(nullptr);
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmLaunchProcess)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmWaitEndProcess)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmEndProcess)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmLaunchProcessTest)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmLaunchProcessWithStepSize)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    AicpuKfcRpcServerV2 rpc;
    memset_s(g_msgArea, sizeof(g_msgArea), 0, sizeof(g_msgArea));
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmStoppingProcess)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmStoppedProcess)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpSupportRetry)
{
    std::string algName = "test";
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
...
TEST_F(AicpuUnfold_ST, HcclGetWaitRetryCmdTimeout)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmWaitRetryProcess)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmRetryProcess)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, WaitFinishWhileLoop)
{
...
TEST_F(AicpuUnfold_ST, IsTaskExceptionForHccs)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, ResetSqBuff)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, init_aicpucom)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(AicpuUnfold_ST, st_GetAlgResponseRes)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(AicpuUnfold_ST, calcResRequest)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(AicpuUnfold_ST, orchestrate)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(AicpuUnfold_ST, orchestrate_RunAlltoAllVTwoLevelPipeline_a2a)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(AicpuUnfold_ST, orchestrate_RunAlltoAllVTwoLevelPipeline_a2avc)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(AicpuUnfold_ST, orchestrate_RunAlltoAllVTwoLevelPipeline_a2av)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(AicpuUnfold_ST, test_RunAicpuRpcSrvLaunchV2_dynamicData)
{
    HcclResult ret = HCCL_SUCCESS;
    hccl::HcclCommAicpu* hcclCommAicpu = new hccl::HcclCommAicpu();
...
TEST_F(AicpuUnfold_ST, test_RunAicpuRpcSrvLaunchV2_ReportSdmaErr)
{
    HcclResult ret = HCCL_SUCCESS;
    hccl::HcclCommAicpu* hcclCommAicpu = new hccl::HcclCommAicpu();
...
TEST_F(AicpuUnfold_ST, test_aicpuHcclProcess_HandleOneSideService)
{
    HcclResult ret;
...
TEST_F(AicpuUnfold_ST, st_HcclOneSideServiceAicpuProcess_When_SdmaAicpuUnflod_Expect_Success)
{
    HcclResult ret;
    constexpr u32 itemNum = 2;
...
TEST_F(AicpuUnfold_ST, st_HcclOneSideServiceAicpuDoProcess_When_linkTypeNotSupport_Expect_Failed)
{
    HcclResult ret;
    constexpr u32 itemNum = 2;
    std::string commId = "one_side_ut_test";
...
TEST_F(AicpuUnfold_ST, st_HcclOneSideServiceAicpuDoSdmaProcess_When_D2dCopyFailed_Expect_Failed)
{
...
TEST_F(AicpuUnfold_ST, test_hcclCommAicpu_alltoall)
{
    hccl::HcclCommAicpu* hcclCommAicpu = new hccl::HcclCommAicpu();
...
TEST_F(AicpuUnfold_ST, InitSendRecvOpId_HcclUpdateOpIndex)
{
    OpParam param;
...
TEST_F(AicpuUnfold_ST, PrintTaskExceptionByTaskId)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    uint32_t sqHead = 0;
    uint32_t sqTail = 100;
...
TEST_F(AicpuUnfold_ST, PrintTaskException)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    uint32_t sqHead = 0;
    uint32_t sqTail = 100;
...
TEST_F(AicpuUnfold_ST, st_PrintTaskException_ExecOp_fail)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    uint32_t sqHead = 0;
    uint32_t sqTail = 100;
...
TEST_F(AicpuUnfold_ST, st_aicpu_PrepareZeroCopyExchanger)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    uint32_t sqHead = 0;
    uint32_t sqTail = 100;
...
TEST_F(AicpuUnfold_ST, aicpu_prof_test_init)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    MOCKER(AdprofCheckFeatureIsOn).stubs().will(returnValue(1));
...
TEST_F(AicpuUnfold_ST, st_ReportFlagTask_test)
{
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmLaunchProcess_bsr_retry)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmStoppedProcess_bsr_retry)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmWaitRetryProcess_bsr_retry)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, HcclOpExecFsmRetryProcess_bsr_retry)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, aicpu_prof_test_init_false)
{
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
...
TEST_F(AicpuUnfold_ST, HcclOpExec_initexecloop)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    OpParam opParam;
...
TEST_F(AicpuUnfold_ST, HcclOpExec_ResetBSRRetryCnt_bsr_retry)
{
...
TEST_F(AicpuUnfold_ST, HcclOpExec_aicpuHdc)
{
    AicpuHdc aicpuHdc;
...
TEST_F(AicpuUnfold_ST, AicpuCheckNotifyOrQPMaxNum_ERROR)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    u64 roceNotifyNumMax = 24;
    EXPECT_EQ(hcclCommAicpu->CheckNotifyOrQPMaxNum(roceNotifyNumMax, RDMA_NOTIFY_MAX_NUM, true), HCCL_E_INTERNAL);
    delete hcclCommAicpu;
}

TEST_F(AicpuUnfold_ST, HostCheckNotifyOrQPMaxNum_ERROR)
{
    HcclCommunicator hcclCommunicator;
    u64 roceNotifyNumMax = 24;
    EXPECT_EQ(hcclCommunicator.CheckNotifyOrQPMaxNum(roceNotifyNumMax, RDMA_NOTIFY_MAX_NUM, true), HCCL_E_INTERNAL);
}

TEST_F(AicpuUnfold_ST, HcclOpExec_HcclOpExecFsmInitProcess)
{
...
TEST_F(AicpuUnfold_ST, InitBatchSendRecvOpId)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
...
TEST_F(AicpuUnfold_ST, st_GetBsrTransportQpn)
{
...
TEST_F(AicpuUnfold_ST, st_DispatcherProfilingRdmaSend)
{
    MOCKER(AdprofCheckFeatureIsOn).stubs().will(returnValue(1));
    bool isL1On = dfx::ProfilingManager::IsProfL1On();
    EXPECT_EQ(isL1On, true);
...
TEST_F(AicpuUnfold_ST, TaskInfo2Addition_ShouldSetCorrectFields_WhenMemcpySucceeds) {
    // Arrange
...
TEST_F(AicpuUnfold_ST, TaskInfo2Addition_ShouldReturnError_WhenMemcpyFails) {
    // Arrange
...
TEST_F(AicpuUnfold_ST, st_GenTaskExceptionInfo)
{
    HcclResult ret = HCCL_SUCCESS;
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
...
TEST_F(AicpuUnfold_ST, PrintTaskException_NoTask_st)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    uint32_t sqHead = 1;
    uint32_t sqTail = 1;
...
TEST_F(AicpuUnfold_ST, PrintTaskException_noActive_st)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    uint32_t sqHead = 0;
    uint32_t sqTail = 100;
...
TEST_F(AicpuUnfold_ST, st_MultiQp_useSingleQp)
{
...
TEST_F(AicpuUnfold_ST, st_MultiQp_32Qp_3Notify)
{
    DlRaFunction::GetInstance().DlRaFunctionInit();
    DlTraceFunction::GetInstance().DlTraceFunctionInit();
    std::string path = "sss";
...
// 临时补充覆盖率
TEST_F(AicpuUnfold_ST, st_OrchestrateAicpu_tmp)
{
...
TEST_F(AicpuUnfold_ST, st_OrchestrateAicpu_agv)
{
    HcclCommunicator impl;
...
TEST_F(AicpuUnfold_ST, test_RunAicpuRpcSrvLaunchV2_agv)
{
    HcclResult ret = HCCL_SUCCESS;
    hccl::HcclCommAicpu* hcclCommAicpu = new hccl::HcclCommAicpu();
...
TEST_F(AicpuUnfold_ST, test_OrchestrateAicpu_rsv)
{
...
TEST_F(AicpuUnfold_ST, test_RunAicpuRpcSrvLaunchV2_rsv)
{
    HcclResult ret = HCCL_SUCCESS;
    hccl::HcclCommAicpu* hcclCommAicpu = new hccl::HcclCommAicpu();
...
TEST_F(AicpuUnfold_ST, HostCheckSetAclGraphZeroCopyModeZero_FALSE)
{
...
TEST_F(AicpuUnfold_ST, HostCheckScratch_FALSE)
{
    ZeroCopyAclGraph aclgraphcpy;
    HcclCMDType opType = HcclCMDType::HCCL_CMD_REDUCE_SCATTER;
    OpParam opParam;
...
TEST_F(AicpuUnfold_ST, HostCheckSetGraphMode_TRUE)
{
    ZeroCopyAclGraph aclgraphcpy;
...
TEST_F(AicpuUnfold_ST, HostCheckIsAlgoSupportAclGraphZeroCopyMode_GetAlgoFALSE)
{
    ZeroCopyAclGraph aclgraphcpy;
    HcclCMDType opType = HcclCMDType::HCCL_CMD_ALLREDUCE;
    OpParam opParam;
...
TEST_F(AicpuUnfold_ST, HostCheckIsAlgoSupportAclGraphZeroCopyMode_GetAlgoTRUE)
{
    ZeroCopyAclGraph aclgraphcpy;
    HcclCMDType opType = HcclCMDType::HCCL_CMD_ALLREDUCE;
    OpParam opParam;
...
TEST_F(AicpuUnfold_ST, HostCheckIsAlgoSupportAclGraphZeroCopyMode_AlgoChecker)
{
    ZeroCopyAclGraph aclgraphcpy;
    HcclCMDType opType = HcclCMDType::HCCL_CMD_ALLREDUCE;
    OpParam opParam;
...
TEST_F(AicpuUnfold_ST, AicpuReportRetryErr)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    hcclCommAicpu->dumpDebug_ = false;
    hcclCommAicpu->dispatcher_ = nullptr;
...
TEST_F(AicpuUnfold_ST, ReportCqeException)
{
    HcclCommAicpu * hcclCommAicpu = new HcclCommAicpu;
    hcclCommAicpu->opNotifies_.push_back(std::make_shared<LocalNotify>());
    hcclCommAicpu->opNotifies_.push_back(std::make_shared<LocalNotify>());
...
TEST_F(AicpuUnfold_ST, st_aicpu_getcomm)
{
...
TEST_F(AicpuUnfold_ST, st_log_aicpuCoreExhausted)
{
...
// 覆盖率用例
TEST_F(AicpuUnfold_ST, HcclProcess_WaitAsyncFlagSuccess)
{
...
TEST_F(AicpuUnfold_ST, HcclProcess_WaitAsyncFlagFalse)
{
    hccl::Transport::Buffer localFlagBufforCheck[3];
...
TEST_F(AicpuUnfold_ST, HcclProcess_InitAsyncFlag)
{
...
TEST_F(AicpuUnfold_ST, AiCpu_RunTransportRoceTxRx_Success)
{
...
TEST_F(AicpuUnfold_ST, AiCpu_RunTransportRoceTxRx_False)
{
