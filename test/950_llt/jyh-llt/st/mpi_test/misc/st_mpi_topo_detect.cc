...
TEST_F(MPI_TOPO_DETECT_Test, st_hcclGetRootInfo_single_server_2p_success_normal_nic_spec)
{
    HcclResult ret;
    s32 nnode, rank = 0;
...
TEST_F(MPI_TOPO_DETECT_Test, st_hcclGetRootInfo_single_server_2p_success_security)
{
...
TEST_F(MPI_TOPO_DETECT_Test, st_hcclGetRootInfo_single_server_2p_success_normal)
{
    HcclResult ret;
    s32 nnode, rank = 0;
    MPI_Comm_size(MPI_COMM_WORLD, &nnode); // nnode 为mpi进程数，即服务器个数
...
TEST_F(MPI_TOPO_DETECT_Test, st_hcclGetRootInfo_single_server_2p_success_normal_1)
{
    HcclResult ret;
    s32 nnode, rank = 0;
    MPI_Comm_size(MPI_COMM_WORLD, &nnode); // nnode 为mpi进程数，即服务器个数
...
TEST_F(MPI_TOPO_DETECT_Test, st_hcclGetRootInfo_invaild_env_01)
{
...
TEST_F(MPI_TOPO_DETECT_Test, st_hcclMasterInfo_single_server_2p_success_normal)
{
    HcclResult ret;
    s32 nnode, rank = 0;
    MPI_Comm_size(MPI_COMM_WORLD, &nnode); // nnode 为mpi进程数，即服务器个数
