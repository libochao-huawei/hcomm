...
TEST_M(RdmaAgent, tc_hdc_mr_reg);
TEST_M(RdmaAgent, tc_hdc_mr_dereg);
TEST_M(RdmaAgent, tc_hdc_send_wr);
TEST_M(RdmaAgent, tc_hdc_send_wrlist);
TEST_M(RdmaAgent, tc_hdc_get_notify_base_addr);
TEST_M(RdmaAgent, tc_set_notify_cfg);
TEST_M(RdmaAgent, tc_get_notify_cfg);
...
TEST_M(RdmaAgent, tc_ra_rs_set_qp_attr_qos);
TEST_M(RdmaAgent, tc_ra_rs_set_qp_attr_timeout);
TEST_M(RdmaAgent, tc_ra_rs_set_qp_attr_retry_cnt);
TEST_M(RdmaAgent, tc_ra_rs_get_cqe_err_info);
TEST_M(RdmaAgent, tc_ra_rs_get_cqe_err_info_num);
TEST_M(RdmaAgent, tc_ra_rs_get_cqe_err_info_list);
TEST_M(RdmaAgent, tc_ra_rs_get_lite_support);
TEST_M(RdmaAgent, tc_ra_RsGetLiteRdevCap);
TEST_M(RdmaAgent, tc_ra_rs_get_lite_qp_cq_attr);
TEST_M(RdmaAgent, tc_ra_rs_get_lite_connected_info);
TEST_M(RdmaAgent, tc_ra_rs_socket_white_list_v2);
TEST_M(RdmaAgent, tc_ra_rs_socket_credit_add);
TEST_M(RdmaAgent, tc_ra_rs_get_lite_mem_attr);
...
TEST_M(RdmaAgent, tc_ra_hdc_set_qp_attr_qos);
TEST_M(RdmaAgent, tc_ra_hdc_set_qp_attr_timeout);
TEST_M(RdmaAgent, tc_ra_hdc_set_qp_attr_retry_cnt);
TEST_M(RdmaAgent, tc_ra_hdc_get_cqe_err_info);
TEST_M(RdmaAgent, tc_ra_hdc_get_cqe_err_info_list);
TEST_M(RdmaAgent, tc_ra_hdc_qp_create_op);
TEST_M(RdmaAgent, tc_ra_hdc_get_qp_status_op);
...
TEST_M(RdmaAgent, tc_message_process_fail);

TEST_M(RdmaAgent, tc_host_abnormal_qp_mode_test);
// TEST_M(RdmaAgent, tc_hdc_send_recv_pkt_recv_check);
...
// TEST_M(RdmaAgent, tc_ra_hdc_socket_batch_close);
// TEST_M(RdmaAgent, tc_rs_get_cur_time);
...
// TEST_M(RdmaAgent, tc_host_notify_base_addr_init_007);
