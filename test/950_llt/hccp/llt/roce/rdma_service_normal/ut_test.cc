...
// TEST_M(RS, tc_rs_init);	//For normal tc, this tc MUST be the first
TEST_M(RS, tc_rs_socket_listen);
TEST_M(RS, tc_rs_socket_listen_ipv6);

// TEST_M(RS, tc_rs_socket_connect);
...
// TEST_M(RS, tc_rs_deinit); //MUST be the last
...
// TEST_M(RS, tc_RsRdev2rdevCb);
// TEST_M(RS, tc_rs_compare_ip_gid);
// TEST_M(RS, tc_rs_query_gid);
TEST_M(RS, tc_rs_get_host_rdev_index);
// TEST_M(RS, tc_rs_get_ib_ctx_and_rdev_index);
TEST_M(RS, tc_rs_rdev_cb_init);
// TEST_M(RS, tc_rs_rdev_init);
TEST_M(RS, tc_rs_ssl_free);
// TEST_M(RS, tc_rs_drv_connect);
// TEST_M(RS, tc_rs_qpn2qpcb);
TEST_M(RS, tc_rs_ssl_deinit);
TEST_M(RS, tc_rs_tls_inner_enable);
TEST_M(RS, tc_rs_ssl_inner_init);
TEST_M(RS, tc_rs_ssl_ca_ky_init);
TEST_M(RS, tc_rs_ssl_crl_init);
TEST_M(RS, tc_rs_check_pridata);
TEST_M(RS, tc_rs_ssl_load_ca);
TEST_M(RS, tc_rs_ssl_get_ca_data);
TEST_M(RS, tc_rs_ssl_get_ca_data_1);
TEST_M(RS, tc_rs_ssl_get_crl_data_1);
TEST_M(RS, tc_rs_ssl_put_certs);
TEST_M(RS, tc_rs_ssl_check_cert_chain);
TEST_M(RS, tc_rs_ssl_skid_get_from_chain);
TEST_M(RS, tc_rs_ssl_verify_cert_chain);
TEST_M(RS, tc_tls_get_cert_chain);
TEST_M(RS, tc_rs_ssl_get_leaf_cert);
...
// TEST_M(RS, tc_rs_get_vnic_ip);
 TEST_M(RS, tc_rs_notify_cfg_set);
// TEST_M(RS, tc_rs_notify_cfg_get);
// TEST_M(RS, tc_crypto_decrypt_with_aes_gcm);
TEST_M(RS, tc_rs_server_send_wlist_check_result);
// TEST_M(RS, tc_rs_socket_init);


// // TEST_M(RS, tc_rs_listen_invalid_port);
// TEST_M(RS, tc_rs_socket_deinit1);
TEST_M(RS, tc_rs_socket_deinit2);
// TEST_M(RS, tc_rs_drv_qp_normal_fail);
...
TEST_M(RS, tc_rs_epoll_ctl_add_02);
...
TEST_M(RS, tc_rs_epoll_event_jfc_in_handle);
TEST_M(RS, tc_rs_handle_epoll_poll_jfc);
...
TEST_M(RS, tc_rs_ub_ctx_jfc_create_normal);
...
TEST_M(RS, tc_rs_ssl_check_mng_and_cert_chain);
TEST_M(RS, tc_rs_remove_certs);
