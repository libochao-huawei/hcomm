...
class ScatterInterNBTest : public testing::Test
{
protected:
...
HcclDispatcher ScatterInterNBTest::dispatcherPtr = nullptr;
DispatcherPub *ScatterInterNBTest::dispatcher = nullptr;

#if 1
TEST_F(ScatterInterNBTest, destructor_D0)
{
...
#endif
#if 1
TEST_F(ScatterInterNBTest, run_async_00)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterInterNBTest, run_async_01)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterInterNBTest, run_async_02)
{
     s32 ret = HCCL_SUCCESS;
...
#if 1
//  chunksize不够128字节均分
TEST_F(ScatterInterNBTest, run_async_03)
{
    s32 ret = HCCL_SUCCESS;
...
#if 1
// ranksize ==1 分支?
TEST_F(ScatterInterNBTest, run_async_04)
{
     s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterInterNBTest, run_async_linkerr_1)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterInterNBTest, run_async_linkerr_2)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(ScatterInterNBTest, run_async_007)
{
...
TEST_F(ScatterInterNBTest, run_async_008)
{
    std::vector<u32> nicRankList = {0};
...
TEST_F(ScatterInterNBTest, run_async_009)
{
    std::vector<u32> nicRankList = {1};
    run_async_test_scatter_nb(dispatcher, /*rank=*/1, /*rankSize=*/8, /*root=*/0, /*nLinks=*/-1, nicRankList);
}
