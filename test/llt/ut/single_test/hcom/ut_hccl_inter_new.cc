...
#if 0
TEST_F(HcclInterTest, ut_reduce_inter_sum_char_root3)
{
...
#if 0
TEST_F(HcclInterTest, ut_reduce_inter_sum_float_slice)
{
...
#if 0 //执行失败aclrtNotifyImportByKey
...
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pmesh_root0_1000)
{
    // ranktable 的读取，直接使用进程
...
#endif
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pmesh_root0_60)
{
    // ranktable 的读取，直接使用进程
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pmesh_root_not0_40)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pmesh_root_not0_515)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
#endif
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pring_root0_1000)
{
...
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pring_root2_40)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_char_8pring_root0_4096)
{
...
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pring_root0_10)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_char_4pring_root2)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
#if 0
TEST_F(HcclInterTest, ut_broadcast_inter_float_slice)
{
    // ranktable 的读取，直接使用进程 
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(HcclInterTest, ut_allreduce_inter_char)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
...
TEST_F(HcclInterTest, ut_allreduce_inter_float_max)
{
    nlohmann::json rank_table = rank_table_910_1server_4rank;
