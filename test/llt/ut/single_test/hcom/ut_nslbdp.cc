...
TEST_F(STnslbdpTest, ut_hccl_noranktable)
{
    MOCKER(H2DTlvRequest)
    .stubs()
    .with(any())
...
TEST_F(STnslbdpTest, ut_sendtable1)
{
    MOCKER(H2DTlvInit)
    .stubs()
    .with(any())
...
#if 0
TEST_F(STnslbdpTest, ut_init_hccp)
{
    MOCKER(H2DTlvInit)
    .stubs()
    .with(any())
    ...
    hcclNslbDp::GetInstance().InitNetCo();
...
TEST_F(STnslbdpTest, ut_checklevel1_910b)
{
    u8 typel1 = 0;
...
TEST_F(STnslbdpTest, ut_checklevel2_910_93)
{
    u8 typel2 = 0;
...
TEST_F(STnslbdpTest, ut_checkNslbOpType)
{
    u8 type1 = 0;
...
TEST_F(STnslbdpTest, ut_checkfirst4bit)
{
...
TEST_F(STnslbdpTest, ut_checkalgo_match)
{
...
TEST_F(STnslbdpTest, ut_getnslb_l4portid)
{
    u32 rankSize = 8;
    u8 algType = 1;
    u16 l4SPortId = 0;
...
TEST_F(STnslbdpTest, ut_collectsend_table4)
{
    MOCKER(H2DTlvRequest)
    .stubs()
    .with(any())
...
#if 0
TEST_F(STnslbdpTest, ut_collect_table2_910b)
{
    MOCKER(H2DTlvRequest)
    .stubs()
    .with(any())
...
TEST_F(STnslbdpTest, ut_collect_table3_910b)
{
    MOCKER(H2DTlvRequest)
    .stubs()
    .with(any())
...
TEST_F(STnslbdpTest, ut_Initconfig_nslb)
{
    MOCKER(H2DTlvInit)
    .stubs()
    .with(any())
...
#if 0 //执行失败
TEST_F(STnslbdpTest, ut_collect_ahc_table2_910_93)
{
    MOCKER(H2DTlvRequest)
    .stubs()
    .with(any())
...
TEST_F(STnslbdpTest, ut_collect_ahc_table3_910_93)
{
    MOCKER(H2DTlvRequest)
    .stubs()
    .with(any())
