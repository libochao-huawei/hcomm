...
TEST_F(TopoExchangeAgentTest, Ut_VerifyClusterTlsConsistency_When_Consistent_True_SupportTls_True_Expect_ReturnIsHCCL_SUCCESS)
{
...
TEST_F(TopoExchangeAgentTest, Ut_VerifyClusterTlsConsistency_When_Consistent_False_SupportTls_True_Expect_ReturnIsHCCL_E_PARA_01)
{
    HcclIpAddress localIp(1694542016);
    HcclNetDevCtx netDevCtx;
    HcclBasicRankInfo localRankInfo;
...
TEST_F(TopoExchangeAgentTest, Ut_VerifyClusterTlsConsistency_When_Consistent_False_SupportTls_True_Expect_ReturnIsHCCL_E_PARA_02)
{
    HcclIpAddress localIp(1694542016);
    HcclNetDevCtx netDevCtx;
    HcclBasicRankInfo localRankInfo;
...
TEST_F(TopoExchangeAgentTest, Ut_VerifyClusterTlsConsistency_When_Consistent_True_SupportTls_False_Expect_ReturnIsHCCL_SUCCESS)
{
    HcclIpAddress localIp(1694542016);
    HcclNetDevCtx netDevCtx;
    HcclBasicRankInfo localRankInfo;
...
TEST_F(TopoExchangeAgentTest, Ut_VerifyClusterTlsConsistency_When_Consistent_False_SupportTls_False_Expect_ReturnIsHCCL_E_PARA)
{
    HcclIpAddress localIp(1694542016);
    HcclNetDevCtx netDevCtx;
    HcclBasicRankInfo localRankInfo;
