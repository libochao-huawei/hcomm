...
int rs_socket_listen_stop(struct socket_listen_info listen[], uint32_t num)
{
    return 0;
}
...
int rs_register_mr(unsigned int dev_id, unsigned int rdev_index, struct rdma_mr_reg_info *mr_reg_info)
{
    return 0;
}

int rs_deregister_mr(unsigned int dev_id, unsigned int rdev_index, char *addr)
{
    return 0;
}
...
// int send_wrlist_exp(struct rs_qp_cb *qp_cb, struct wr_info *wr_list, unsigned int send_num,
//     struct send_wr_rsp *wr_rsp, unsigned int *complete_num)
// {
//     return 0;
// }
...
int rs_set_host_pid(uint32_t dev_id, uint32_t host_pid)
{
    return 0;
}
...
int rs_init(struct ra_init_config *cfg)
{
    return 0;
}
...
int rs_deinit(struct ra_init_config *cfg)
{
    return 0;
}
...
int rs_get_ifaddrs_v2(struct interface_info interface_infos[], unsigned int *num,
...
int rs_remap_mr(unsigned int phy_id, unsigned int rdev_index, struct mem_remap_info mem_list[], unsigned int mem_num)
{
    return 0;
}
...
int rs_get_hccn_cfg(unsigned int phy_id, enum hccn_cfg_key key, char *value, unsigned int *value_len)
{
	return 0;
}
