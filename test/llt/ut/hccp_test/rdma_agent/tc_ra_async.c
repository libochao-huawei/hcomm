...
void tc_ra_socket_batch_connect_async_fail()
{
    ...
    ret = ra_socket_batch_connect_async(conn, 0, &req_handle);
    EXPECT_INT_NE(ret, 0);

    ret = ra_socket_batch_connect_async(conn, 1, NULL);
    EXPECT_INT_NE(ret, 0);
...
void tc_ra_socket_listen_start_async_fail()
{
    ...
    ret = ra_socket_listen_start_async(conn, 0, &req_handle);
    EXPECT_INT_NE(ret, 0);

    ret = ra_socket_listen_start_async(conn, 1, NULL);
    EXPECT_INT_NE(ret, 0);
...
void tc_ra_socket_listen_stop_async_fail()
{
    ...
    ret = ra_socket_listen_stop_async(conn, 0, &req_handle);
    EXPECT_INT_NE(ret, 0);

    ret = ra_socket_listen_stop_async(conn, 1, NULL);
    EXPECT_INT_NE(ret, 0);

    conn[0].socket_handle = NULL;
    ret = ra_socket_listen_stop_async(conn, 1, &req_handle);
    EXPECT_INT_NE(ret, 0);
...
void tc_ra_socket_batch_close_async_fail()
{
    ...
    ret = ra_socket_batch_close_async(conn, 0, &req_handle);
    EXPECT_INT_NE(ret, 0);

    ret = ra_socket_batch_close_async(conn, 1, NULL);
    EXPECT_INT_NE(ret, 0);
