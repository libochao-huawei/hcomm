...
TEST_F(MPI_Pcie_Test, ut_mpi_pcie_init)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Pcie_Test, ut_mpi_pcie_tx_rx)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Pcie_Test, ut_mpi_pcie_dst_copy)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Pcie_Test, ut_mpi_pcie_write_read)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Pcie_Test, ut_mpi_pcie_create_link)
{
    s32 ret;
    s32 size, rank;
...
TEST_F(MPI_Pcie_Test, ut_mpi_mc2aicpu_pcie_tx_rx)
{
    s32 ret;
    s32 size, rank;
