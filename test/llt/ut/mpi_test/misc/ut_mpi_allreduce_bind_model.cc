...
void* inter_all_reduce_task(void* parg)
{
    ...
    for(int i = 0; i < para_info->round; ++i)
    {
        ...
        {
            HCCL_ERROR("rank[%d] task allgather fails", para_info->comm_id);
        }
...
#if 1
#define DEV_NUM_4 4
TEST_F(MPI_AllreduceBindModel_Test, ut_mpi_allreduce_8ranks_2server_ring_muti_tag)
{
...
#if 1
#define DEV_NUM_8 8
TEST_F(MPI_AllreduceBindModel_Test, ut_mpi_allreduce_16ranks_2server_char_sum_4rings_bind_model)
{
    // ranktable 的读取，直接使用进程
