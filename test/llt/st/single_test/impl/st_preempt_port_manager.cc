...
TEST_F(HcclPreemptPortManagerTest, st_GetInstance_unnormal_case)
{
    {
...
TEST_F(HcclPreemptPortManagerTest, st_ListenPreempt)
{
...
TEST_F(HcclPreemptPortManagerTest, st_PreemptPortInRange_reuse)
{
...
TEST_F(HcclPreemptPortManagerTest, st_PreemptPortInRange_nouse1)
...
TEST_F(HcclPreemptPortManagerTest, st_PreemptPortInRange_nouse2)
...
TEST_F(HcclPreemptPortManagerTest, st_PreemptPortInRange_nouse3)
{
    MOCKER_CPP(&HcclSocket::Listen, HcclResult (HcclSocket::*)(u32 port))
        .stubs()
        .with(any())
...
TEST_F(HcclPreemptPortManagerTest, st_IsAlreadyListening)
{
    IpPortRef hostPortRef ;
    hostPortRef.insert({"10.10.10.02", std::make_pair(5000, Referenced())});
    PreemptPortManager& ppm = PreemptPortManager::GetInstance(0);
...
TEST_F(HcclPreemptPortManagerTest, st_ReleasePreempt)
{
...
TEST_F(HcclPreemptPortManagerTest, st_Release)
{
