...
TEST_F(HcclImplTest, st_hcclimpl_BuildAlltoAllVScratchMem)
{
...
TEST_F(HcclImplTest, st_hcclimpl_CreateCommForAlltoAllFullMesh)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_GetInnerServerAverageDevice)
{
...
TEST_F(HcclImplTest, st_GetCqeError)
{
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_REDUCE_SCATTER)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_REDUCE_SCATTER_15SEVER)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_REDUCE_SCATTER_11SEVER_1)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_REDUCE_SCATTER_11SEVER_2)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLGATHER)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLGATHER_15SEVER)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLGATHER_11SEVER_1)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLGATHER_11SEVER_2)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLREDUCE)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLREDUCE_15SEVER)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLREDUCE_11SEVER_1)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_AutoSelectAlgTypeLevel1_ALLREDUCE_11SEVER_2)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_SelectAlgoTypeForReduceScatter)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_SelectAlgoTypeForAllGather)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_SelectAlgoTypeForGather)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_SelectAlgoTypeForAllReduce)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_SelectAlgoTypeForBroadcast)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclimpl_SelectAlgoTypeForReduce)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_multiModuleDiffDeviceNumMode_SetAlgType)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclImpl_get_double_ring_topo_type_1)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclImpl_get_double_ring_topo_type_2)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclImpl_is_double_ring_topo_pattern_1)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclImpl_is_double_ring_topo_pattern_2)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclImpl_is_double_ring_topo_pattern_3)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclImpl_run_double_ring_executer_by_all_gather)
{
    std::unique_ptr<HcclCommunicator> implBase(new (std::nothrow) HcclCommunicator());
...
TEST_F(HcclImplTest, st_hcclImpl_run_double_ring_executer_by_all_reduce)
{
...
TEST_F(HcclImplTest, st_hcclImpl_run_double_ring_executer_for_91093_by_broadcast)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_hcclImpl_run_double_ring_executer_for_91093_by_all_reduce)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_hcclImpl_run_fast_double_ring_for_910_93_executer_by_all_reduce)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_multiModuleDiffDeviceNumMode_1s7p_disableRDMA)
{
...
TEST_F(HcclImplTest, st_multiModuleDiffDeviceNumMode_1s7p_enableRDMA)
{
...
TEST_F(HcclImplTest, st_multiModuleDiffDeviceNumMode_1s8p_disableRDMA)
{
...
TEST_F(HcclImplTest, st_multiModuleDiffDeviceNumMode_1s8p_enableRDMA)
{
    // module0:0,1,2,3  module1:8,9,10,12 without rdma
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(HcclImplTest, st_HcclCommunicator_AicpuUnfold)
{
...
TEST_F(HcclImplTest, st_hrtRaGetSocketVnicIpInfos)
{
    HcclResult ret =  HCCL_SUCCESS;
    u32 phy_id = 2;
    vector<u32> ids;
...
TEST_F(HcclImplTest, st_H2DTlvInit)
{
    HcclResult ret =  HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_H2DTlvRequest)
{
    HcclResult ret =  HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_H2DTlvDeinit)
{
    HcclResult ret =  HCCL_SUCCESS;
    void *tlv_handle = nullptr;
...
TEST_F(HcclImplTest, st_hccl_Communicator_SetRetryEnable_Inter_Super_Pod_true)
{
    HcclResult ret;
...
TEST_F(HcclImplTest, st_hccl_Communicator_SetRetryEnable_Inter_2Sever_true)
{
    HcclResult ret;
...
TEST_F(HcclImplTest, st_hccl_Communicator_SetRetryEnable_Inter_1Sever_true)
{
    HcclResult ret;
    setenv("HCCL_OP_RETRY_ENABLE", "L0:0, L1:1, L2:0", 1);
    ret = ParseRetryEnable();
...
#if 1
TEST_F(HcclImplTest, st_hccl_Communicator_SetRetryEnable_Intra_Sever_true)
{
    HcclResult ret;
...
#endif
TEST_F(HcclImplTest, st_hccl_Communicator_SetRetryEnable_All_False)
{
    HcclResult ret;
...
TEST_F(HcclImplTest, st_hccl_Communicator_SetRetryEnable_deviceNumPerAggregation_1)
{
    HcclResult ret;
    setenv("HCCL_OP_RETRY_ENABLE", "L0:1, L1:0, L2:0", 1);
    ret = ParseRetryEnable();
...
TEST_F(HcclImplTest, st_hccl_Communicator_SetRetryEnable_illegal_config)
{
    HcclResult ret;
...
TEST_F(HcclImplTest, st_transport_base_stop_test)
{
    HcclResult ret =  HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_transport_base_Resume_test)
{
    HcclResult ret =  HCCL_SUCCESS;
    DispatcherPub *dispatcher;
    const std::unique_ptr<NotifyPool> notifyPool;
...
TEST_F(HcclImplTest, st_migrate_link_to_stop_or_Resume)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_transport_base_fence_test)
{
    HcclResult ret =  HCCL_SUCCESS;
    DispatcherPub *dispatcher;
    const std::unique_ptr<NotifyPool> notifyPool;
...
TEST_F(HcclImplTest, st_migrate_link_vector_to_stop_or_Resume_test)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommunicator hcclCommunicator;
...
TEST_F(HcclImplTest, st_traverse_link_vector_test)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommunicator hcclCommunicator;
...
TEST_F(HcclImplTest, st_hccl_communicator_stop_test)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_hccl_communicator_Resume_test)
{
    HcclResult ret = HCCL_SUCCESS;
    auto notifypool = std::make_unique<NotifyPool>();
    std::map<HcclIpAddress, HcclNetDevCtx> netDevCtxMap = {};
...
TEST_F(HcclImplTest, st_regist_tast_abort_handler_test)
{
    hcclComm hcclcomm;
...
TEST_F(HcclImplTest, st_un_regist_tast_abort_handler_test)
{
...
TEST_F(HcclImplTest, st_hccl_comm_suspend_test)
{
    hcclComm hcclcomm;
    hcclcomm.communicator_ = std::make_unique<HcclCommunicator>();
    MOCKER(hrtTaskAbortHandleCallback)
...
TEST_F(HcclImplTest, st_TraverseSingleSubCommTransport_first_test)
{
...
TEST_F(HcclImplTest, st_TraverseSingleSubCommTransport_second_test)
{
    TransportType type = TransportType::TRANS_TYPE_P2P;
    TransportPara para;
    const std::unique_ptr<NotifyPool> notifyPool;
...
TEST_F(HcclImplTest, st_TraverseSingleSubCommTransport_third_test)
{
    TransportType type = TransportType::TRANS_TYPE_P2P;
    TransportPara para;
    const std::unique_ptr<NotifyPool> notifyPool;
...
TEST_F(HcclImplTest, st_TraverseLevelNSubCommTransport_test)
{
...
TEST_F(HcclImplTest, st_TraverseOpCommTransport_test)
{
    OpCommTransport op;
    op.resize(1);
    HcclCommunicator hcclCommunicator;
...
TEST_F(HcclImplTest, st_TraverseAlgResourceResponse_test)
{
    HcclCommunicator hcclCommunicator;
...
TEST_F(HcclImplTest, st_hcclImpl_run_ring_executer_by_all_reduce_stars)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_hcclImpl_run_ring_executer_by_all_gather_stars)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_hcclImpl_run_double_ring_executer_by_all_reduce_stars_2)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_ReduceScatterVFor910BMesh)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_ReduceScatterVAivSmallCount)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_hcclImpl_run_a3_aiv_coressnode_opbase)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_hcclImpl_run_a3_aiv_coressnode_offload)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_ReduceScatterVFor310PRing)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_ReduceScatterVFor310PRingNosupportIineReduce)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_AllGatherVFor310PExecutor_Ring)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_AllGatherVFor910BExecutor_Mesh)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_AllGatherVAivBigCount)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_AllGatherVAivSmallCount)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_AllGatherV_offload_For910B_Executor_Mesh_v1)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_AllGatherV_offload_For910B_Executor_Mesh_v2)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_ReduceScatterVAivBigCount)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplTest, st_hcclimpl_AiCpuSetCommResource_MultiServer)
{
    u32 ifnumVersion = 3;
    MOCKER(hrtRaGetInterfaceVersion)
    .stubs()
...
TEST_F(HcclImplTest, st_hcclimpl_AiCpuSetCommResource_AIVHierarchy)
{
    void *commInputPtr = nullptr;
    u64 commInputSize;
    void *commOutputPtr = nullptr;
...
TEST_F(HcclImplTest, st_hcclimpl_AiCpuSetCommResource_AIVRoce)
{
    u32 ifnumVersion = 3;
    MOCKER(hrtRaGetInterfaceVersion)
    .stubs()
...
TEST_F(HcclImplTest, st_clean_ccl_buffer)
{
    HcclCommParams params;
    RankTable_t rankTable;
    TestConstructParam(params, rankTable);
...
TEST_F(HcclImplTest, st_AllocTransport910B)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_AllocTransport910C)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(HcclImplTest, st_checkSubCommLinkThreadsStatus_910C)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(HcclImplTest, st_TransportMgrConstructTransTag)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(HcclImplTest, st_TransportMgrExceptionHandle)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(HcclImplTest, st_TransportMgrSetMachinePara)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(HcclImplTest, st_update_zerocopy)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_prepare_zerocopy_algname)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_prepare_zerocopy_op)
{
    HcclResult ret = HCCL_SUCCESS;
    MOCKER(GetWorkflowMode)
    .stubs()
...
TEST_F(HcclImplTest, st_AllocTransportZeroCopy)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplTest, st_zerocopy_alloc_slave_empty)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
#if 0
TEST_F(HcclImplTest, st_Mc2CreateAndLaunchContext_multi_server)
{
    HcclResult ret = HCCL_SUCCESS;
    std::unique_ptr<HcclCommunicator> hcclCommunicator(new (std::nothrow) HcclCommunicator());
...
#endif
TEST_F(HcclImplTest, st_hcclimpl_AiCpuSetCommResource_EnvTest)
{
    u32 ifnumVersion = 3;
    MOCKER(hrtRaGetInterfaceVersion)
    .stubs()
...
TEST_F(HcclImplTest, st_GetRemoteUserMemResource_When_Link_Normal_Expect_ReturnSuccess)
{
    HcclResult ret = HCCL_SUCCESS;
    std::unique_ptr<HcclCommunicator> hcclCommunicator(new (std::nothrow) HcclCommunicator());
    // 构建window resource
...
#if 0 // coredump
TEST_F(HcclImplTest, st_HcclCommunicator_AicpuUnfold_and_AllReduceAicpuUnfold)
{
    setenv("HCCL_OP_EXPANSION_MODE", "AI_CPU", 1);
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
...
TEST_F(HcclImplTest, st_inst_topo_getNetLayer)
{
...
TEST_F(HcclImplTest, st_get_inst_byNetLayer)
{
    hcclComm hcclcomm;
