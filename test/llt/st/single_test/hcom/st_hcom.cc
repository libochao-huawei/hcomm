...
TEST_F(HcomTest, st_hcom_GetHcclComm)
{   
    int64_t comm = 0;
    std::string group;
...
TEST_F(HcomTest, st_hcom_CreateCommCclBuf)
{   
    std::string group = "aa";
    MOCKER(hrtGetDeviceType)
    .stubs()
...
TEST_F(HcomTest, st_hcom_GetInCclBuf)
{   
    std::string group = "a";
    void* Ptr;
    u64 Size;
...
TEST_F(HcomTest, st_hcom_GetOutCclBuf)
{   
    std::string group = "a";
    void* Ptr;
    u64 Size;
...
TEST_F(HcomTest, st_hcom_GetdirectCclBuf)
{   
    int64_t hcomComm;
    const char *sGroup;
...
TEST_F(HcomTest, st_hccl_CommCalcTaskNum)
{   
    u32 num;
    HcomOpParam OpParam{};
...
TEST_F(HcomTest, st_get_GroupNameByOpBaseHcom)
{   
    s64 opBaseHcom;
    char *groupname;
