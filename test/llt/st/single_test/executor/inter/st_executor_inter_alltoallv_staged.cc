...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_inter_alltoallv_staged_4ranks_1server_float)
{
    HcclResult ret;
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_inter_alltoallv_staged_2ranks_1server_int16)
{
    HcclResult ret;
    std::string algo = "level0:pairwise;level1:pairwise";
    ret = SetHcclAlgoConfig(algo);
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_inter_alltoallv_staged_4ranks_1server_int16)
{
    HcclResult ret;
    std::string algo = "level0:pairwise;level1:pairwise";
    ret = SetHcclAlgoConfig(algo);
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_inter_alltoallv_staged_4ranks_1server_int64)
{
    HcclResult ret;
    std::string algo = "level0:pairwise;level1:pairwise";
    ret = SetHcclAlgoConfig(algo);
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_inter_opbase_alltoallv_staged_4ranks_1server_int64)
{
    HcclResult ret;
    std::string algo = "level0:pairwise;level1:pairwise";
    ret = SetHcclAlgoConfig(algo);
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_opbase_alltoallv_set)
{
    HcclResult ret;
    // 通过环境变量选择走全连接还是分级
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_send_zero_check)
{
    s32 device_id = 0;
    Stream stream;
    DeviceMem sendMem;
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_inter_alltoallv_staged_mesh_4ranks_1server_int64)
{
    HcclResult ret;
...
#if 1
TEST_F(Inter_AlltoAllV_Staged_Test, st_inter_alltoallv_staged_mesh_2ranks_1server_int64)
{
    HcclResult ret;
    std::string algo = "level0:fullmesh;level1:pairwise";
    ret = SetHcclAlgoConfig(algo);
