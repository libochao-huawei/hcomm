...
HcclResult stub_hrtRaGetCqeErrInfoList(RdmaHandle handle, struct cqe_err_info *infolist, unsigned int *num)
{
    *num = 1;
    infolist[0].qpn=1;
...
TEST_F(TypicalInterfaceTest, st_interface_create_ascend_qp_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_modify_ascend_qp_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_destroy_ascend_qp_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_alloc_free_window_mem_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_alloc_free_sync_mem_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_register_deregister_mem_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_send_by_ascend_qp_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_recv_by_ascend_qp_test)
{
    MOCKER_CPP(&TypicalQpManager::GetQpHandleByQpn)
    .stubs()
    .with(any(), any())
...
TEST_F(TypicalInterfaceTest, st_interface_put_by_ascend_qp_test)
{
    MOCKER_CPP(&TypicalQpManager::GetQpHandleByQpn)
    .stubs()
    .with(any(), any())
...
TEST_F(TypicalInterfaceTest, st_interface_batch_put_by_ascend_qp_test)
{
...
TEST_F(TypicalInterfaceTest, st_interface_wait_batch_put_by_ascend_qp_test)
{
    MOCKER_CPP(&SendRecvExecutor::WaitSignal)
    .stubs()
    .will(returnValue(HCCL_SUCCESS));
...
TEST_F(TypicalInterfaceTest, st_interface_hcclrdma_init_and_deInit)
{
...
TEST_F(TypicalInterfaceTest, st_interface_get_err_cqe_list)
{
    void* mrHandle = (void*)0x11;
    MOCKER(hrtRaRegGlobalMr)
    .stubs()
