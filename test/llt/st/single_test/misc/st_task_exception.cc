...
TEST_F(TaskExceptionTest, st_task_exception_callback)
{
    u32 deviceLogicId = 0;
...
TEST_F(TaskExceptionTest, st_task_exception_callback_ffts)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
...
TEST_F(TaskExceptionTest, st_task_exception_callback_context_size)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
...
TEST_F(TaskExceptionTest, st_task_exception_callback_fftsCtx)
{
...
TEST_F(TaskExceptionTest, st_task_exception_callback_fftsCtx_context_size)
{
    MOCKER(GetExternalInputTaskExceptionSwitch)
    .stubs()
    .will(returnValue(1));
...
TEST_F(TaskExceptionTest, st_task_exception_callback_heartbeat1)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
...
TEST_F(TaskExceptionTest, st_task_exception_callback_heartbeat2)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
...
TEST_F(TaskExceptionTest, st_task_exception_callback__cqe_heartbeat)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
...
#endif
TEST_F(TaskExceptionTest, st_TaskInfo_GetBaseInfoStr)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
...
TEST_F(TaskExceptionTest, st_TaskInfo_GetOpDataAndRankInfo)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
    ...
    TaskExceptionHandler::DealExceptionGroupRank(&rtExceptionInfo1, tag, true, groupRankContentInfo);
    TaskExceptionHandler::DealExceptionOpData(&rtExceptionInfo1, tag, true, index);
...
#if 0 //执行失败Map size is bigger than max stream count
TEST_F(TaskExceptionTest, st_task_exception_callback__stuck_heartbeat)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
...
TEST_F(TaskExceptionTest, st_PrintAicpuErrorMessage)
{
...
#if 0 //执行失败Map size is bigger than max stream count
TEST_F(TaskExceptionTest, st_task_exception_aiv)
{
    u32 deviceLogicId = 0;
    TaskExceptionHandler taskExceptionHandler(deviceLogicId);
