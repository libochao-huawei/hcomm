...
TEST_F(RanktableTest, st_CheckUniqueInfo)
{
...
TEST_F(RanktableTest, st_AddServer)
{
nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(RanktableTest, st_AddGroup)
{
nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(RanktableTest, st_GetGroupsInfo)
{
nlohmann::json rank_table =
    {
        {"group_count","1"},
...
TEST_F(RanktableTest, st_GenerateRankTable)
{
nlohmann::json rank_table =
    {
        {"group_count","1"},
