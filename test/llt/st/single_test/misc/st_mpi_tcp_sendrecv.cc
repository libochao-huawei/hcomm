...
TEST_F(MPI_TCP_SENDRECV_TEST, st_mpi_tcp_send_link)
{
    SetTcpMode(true);
    HcclResult ret;
...
TEST_F(MPI_TCP_SENDRECV_TEST, st_mpi_tcp_improbe)
{
    SetTcpMode(true);
    HcclResult ret;
    u32 commId = 0;
...
TEST_F(MPI_TCP_SENDRECV_TEST, st_mpi_tcp_imrecv)
{
    SetTcpMode(true);
    u32 commId = 0;
    u32 peerRank = 0;
...
TEST_F(MPI_TCP_SENDRECV_TEST, st_mpi_tcp_TcpfdHandleCheck)
{
   SetTcpMode(true);
...
TEST_F(MPI_TCP_SENDRECV_TEST, st_mpi_tcp_tcpEschedFinishProcess)
{
     SetTcpMode(true);
...
TEST_F(MPI_TCP_SENDRECV_TEST, st_mpi_tcp_sendWork)
{
