...
TEST_F(SocketManagerTest, st_SocketManagerTest_LocalServer)
{
...
TEST_F(SocketManagerTest, st_SocketManagerTest_LocalClient)
{
    TlsStatus tlsStatus = TlsStatus::ENABLE;
    u32 ifnumVersion = 3;
    MOCKER(hrtRaGetInterfaceVersion)
...
TEST_F(SocketManagerTest, st_SocketManagerTest_GetStatus_SOCKET_ERROR)
{
    TlsStatus tlsStatus = TlsStatus::ENABLE;
    MOCKER(HcclNetDevGetTlsStatus)
    .stubs()
...
TEST_F(SocketManagerTest, st_NetDev_error)
{
    HcclResult ret;
...
TEST_F(SocketManagerTest, st_Socket_Abort)
{
    HcclResult ret;
...
TEST_F(SocketManagerTest, st_socket_listen_with_port)
{
    HcclResult ret;
