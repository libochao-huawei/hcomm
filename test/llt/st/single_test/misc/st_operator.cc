...
TEST_F(OperatorTest, stOperatorHcclCounterAdd)
{
    u64 counter = 0;
...
TEST_F(OperatorTest, stOperatorHcclCounterClear)
{
    u64 counter = 0;
    Stream stream(StreamType::STREAM_TYPE_OFFLINE);
...
// HcclCmp接口st用例
TEST_F(OperatorTest, stOperatorHcclCmp)
{
    s32 result = 0xff;
    Stream stream(StreamType::STREAM_TYPE_OFFLINE);
...
// HcclLogStr接口st用例
TEST_F(OperatorTest, stOperatorHcclLogStr)
{
...
TEST_F(OperatorTest, stOperatorHcclLogVariable)
{
    char str[] = "This is a test! ";
    u64 data1 = 1;
    u64 data2 = 2;
