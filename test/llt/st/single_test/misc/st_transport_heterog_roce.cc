...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_AllEschedAckCallback)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_RegisterEschedAckCallback)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_InitAllLinkVec)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogEventRoce> transport(new (nothrow) TransportHeterogEventRoce("test_collective", invalidIp, invalidIp, 18000, 0, transportResourceInfo));
    // unique_ptr<TransportHeterogEventRoce> transport(new (nothrow) TransportHeterogEventRoce("test_collective", 0, 1, 18000, 0, transportResourceInfo));
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_EraseTransportFromAllLinkVec)
{
    u64 transportPtr = 0;
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_White_List)
{
    HcclIpAddress invalidIp;
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_Init)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogEventRoce> transport(new (nothrow) TransportHeterogEventRoce("test_collective", invalidIp, invalidIp, 18000, 0, transportResourceInfo));
    // unique_ptr<TransportHeterogEventRoce> transport(new (nothrow) TransportHeterogEventRoce("test_collective", 0, 1, 18000, 0, transportResourceInfo));
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_Deinit)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_Send)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogEventRoce> transport(new (nothrow) TransportHeterogEventRoce("test_collective", invalidIp, invalidIp, 18000, 0, transportResourceInfo));
    // unique_ptr<TransportHeterogEventRoce> transport(new (nothrow) TransportHeterogEventRoce("test_collective", 0, 1, 18000, 0, transportResourceInfo));
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_Imrecv)
{
    HcclIpAddress invalidIp;
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogEventRoce_SendFlowControl)
{
    MOCKER_CPP(&TransportHeterogRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_SendFlowControl)
{
    MOCKER_CPP(&TransportHeterogRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogEventRoce_ParseTagRqes)
{
    MOCKER_CPP(&TransportHeterogEventRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_ParseTagRqes)
{
    MOCKER_CPP(&TransportHeterogRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogEventRoce_ParseDataRqes)
{
    MOCKER_CPP(&TransportHeterogRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_ParseDataRqes)
{
    MOCKER_CPP(&TransportHeterogRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_ParseDataSqes)
{
    MOCKER_CPP(&MrManager::ReleaseKey)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_PullRecvRequestStatus)
{
    HcclIpAddress invalidIp;
    TransportHeterogEventRoce transportEvent("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogEventRoce transportEvent("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_PullRecvRequestStatus_1)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transportEvent("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogRoce transportEvent("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_PullSendStatus)
{
    HcclIpAddress invalidIp;
    TransportHeterogEventRoce transportEvent("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogEventRoce transportEvent("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_PullRecvStatus)
{
    HcclIpAddress invalidIp;
    TransportHeterogEventRoce transportEvent("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogEventRoce transportEvent("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_UpdateStatus)
{
    HcclIpAddress invalidIp;
    TransportHeterogEventRoce transportEvent("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    // TransportHeterogEventRoce transportEvent("test_ta", 0, 1, 18000, 0, transportResourceInfo);
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_EschedAckCallback)
{
    MOCKER(TransportHeterogEventRoce::UpdateStatus)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_InitTagRecvWqe)
{
    MOCKER_CPP(&TransportHeterogRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportEventHeterogRoce_InitTagRecvWqe)
{
    MOCKER_CPP(&TransportHeterogRoce::IssueRecvWqe)
    .stubs()
    .with(any())
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_IssueRecvWqe)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_QpConnect)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogEventRoce_GetQpStatus)
{
    int qpStatus = 0;
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_hccd_TransportHeterogRoce_CreateSrq_success)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_FlushSendQueue)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_CreateCqAndQp)
{
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_PullSendOrRecvStatus)
{
    HcclIpAddress invalidIp;
    TransportHeterogRoce transportEvent("test_ta", invalidIp, invalidIp, 18000, 0, transportResourceInfo);
    MOCKER_CPP_VIRTUAL(transportEvent, &TransportHeterogRoce::PullSendStatus)
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogRoce_Wait)
{
    HcclIpAddress invalidIp;
    unique_ptr<TransportHeterogRoce> transport(new (nothrow) TransportHeterogRoce("test_collective", invalidIp, invalidIp, 18000, 0, transportResourceInfo));
    TransportHeterogRoce *transportHandle = transport.get();
...
TEST_F(MPI_TRANSPORT_HETEROG_ROCE_TEST, st_TransportHeterogEventRoce_Imrecv)
{
    HcclIpAddress invalidIp;
    TransData recvData;
    HcclMessageInfo msg;
