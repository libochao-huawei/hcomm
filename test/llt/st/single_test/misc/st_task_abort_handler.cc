...
#endif
TEST_F(TaskAbortHandlerTest, st_ProcessTaskAbortHandleCallback_stage2_success)
{
    uint32_t deviceLogicId = 0;
    rtDeviceTaskAbortStage stage = RT_DEVICE_TASK_ABORT_POST;
    int a = 8;
...
TEST_F(TaskAbortHandlerTest, st_ProcessTaskAbortHandleCallback_stage2_false)
{
    uint32_t deviceLogicId = 0;
    rtDeviceTaskAbortStage stage = RT_DEVICE_TASK_ABORT_POST;
    int a = 8;
