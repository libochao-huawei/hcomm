...
TEST_F(SwitchNicTest, st_hcclSwitchNic_test)
{
    hcclComm comm;
...
TEST_F(SwitchNicTest, st_HcclCommunicator_SwitchNicTimeout)
{
...
TEST_F(SwitchNicTest, st_HcclCommunicator_GetSwitchRanks)
{
    HcclResult ret = HCCL_SUCCESS;
    unique_ptr<HcclCommunicator> communicator(new (nothrow) HcclCommunicator());
...
TEST_F(SwitchNicTest, st_hcclCommAicpu_SwitchNic)
{
...
TEST_F(SwitchNicTest, st_hcclCommAicpu_SwitchNic_WaitHandleCommand)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
    AlgResourceResponse resourceResponse;
    resourceResponse.opTransportResponse.resize(COMM_LEVEL_RESERVED);
...
TEST_F(SwitchNicTest, st_hcclCommAicpu_SwitchNic_WaitResult)
{
    hccl::HcclCommAicpu *hcclCommAicpu = new hccl::HcclCommAicpu;
...
TEST_F(SwitchNicTest, st_ExecutorTracer_HandleSwitchNic)
{
