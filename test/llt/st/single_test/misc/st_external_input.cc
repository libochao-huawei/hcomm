...
TEST_F(ExternalInputTest, st_external_input_env_variables_params_intra_comm_type)
{
    u32 intraRoce = 0;
    HcclResult ret;
...
TEST_F(ExternalInputTest, st_external_input_env_variables_taskExceptionSwitch)
{
...
TEST_F(ExternalInputTest, st_external_input_env_variables_port)
{
    u32 baseport;
    HcclResult ret;
...
TEST_F(ExternalInputTest, st_external_input_env_variables_trafficClass)
{
...
TEST_F(ExternalInputTest, st_external_input_env_variables_serverLevel)
{
    u32 rdmaServerLevel;
    HcclResult ret;
    ret = InitEnvVarParam();
...
TEST_F(ExternalInputTest, st_external_input_env_variables_RdmaTimeOut)
{
    u32 rdmaTimeOut;
    HcclResult ret;
    ret = InitEnvVarParam();
...
TEST_F(ExternalInputTest, st_external_input_env_variables_RdmaRetryCnt)
{
    u32 rdmaRetryCnt;
    HcclResult ret;
    ret = InitEnvVarParam();
...
TEST_F(ExternalInputTest, st_external_input_env_variables_masterinfo)
{
    HcclResult ret;
    // masterIp error
    string masterIp = "1";
...
TEST_F(ExternalInputTest, st_external_input_env_variables_HcclSocketIfName)
{
...
//测试cclbufsize
TEST_F(ExternalInputTest, st_external_input_env_cclbufsize)
{
    u64 cclbufsize;
    HcclResult ret; 
...
TEST_F(ExternalInputTest, st_external_input_env_interHccs)
{
...
//测试HCCL_LOG_CONFIG
TEST_F(ExternalInputTest, st_external_hccl_log_config)
{
...
TEST_F(ExternalInputTest, st_external_input_env_retryparams)
{
    u32 maxcnt = 0;
    u32 holdtime = 0;
    u32 intervaltime = 0;
...
TEST_F(ExternalInputTest, st_external_input_env_hccl_algo)
{
    HcclResult ret;
    ret = InitEnvParam();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(ExternalInputTest, st_external_input_env_hccl_op_expansion_mode)
{
    HcclResult ret;
    ret = InitEnvVarParam();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(ExternalInputTest, st_external_input_env_hccl_deterministic)
{
    HcclResult ret;
    ret = InitEnvVarParam();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(ExternalInputTest, st_external_input_env_expansion_mode_hostts)
{
    ResetInitState();
...
TEST_F(ExternalInputTest, st_external_input_env_expansion_mode_host )
{
    HcclResult ret;
    ret = InitEnvVarParam();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(ExternalInputTest, st_external_input_env_rdma_high_perf_enable)
{
    HcclResult ret;
    ret = InitEnvVarParam();
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(ExternalInputTest, st_external_input_env_socket_port_range_null)
{
...
TEST_F(ExternalInputTest, st_external_input_env_socket_port_range)
{
...
TEST_F(ExternalInputTest, st_external_input_env_socket_port_range_310p)
{
    setenv("HCCL_HOST_SOCKET_PORT_RANGE", "60000,60001-60031", 1);
...
TEST_F(ExternalInputTest, st_external_input_env_HCCL_DEBUG_CONFIG_invalid)
{
...
TEST_F(ExternalInputTest, st_external_input_env_HCCL_DEBUG_CONFIG_invert)
{
    u64 config = 0;
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(ExternalInputTest, st_external_input_env_HCCL_DEBUG_CONFIG)
{
    u64 config = 0;
    HcclResult ret = HCCL_SUCCESS;
