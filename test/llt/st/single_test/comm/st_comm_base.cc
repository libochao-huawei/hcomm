...
TEST_F(CommInnerTest, st_destructor_D0)
{
...
TEST_F(CommInnerTest, st_gget_transport_by_rank_err)
{
    std::string rootInfo = "test_collective";
    IntraExchanger exchanger{};
    std::vector<RankInfo> para_vector(1);
...
TEST_F(CommInnerTest, st_get_rank_by_userrank)
{
...
TEST_F(CommInnerTest, st_get_userrank_by_rank)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommInnerTest, st_get_userrank_by_rank_with_err)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommInnerTest, st_SetTransportType)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommInnerTest, st_TransportInit)
{
...
TEST_F(CommInnerTest, st_AiCpuNotifyDataGet)
{
...
TEST_F(CommInnerTest, st_get_intra_rank_ipinfo)
{
    std::string rootInfo = "test_collective";
    IntraExchanger exchanger{};
...
TEST_F(CommInnerTest, st_create_dest_link_memorry_error)
{
...
TEST_F(CommInnerTest, st_PrepareDeInit_fail)
{
...
TEST_F(CommInnerTest, st_HeterogDeinit_fail)
{
    s32 ret = DlRaFunction::GetInstance().DlRaFunctionInit();
    EXPECT_EQ(ret, HCCL_SUCCESS);
    u32 port = 16666;
