...
TEST_F(CommP2PTest, st_CommP2P_init)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommP2PTest, st_CommP2P_init_err0)
{
    s32 ret = HCCL_SUCCESS;
    u32 ifnumVersion = 3;
    MOCKER(hrtRaGetInterfaceVersion)
...
TEST_F(CommP2PTest, st_CommP2P_init_err1)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommP2PTest, st_CommP2P_init_err2)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommP2PTest, st_CommP2P_init_err3)
{
    s32 ret = HCCL_SUCCESS;
    MOCKER(hrtRaGetInterfaceVersion)
    .expects(atMost(1))
