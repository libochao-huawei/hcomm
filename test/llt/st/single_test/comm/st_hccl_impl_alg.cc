...
#if 0
TEST_F(HcclImplAlgTest, st_ReduceComm)
{
...
#endif
TEST_F(HcclImplAlgTest, st_ReduceScatterComm)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTest, st_ReduceScatterMeshExecutor)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTest, st_ReduceScatterRingExecutor_HD)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTest, st_ReduceScatterRingExecutor_Ring)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTest, st_CollMultiRingAllReduceAndMultiRootScatter)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
