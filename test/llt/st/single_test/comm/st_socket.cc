...
TEST_F(SocketTest, St_SendAsync_When_ParamErrOrRaSocketErr_Expect_Error)
{
...
TEST_F(SocketTest, St_SendAsync_When_RaSocketSuccess_Expect_Success)
{
    NetDevContext devCtx;
    HcclSocket tempSocket(&devCtx, 16666);
    HcclResult ret;
...
TEST_F(SocketTest, St_RecvAsync_When_ParamErrOrRaSocketErr_Expect_Error)
{
    NetDevContext devCtx;
    HcclSocket tempSocket(&devCtx, 16666);
    HcclResult ret;
...
TEST_F(SocketTest, St_RecvAsync_When_RaSocketSuccess_Expect_Success)
{
    NetDevContext devCtx;
    HcclSocket tempSocket(&devCtx, 16666);
    HcclResult ret;
...
TEST_F(SocketTest, St_IsSupportAsync_When_RaSocketNotSupportAsync_Expect_ReturnFalse)
{
