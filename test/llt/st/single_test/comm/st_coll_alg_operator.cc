...
TEST_F(CollAlgOperatorTest, st_SupportRetryWithInplaceCheck_ptr_check)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollAlgOperatorTest, st_SupportRetryWithInplaceCheck_opType_check)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommParams params;
    RankTable_t rankTable;
...
TEST_F(CollAlgOperatorTest, st_SupportRetryWithInplaceCheck_retry_condition_check)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(CollAlgOperatorTest, st_HcclCommunicator_IsHcclOpInplace)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclWorkflowMode oldMode = GetWorkflowMode();
    ret = SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
...
TEST_F(CollAlgOperatorTest, st_HcclCommunicator_IsHcclOpInplace_alltoall)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclWorkflowMode oldMode = GetWorkflowMode();
    ret = SetWorkflowMode(HcclWorkflowMode::HCCL_WORKFLOW_MODE_OP_BASE);
