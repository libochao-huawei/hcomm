...
TEST_F(CommInnerTest, st_get_rank_by_userrank1)
{
...
TEST_F(CommInnerTest, st_get_socket_timeout_err_msg)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommInnerTest, st_get_userrank_by_rank1)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommInnerTest, st_get_userrank_by_rank_with_err1)
{
    s32 ret = HCCL_SUCCESS;
