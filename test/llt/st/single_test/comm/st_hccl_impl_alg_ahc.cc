...
// 910B AHC-Broke 执行流程
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllReduceAHCBrokeExecute910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
// 91093 AHC 执行流程
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllReduceAHCExecute91093)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllReduceAHCBrokeExecute91093)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
// 91093 null-AHC 执行流程
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllReduceNULLAHCExecute91093)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_AICPU_AHC_Default_91093)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
// 910B 不同拓扑 AHC 执行流程
TEST_F(HcclImplAlgTestAHCAllreduce, st_AHC_Mesh_910_93){
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
    DeviceMem outputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllGatherAHCExecuteSingleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllGatherAHCBrokeExecuteSingleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllGatherAHCExecuteDoubleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_AllGatherAHCBrokeExecuteDoubleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_ReduceScatterAHCExecuteSingleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_ReduceScatterAHCBrokeExecuteSingleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_ReduceScatterAHCExecuteDoubleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
...
TEST_F(HcclImplAlgTestAHCAllreduce, st_ReduceScatterAHCBrokeExecuteDoubleBuffer910B)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    u64 count = 1024;
