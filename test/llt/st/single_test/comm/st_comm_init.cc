...
TEST_F(CommInitTest, st_HcclCommInitRootInfoConfig_not_set_config_01)
{
...
TEST_F(CommInitTest, st_HcclCommInitRootInfoConfig_not_set_config_02)
{
    HcclRootInfo id;
    DevType deviceType = DevType::DEV_TYPE_910B;
    MOCKER(hrtGetDeviceType)
...
TEST_F(CommInitTest, st_HcclCommInitRootInfoConfig_by_config_file)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
    HcclRootInfo id;
...
TEST_F(CommInitTest, st_HcclCommInitRootInfoConfig_by_config_file_sl)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
    HcclRootInfo id;
...
TEST_F(CommInitTest, st_HcclCommInitRootInfoConfig_by_config_file_tc)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
    HcclRootInfo id;
...
TEST_F(CommInitTest, st_HcclCommInitRootInfoConfig_in_valiad_para)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
    HcclRootInfo id;
...
TEST_F(CommInitTest, st_HcclCommInitRootInfoConfig_in_boundary_value)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
    HcclRootInfo id;
...
TEST_F(CommInitTest, st_transport_ibverbs_createoneqp_not_set_config)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
...
TEST_F(CommInitTest, st_transport_ibverbs_createoneqp_by_config_file)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
    MachinePara machinePara;
...
TEST_F(CommInitTest, st_InitEnvConfig)
{
    setenv("HCCL_RDMA_TC", "120", 1);
    setenv("HCCL_RDMA_SL", "2", 1);
...
TEST_F(CommInitTest, st_device_CheckDeviceType_Error)
{
