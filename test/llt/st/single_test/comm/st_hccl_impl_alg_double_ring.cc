...
TEST_F(HcclImplAlgTestDoubleRing, st_CollReduceScatterFastDoubleRingFor91093Executor_Ring)
{
...
TEST_F(HcclImplAlgTestDoubleRing, st_CollReduceDoubleRingExecutor_Ring)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRing, st_CollReduceDoubleRingExecutor_Ring_level2)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRing, st_AllGatherDoubleRingExecutor_Ring_SuperPod)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRing, st_CollAllGatherDoubleRingExecutor_Ring)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096);
...
TEST_F(HcclImplAlgTestDoubleRing, st_SelectAlg)
{
    HcclResult ret = HCCL_SUCCESS;
...
TEST_F(HcclImplAlgTestDoubleRing, st_CollReduceScatterDoubleRingExecutor_UpdateOffsetBasedOnStrideCount)
{
    HcclResult ret = HCCL_SUCCESS;
    std::string tag = "test";
    DeviceMem inputMem = DeviceMem::alloc(4096 * 4);
