...
int (*ra_peer_socket_batch_connect_p)(struct socket_connect_info_t conn[], u32 num) = ra_peer_socket_batch_connect;
int (*ra_peer_socket_batch_close_p)(struct socket_close_info_t conn[], u32 num) = ra_peer_socket_batch_close;
int (*ra_peer_socket_listen_start_p)(struct socket_listen_info_t conn[], u32 num) = ra_peer_socket_listen_start;
int (*ra_peer_socket_listen_stop_p)(struct socket_listen_info_t conn[], u32 num) = ra_peer_socket_listen_stop;
int (*ra_peer_get_sockets_p)(u32 role, struct socket_info_t conn[], u32 num) = ra_peer_get_sockets;
...
int (*ra_hdc_socket_batch_connect_p)(struct socket_connect_info_t conn[], u32 num) = ra_hdc_socket_batch_connect;
int (*ra_hdc_socket_batch_close_p)(struct socket_close_info_t conn[], u32 num) = ra_hdc_socket_batch_close;
int (*ra_hdc_socket_listen_start_p)(struct socket_listen_info_t conn[], u32 num) = ra_hdc_socket_listen_start;
int (*ra_hdc_socket_listen_stop_p)(struct socket_listen_info_t conn[], u32 num) = ra_hdc_socket_listen_stop;
int (*ra_hdc_get_sockets_p)(u32 role, struct socket_info_t conn[], u32 num) = ra_hdc_get_sockets;
