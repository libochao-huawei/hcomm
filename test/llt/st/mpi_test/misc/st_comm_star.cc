...
TEST_F(CommStarTest, st_star_init_testdestructor_D0)
{
    s32 ret = 0;
...
TEST_F(CommStarTest, st_star_MakeClientInfo_test)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommStarTest, st_star_CreateInterLinks_test)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommStarTest, st_star_SetMachinePara_test)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommStarTest, st_transport_stop_test)
{
    s32 ret = HCCL_SUCCESS;
...
TEST_F(CommStarTest, st_transport_Resume_test)
{
    s32 ret = HCCL_SUCCESS;
    DispatcherPub *dispatcher;
    const std::unique_ptr<NotifyPool> notifyPool;
