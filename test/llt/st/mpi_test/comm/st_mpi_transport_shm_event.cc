...
TEST_F(TransportShmEventTest, st_TransportShmEvent_ExchangeIpcMesg)
{
...
#if 1
TEST_F(TransportShmEventTest, st_TransportShmEvent_ExchangePidMesg)
{
    MachinePara machine_para;
    std::chrono::milliseconds timeout = std::chrono::milliseconds(10000);
    HcclIpAddress invaildIp;
...
#if 1
TEST_F(TransportShmEventTest, st_TransportShmEvent_SocketSend)
{
    MachinePara machine_para;
    std::chrono::milliseconds timeout = std::chrono::milliseconds(10000);
    HcclIpAddress invaildIp;
...
#if 1
TEST_F(TransportShmEventTest, st_TransportShmEvent_PrepareConnect)
{
    MachinePara machine_para;
    std::chrono::milliseconds timeout = std::chrono::milliseconds(10000);
    HcclIpAddress invaildIp;
...
#if 1
TEST_F(TransportShmEventTest, st_TransportShmEvent_Init)
{
    MachinePara machine_para;
    std::chrono::milliseconds timeout = std::chrono::milliseconds(10000);
    HcclIpAddress invaildIp;
...
TEST_F(TransportShmEventTest, st_TransportShmEvent_Imrecv)
{
    MachinePara machine_para;
    std::chrono::milliseconds timeout = std::chrono::milliseconds(10000);
    HcclIpAddress invaildIp;
...
#if 1
TEST_F(TransportShmEventTest, st_TransportShmEvent_CheckShmMemRange)
{
    MachinePara machine_para;
    std::chrono::milliseconds timeout = std::chrono::milliseconds(10000);
    HcclIpAddress invaildIp;
