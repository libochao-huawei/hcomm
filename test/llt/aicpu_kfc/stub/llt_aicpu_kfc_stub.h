 ...
 ******************************************************************************
  文 件 名   : llt_aicpu_kfc_stub.h
  版 本 号   : 初稿
  作    者   : p00335137
  生成日期   : 2017年12月8日
  最近修改   :
  功能描述   : llt_aicpu_kfc_stub.cc 的私有头文件.
  函数列表   :
  修改历史   :
  1.日    期   : 2017年12月8日
    作    者   : p00335137
...
#ifndef __LLT_AICPU_KFC_STUB_H__
#define __LLT_AICPU_KFC_STUB_H__
...
#endif /* __LLT_AICPU_KFC_STUB_H__ */
