...
class MC2Trace_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MC2Trace_ST SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "MC2Trace_ST TearDown" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        std::cout << "MC2Trace_ST Test SetUP" << std::endl;
    }
    virtual void TearDown()
    {
        ResetMC2Context();
        GlobalMockObject::verify();
        std::cout << "MC2Trace_ST Test TearDown" << std::endl;
    }
};

TEST_F(MC2Trace_ST, Init_Error)
{
    g_isError = true;
...
TEST_F(MC2Trace_ST, Init)
{
    HcclResult ret = MC2TraceUtils::Init();
    EXPECT_EQ(ret, HCCL_SUCCESS);
}

TEST_F(MC2Trace_ST, InitV2)
{
