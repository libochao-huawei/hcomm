...
class MC2AicpuInterface_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MC2AicpuInterface_ST SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "MC2AicpuInterface_ST TearDown" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        MOCKER(hrtGetHccsPortNum)
            ...
            .will(returnValue(HCCL_SUCCESS));
        std::cout << "MC2AicpuInterface_ST Test SetUP" << std::endl;
    }
    virtual void TearDown()
    {
        ResetMC2Context();
        GlobalMockObject::verify();
        std::cout << "MC2AicpuInterface_ST Test TearDown" << std::endl;
    }
};

class MC2AicpuInterfaceV2_ST : public MC2AicpuInterface_ST {
protected:
    virtual void SetUp()
    {
        g_stubDevType = DevType::DEV_TYPE_910B;
        ...
        MOCKER(hrtGetHccsPortNum)
            ...
            .with(any(), outBound(portNum))
            .will(returnValue(HCCL_SUCCESS));
        std::cout << "MC2AicpuInterfaceV2_ST Test SetUP" << std::endl;
    }
};

TEST_F(MC2AicpuInterface_ST, RunAicpuKfcResInit_nullptr)
{
    EXPECT_EQ(HCCL_E_PARA, RunAicpuKfcResInit(nullptr));
}

TEST_F(MC2AicpuInterface_ST, RunAicpuKfcResInitV2_nullptr)
{
    EXPECT_EQ(HCCL_E_PARA, RunAicpuKfcResInitV2(nullptr));
}

TEST_F(MC2AicpuInterface_ST, RunAicpuKfcResInit_hcomUnEqual)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcResInit_ok)
{
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_argsNullptr)
{
    EXPECT_EQ(HCCL_E_PARA, RunAicpuRpcSrvLaunch(nullptr));
}

TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvGroupLaunch_argsNullptr)
{
    EXPECT_EQ(HCCL_E_PARA, RunAicpuRpcSrvGroupLaunch(nullptr));
}

TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_tilingDataNullptr)
{
    KFCTask kfcTask;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvGroupLaunch_tilingDataNullptr)
{
    KFCTask kfcTask;
    kfcTask.tilingData = 0;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_ctxNullptr)
{
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvGroupLaunch_ctxNullptr)
{
    HccCommResParamTask paramTask;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_debugModeOnlyCube)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    KFCResInitTask initTask;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvGroupLaunch_debugModeOnlyCube)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    KFCResInitTask initTask;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_debugModeWaitComm)
{
    // 模拟产生了异常cq
    ...
    KFCResInitTask initTask;
    memset_s(&initTask, sizeof(KFCResInitTask), 0, sizeof(KFCResInitTask));
    initTask.context = uint64_t(&paramTask);
    ...
    KFCTask kfcTask;
    memset_s(&kfcTask, sizeof(KFCTask), 0, sizeof(KFCTask));
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_debugModeTimeTaken)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
// 覆盖率用例
TEST_F(MC2AicpuInterface_ST, ut_GetMsgTypeString)
{
    AicpuComContext *ctx = AicpuGetComContext();
...
// 覆盖率用例
TEST_F(MC2AicpuInterface_ST, st_GetSendRecvOff1)
{
    HcclKFCTilingData tilingData = {0};
...
// 覆盖率用例
TEST_F(MC2AicpuInterface_ST, st_GetSendRecvOff2)
{
    HcclKFCTilingData tilingData = {0};
    tilingData.commAlg = 0;
    tilingData.turnNum = 1;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunchTestPrint)
{
    HccCommResParamTask paramTask;
    HcclKFCTilingData tilingData = {0};
    KFCTask kfcTask;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunchTestPrintHccl)
{
    HccCommResParamTask paramTask;
    HcclKFCTilingData tilingData = {0};
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunchTestNullArgs)
{
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunchTestNullDesc)
{
    ...
    void* desPtr = reinterpret_cast<void*>(&desc);
    HcclKFCTilingData tilingData = {0};
    tilingData.commType = HCCL_CMD_ALLGATHER;
    tilingData.dataType = HCCL_DATA_TYPE_FP16;
    tilingData.turnNum = 2;
    ...
    kfcTask.context = uint64_t(&paramTask);
    kfcTask.tilingData = uint64_t(&tilingData);
    void* arr[] = {desPtr, a, a, a, a, a, a, a, nullptr, nullptr, nullptr, nullptr, nullptr};
    EXPECT_EQ(1, RunAicpuKfcSrvLaunch(nullptr));
    free(a);
}

TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_Mc2api_Finalize)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_PreparePositionFail)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_Mc2api_Timeout)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_Mc2api_nullptr)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_Mc2api_debugModePrint)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_Mc2api_errorDataTypeOPTYPE)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_Mc2api_errorChipType)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunch_Mc2api_1)
{
    ...
    MOCKER(AicpuKfcProcess::AicpuRunRpcServerForMC2).stubs().will(returnValue(HCCL_SUCCESS));
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunch_Mc2api_2)
{
...
// 覆盖率用例
TEST_F(MC2AicpuInterface_ST, ReadApiValidMsg_1)
{
    HcclMsgForTest rMsg;
    HcclMsgForTest msg;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_Mc2api_debugModePrintBuff)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunch_Mc2api_5)
{
    MOCKER(AdprofCheckFeatureIsOn).stubs().will(returnValue(1));
    HccCommResParamTask paramTask;
    HcclCommParamDesc desc;
    ...
    MOCKER(AicpuKfcProcess::AicpuRunRpcServerForMC2V2).stubs().will(returnValue(HCCL_SUCCESS));
    ArgsInputApi curArgs = {inputDesc,  (void *)&paramTask, (void *)&paramTask, nullptr, &tilingData};
    void *args[sizeof(curArgs)/ sizeof(void *)];
    memcpy(args, &curArgs, sizeof(curArgs));
    EXPECT_EQ(0, RunAicpuKfcSrvLaunch(args));
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunch_Mc2api_6)
{
    StubHccCommRes commRes;
    HccCommResParamTask paramTask = commRes.StubHccCommResParamTask();
    AicpuKfcRpcServer::RpcMsgBody msgBody;
...
TEST_F(MC2AicpuInterface_ST, RunAicpuRpcSrvLaunch_RDMAFullmeshPostsend)
{
    char virremoteBuf[2 * 1024 * 1024];
    char virlocalBuf[2 * 1024 * 1024];
    std::vector<TransportDeviceNormalData> transDevIbverbsData{};
    transDevIbverbsData.resize(2);
    ibv_qp qp_info[2];
    MemDetails MemDetails_local;
    MemDetails_local.addr = reinterpret_cast<std::uintptr_t>(&virlocalBuf);
    MemDetails_local.size = 2 * 1024 * 1024;
    MemDetails_local.key = 1;
    MemDetails MemDetails_remote;
    MemDetails_remote.addr = reinterpret_cast<std::uintptr_t>(&virremoteBuf);
    MemDetails_remote.size = 2 * 1024 * 1024;
    MemDetails_remote.key = 1;

    transDevIbverbsData[0].localInputMem = MemDetails_local;
    transDevIbverbsData[0].localOutputMem = MemDetails_local;
    transDevIbverbsData[0].remoteInputMem = MemDetails_remote;
    transDevIbverbsData[0].remoteOutputMem = MemDetails_remote;
    HcclQpInfoV2 hcclQpInfoV2_local{};
    hcclQpInfoV2_local.dbIndex = 0;
    hcclQpInfoV2_local.sqIndex = 0;
    hcclQpInfoV2_local.qpPtr = reinterpret_cast<std::uintptr_t>(&qp_info[0]);
    transDevIbverbsData[0].qpInfo = hcclQpInfoV2_local;

    transDevIbverbsData[1].localInputMem = MemDetails_remote;
    transDevIbverbsData[1].localOutputMem = MemDetails_remote;
    transDevIbverbsData[1].remoteInputMem = MemDetails_local;
    transDevIbverbsData[1].remoteOutputMem = MemDetails_local;
    HcclQpInfoV2 hcclQpInfoV2_remote{};
    hcclQpInfoV2_remote.dbIndex = 0;
    hcclQpInfoV2_remote.sqIndex = 0;
    hcclQpInfoV2_remote.qpPtr = reinterpret_cast<std::uintptr_t>(&qp_info[1]);
    transDevIbverbsData[1].qpInfo = hcclQpInfoV2_remote;

    AicpuComContext *ctx = AicpuGetComContext();
    std::vector<TransportDeviceNormalData> transDevIbverbsData_temp{};
    ctx->ibversData.swap(transDevIbverbsData_temp);
    ctx->rankNum = 2;

    HccCommResParamTask paramTask;
    paramTask.rankNum = 2;
    paramTask.ibverbsData = reinterpret_cast<u64>(transDevIbverbsData.data());
    KFCResInitTask initTask;
    initTask.context = uint64_t(&paramTask);
    // Size不一致，应报错返回
    paramTask.ibverbsDataSize = 0;
    EXPECT_EQ(HCCL_E_PARA, InitIbversData(&paramTask, ctx));

    paramTask.ibverbsDataSize = transDevIbverbsData.size() * sizeof(TransportDeviceNormalData);
    EXPECT_EQ(HCCL_SUCCESS, InitIbversData(&paramTask, ctx));

    u32 remoteRankId = 0;
    hccl::Transport::Buffer remoteBuf1{&virremoteBuf, 0};
    hccl::Transport::Buffer localBuf1{&virlocalBuf, 0};
    std::vector<hccl::Transport::Buffer> remoteBuf{remoteBuf1};
    std::vector<hccl::Transport::Buffer> localBuf{localBuf1};
    MOCKER(stub_ibv_exp_post_send).stubs().will(returnValue(0));
    MOCKER(&AicpuDispatcher::LaunchTask).stubs().will(returnValue(0));
    MOCKER(&AicpuDispatcher::RdmaSend).stubs().will(returnValue(0));
    EXPECT_EQ(HCCL_SUCCESS, HcclAicpuUtils::PostSend(*ctx, remoteRankId, remoteBuf, localBuf, true));
    EXPECT_EQ(HCCL_SUCCESS, HcclAicpuUtils::PostSend(*ctx, remoteRankId, remoteBuf, localBuf, false));
    std::vector<TransportDeviceNormalData> transDevIbverbsData_temp1{};
    ctx->ibversData.swap(transDevIbverbsData_temp1);
}
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunch_Mc2api_8)
{
    MOCKER(AdprofCheckFeatureIsOn).stubs().will(returnValue(1));
...
TEST_F(MC2AicpuInterface_ST, RunAicpuKfcSrvLaunch_Mc2api_9)
{
...
TEST_F(MC2AicpuInterface_ST, PrintHcclMsgArea)
{
