...
class MC2AllToAll_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MC2AllToAll_ST SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "MC2AllToAll_ST TearDown" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        InitEnvParam();
        std::cout << "MC2AllToAll_ST Test SetUP" << std::endl;
    }
    virtual void TearDown()
    {
        ResetMC2Context();
        GlobalMockObject::verify();
        std::cout << "MC2AllToAll_ST Test TearDown" << std::endl;
    }
};
...
TEST_F(MC2AllToAll_ST, alltoall_mc2Api)
{
...
TEST_F(MC2AllToAll_ST, alltoall_mc2Api_repeat)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AllToAll_ST, alltoall_mc2Api_win)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AllToAll_ST, alltoall_win_repeat)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AllToAll_ST, alltoall_mc2Api_prepare_timeout)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AllToAll_ST, alltoall_mc2Api_finalize_timeout)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AllToAll_ST, alltoall_mc2Api_profiling)
{
...
TEST_F(MC2AllToAll_ST, alltoall_mc2_fine_granularity)
{
