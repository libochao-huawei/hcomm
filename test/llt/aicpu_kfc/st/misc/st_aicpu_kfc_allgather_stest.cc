...
class MC2Allgather_ST : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "MC2Allgather_ST SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "MC2Allgather_ST TearDown" << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        InitEnvParam();
        std::cout << "MC2Allgather_ST Test SetUP" << std::endl;
    }
    virtual void TearDown()
    {
        ResetMC2Context();
        GlobalMockObject::verify();
        std::cout << "MC2Allgather_ST Test TearDown" << std::endl;
    }
};
...
TEST_F(MC2Allgather_ST, allgather_fp16)
{
...
TEST_F(MC2Allgather_ST, allgather_bf16)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_fp16LargeData)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_doublering)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_chipTypeDc)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_hcclKfcTaskHcclOnlyExe)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_mc2Api)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_mc2Api_turn2)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_mc2Api_repeat)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2Allgather_ST, allgather_mc2Api_combine)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
