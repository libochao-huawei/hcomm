...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_normal)
{
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_retry_success_when_op_runing)
{
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_retry_when_op_end)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_retry_when_op_start)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
    ...
    .stubs()
    .with(any())
    .will(invoke(halSqCpQueryStub_1));
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_not_support_retry_for_inplace)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_not_support_retry_for_disable_retry)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_stop)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_stop_when_wait_stop_exec)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_stop_when_wait_retry)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_retry_launch_fail)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_retry_reset_sq_fail)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_init_opexec_status_fail)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_task_exec_fail)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_retry_when_sdma_taskexception)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, allreduce_fp16_retry_wait_stop_exec_timeout)
{
    dlog_setlevel(HCCL, DLOG_DEBUG, 1);
...
TEST_F(MC2AicpuRetry_ST, st_AicpuHcclProcess_function)
{
...
TEST_F(MC2AicpuRetry_ST, ut_InitProcess_BatchSendRecv_hcclCommAicpu)
{
...
TEST_F(MC2AicpuRetry_ST, st_WaitEndProcess_hcclCommAicpu)
{
    HcclResult ret = HCCL_SUCCESS;
    HcclCommAicpu comm;
...
TEST_F(MC2AicpuRetry_ST, allreduce_ns_stoplaunch)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AicpuRetry_ST, allreduce_ns_stopexec_clear)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AicpuRetry_ST, allreduce_ns_stopexec_clear_end)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
...
TEST_F(MC2AicpuRetry_ST, allreduce_ns_stopexec_clear_error)
{
    KFCResInitTask initTask;
    init_kfc_args(initTask);
    EXPECT_EQ(0, RunAicpuKfcResInit(&initTask));
