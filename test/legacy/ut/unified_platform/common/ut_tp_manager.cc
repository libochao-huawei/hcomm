...
TEST_F(TpManagerTest, Ut_CalcTaTimeout_EnvGreaterThanTp_ReturnsEnvValue)
{
    TpAttrInfo tpAttrInfo{};
    tpAttrInfo.tpAttr.at = 0;
    tpAttrInfo.tpAttr.retryTimesInit = 0;
...
TEST_F(TpManagerTest, Ut_CalcTaTimeout_TpGreaterThanEnv_AutoUpgrade)
{
    TpAttrInfo tpAttrInfo{};
    tpAttrInfo.tpAttr.at = 3;
    tpAttrInfo.tpAttr.retryTimesInit = 3;
...
TEST_F(TpManagerTest, Ut_CalcTaTimeout_EnvEqualToTp_ReturnsEnvValue)
{
    TpAttrInfo tpAttrInfo{};
    tpAttrInfo.tpAttr.at = 2;
    tpAttrInfo.tpAttr.retryTimesInit = 0;
