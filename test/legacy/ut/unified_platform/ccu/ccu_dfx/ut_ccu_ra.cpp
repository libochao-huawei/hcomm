...
TEST_F(CcuRaTest, test_get_ccu_xn_value)
{
    ...
    MOCKER(HrtRaCustomChannel).stubs().with(_, _, _).will(invoke(MockHrtRaCustomChannelXn));
...
{
    MOCKER(HrtGetDevicePhyIdByIndex).defaults().will(returnValue(static_cast<u32>(0)));
    MOCKER(HrtRaCustomChannel).stubs().with(_, _, _).will(invoke(MockHrtRaCustomChannelGSA));
...
{
    MOCKER(HrtGetDevicePhyIdByIndex).defaults().will(returnValue(static_cast<u32>(0)));
    MOCKER(HrtRaCustomChannel).stubs().with(_, _, _).will(invoke(MockHrtRaCustomChannelCKE));
...
{
    MOCKER(HrtGetDevicePhyIdByIndex).defaults().will(returnValue(static_cast<u32>(0)));
    MOCKER(HrtRaCustomChannel).stubs().with(_, _, _).will(invoke(MockHrtRaCustomChannelMissionContext));
...
{
    MOCKER(HrtGetDevicePhyIdByIndex).defaults().will(returnValue(static_cast<u32>(0)));
    MOCKER(HrtRaCustomChannel).stubs().with(_, _, _).will(invoke(MockHrtRaCustomChannelLoopContext));
