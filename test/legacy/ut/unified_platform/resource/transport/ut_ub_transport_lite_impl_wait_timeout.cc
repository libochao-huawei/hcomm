...
class UbTransportLiteImplWaitTimeoutTest : public testing::Test {
protected:
    static void SetUpTestCase()
    {
        std::cout << "UbTransportLiteImplWaitTimeoutTest tests set up." << std::endl;
    }

    static void TearDownTestCase()
    {
        std::cout << "UbTransportLiteImplWaitTimeoutTest tests tear down." << std::endl;
    }
    ...
    virtual void SetUp()
    {
        ...
        std::cout << "A Test case in UbTransportLiteImplWaitTimeoutTest SetUp" << std::endl;
    }

    virtual void TearDown()
    {
        std::cout << "A Test case in UbTransportLiteImplWaitTimeoutTest TearDown" << std::endl;
...
TEST_F(UbTransportLiteImplWaitTimeoutTest, Wait_WithSpecificTimeout_Expect_Success)
{
    ...
    u32 timeout = 1800;
    EXPECT_NO_THROW(ubTransportLite.Wait(0, stream, timeout));
}

TEST_F(UbTransportLiteImplWaitTimeoutTest, Wait_WithZeroTimeout_Expect_Success)
{
    std::vector<char> liteData = BuildUbTransportLiteUniqueId();
...
TEST_F(UbTransportLiteImplWaitTimeoutTest, MemTransportLite_Wait_WithDefaultTimeout_Expect_Success)
{
    std::vector<char> liteData = BuildUbTransportLiteUniqueId();
    ...
    EXPECT_NO_THROW(transportLite.Wait(0, stream));
}

TEST_F(UbTransportLiteImplWaitTimeoutTest, MemTransportLite_Wait_WithSpecificTimeout_Expect_Success)
{
    std::vector<char> liteData = BuildUbTransportLiteUniqueId();
    ...
    u32 timeout = 1800;
    EXPECT_NO_THROW(transportLite.Wait(0, stream, timeout));
}
