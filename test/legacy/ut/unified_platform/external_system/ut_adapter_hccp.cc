...
TEST_F(AdapterHccpTest, ut_HrtGetUboeFlagEnable_When_RaGetInterfaceVersion_SuccAndVersionEnough_Expect_SuccessAndFlagValid)
{
    u32 devPhyId = 1;
...
TEST_F(AdapterHccpTest, ut_HrtGetUboeFlagEnable_When_RaGetInterfaceVersionSucc_ButVersionNotEnough_Expect_SuccessButFlagInvalid)
{
    u32 devPhyId = 1;
...
TEST_F(AdapterHccpTest, ut_HrtGetUboeFlagEnable_When_RaGetInterfaceVersionFailed_Expect_Error)
{
    u32 devPhyId = 1;
    bool uboeFlagValid = false;
    MOCKER(RaGetInterfaceVersion).stubs().will(returnValue(-1));
