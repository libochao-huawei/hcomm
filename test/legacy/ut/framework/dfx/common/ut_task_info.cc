...
TEST_F(TaskInfoTest, test_get_op_info)
{
    ...
    EXPECT_EQ(taskInfo.GetOpInfo(), "commIndex[3], opType[OpType::Invalid], commId[], count[187650270809292], reduceType[ReduceOp::SUM], dataType[DataType::UINT64], opIndex[0], headOpCounterAddr[0], tailOpCounterAddr[0]");
    ...
    EXPECT_EQ(taskInfo.GetOpInfo(), "commIndex[3], opType[OpType::Invalid], commId[], count[187650270809292], reduceType[ReduceOp::SUM], src:[0x111122223333], dst:[0xaaaabbbbcccc], dataType[DataType::UINT64], opIndex[0], headOpCounterAddr[0], tailOpCounterAddr[0]");
