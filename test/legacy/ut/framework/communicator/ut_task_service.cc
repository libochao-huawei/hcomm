...
TEST_F(TaskServiceTest, test_task_run_data_size_zero) {
    // 测试 dataSize_ == 0 的情况
    ...
    // 分配内存
    void *deviceMem = malloc(1024);
    void *hostMem = malloc(1024);
...
TEST_F(TaskServiceTest, test_task_run_data_size_exceeds_host_mem) {
