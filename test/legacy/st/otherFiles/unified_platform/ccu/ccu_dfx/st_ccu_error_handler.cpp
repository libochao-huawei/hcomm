...
TEST_F(CcuErrorHandlerTest, test_error_info_when_rep_type_is_loc_post_sem)
{
    ...
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(_, _, _).will(returnValue(0xabcd));
...
TEST_F(CcuErrorHandlerTest, test_error_info_when_rep_type_is_rem_wait_sem)
{
    ...
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(_, _, eq(101)).will(returnValue(0xabcd));
...
TEST_F(CcuErrorHandlerTest, test_error_info_when_rep_type_is_rem_wait_group)
{
    ...
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(_, _, eq(100)).will(returnValue(0xabcd));
...
TEST_F(CcuErrorHandlerTest, test_gen_error_info_loop)
{
    ...
    uint16_t mask = 0x0010;  // mask
    MOCKER(CcuErrorHandler::GetCcuCKEValue).stubs().with(_, _, eq(0xa)).will(returnValue(0xabcd));
