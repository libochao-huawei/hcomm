...
TEST(ChannelManagerTest, TestChannelCreate_PFECreateFailed) {
    ...
    CfgBasePara para;
    para.dieId = 0;
    MOCKER_CPP(&PfeManager::PfeCreate).stubs().with(_).will(returnValue(CcuPfeInfo{false, 0, 0, 0}));
...
TEST(ChannelManagerTest, TestChannelCreate_ChannelCreateFailed) {
    ...
    MOCKER_CPP(&PfeManager::PfeCreate).stubs().with(_).will(returnValue(CcuPfeInfo{true, 0, 0, 0}));
...
TEST(ChannelManagerTest, TestChannelCreate_JettyCtxCreateFailed) {
    ...
    MOCKER_CPP(&LocalJettyContextManager::JettyCtxCreate).stubs().with(_).will(returnValue(INVILD_U8));
...
TEST(ChannelManagerTest, TestChannelCreate_Success) {
    ...
    MOCKER_CPP(&LocalJettyContextManager::JettyCtxCreate).stubs().with(_).will(returnValue(0));
