...
TEST_F(HcclIndependentOpRankGraphTest, Ut_HcclRankGraphGetLinks_When_CommIsNull_Expect_PtrError)
{
...
TEST_F(HcclIndependentOpRankGraphTest, Ut_A2CommGetRankGraph_When_RightPara_Expect_Success)
{
    ...
    ret = HcclRankGraphGetLayers(hcom_info.pComm.get(), &netlayers, &netLayersNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    ret = HcclRankGraphGetTopoTypeByLayer(hcom_info.pComm.get(), 0, &topoType);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(topoType, CommTopo::COMM_TOPO_1DMESH);
 
    ret = HcclRankGraphGetTopoTypeByLayer(hcom_info.pComm.get(), 1, &topoType);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(topoType, CommTopo::COMM_TOPO_CLOS);
 
    ret = HcclRankGraphGetRankSizeByLayer(hcom_info.pComm.get(), 0, &rankNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(rankNum, 4);
 
    ret = HcclRankGraphGetRankSizeByLayer(hcom_info.pComm.get(), 1, &rankNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(rankNum, 8);
 
    ret = HcclRankGraphGetRanksByLayer(hcom_info.pComm.get(), 0, &rankList, &rankNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(rankNum, 4);
    ...
    ret = HcclRankGraphGetRanksByLayer(hcom_info.pComm.get(), 1, &rankList, &rankNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(rankNum, 8);
    for (int i=0; i<rankNum; i++) {
    ...
    ret = HcclRankGraphGetInstSizeListByLayer(hcom_info.pComm.get(), 0, &rankSizeList, &rankListNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    ret = HcclRankGraphGetInstSizeListByLayer(hcom_info.pComm.get(), 1, &rankSizeList, &rankListNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
...
TEST_F(HcclIndependentOpRankGraphTest, Ut_A3CommGetRankGraph_When_RightPara_Expect_Success)
{
    ...
    ret = HcclRankGraphGetTopoTypeByLayer(hcom_info.pComm.get(), 2, &topoType);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(topoType, CommTopo::COMM_TOPO_CLOS);
    ...
    ret = HcclRankGraphGetRankSizeByLayer(hcom_info.pComm.get(), 2, &rankNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    ret = HcclRankGraphGetRanksByLayer(hcom_info.pComm.get(), 2, &rankList, &rankNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    ...
    ret = HcclRankGraphGetInstSizeListByLayer(hcom_info.pComm.get(), 2, &rankSizeList, &rankListNum);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(rankListNum, 1);
