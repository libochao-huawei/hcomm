...
static void SetUpTestCase()
    {
        std::cout << "RtsqInteract_UT SetUP" << std::endl;
    }
    static void TearDownTestCase()
    {
        std::cout << "RtsqInteract_UT TearDown" << std::endl;
    }
    virtual void SetUp()
    {
        std::cout << "RtsqInteract_UT Test SetUP" << std::endl;
    }
    virtual void TearDown()
    {
        GlobalMockObject::verify();
        std::cout << "RtsqInteract_UT Test TearDown" << std::endl;
    }
};
