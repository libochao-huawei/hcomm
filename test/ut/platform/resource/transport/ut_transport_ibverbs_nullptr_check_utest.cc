...
// Test GetRemoteMem with nullptr remotePtr
TEST_F(TransportIbverbsNullptrCheck_UT, GetRemoteMem_nullptr_remotePtr)
{
    ...
    // Should return HCCL_E_PTR due to nullptr check
