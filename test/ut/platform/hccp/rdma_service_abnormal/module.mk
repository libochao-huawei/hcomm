...
LOCAL_SRC_FILES += stub/cmd.c stub/init.c stub/device.c stub/mm.c stub/dl.c stub/ssl.c stub/drv_usr_cfg.c
...
LOCAL_C_INCLUDES+= 	$(LOCAL_PATH)/include	\
					...
					${SRC_DIR}/src/platform/hccp/common \
					$(ROCE_USER_SRC_DIR)

LOCAL_CFLAGS += -U_FORTIFY_SOURCE -O0 -DHNS_ROCE_LLT -g -DUSE_DISPATCH_EXPECT -DCA_CONFIG_LLT -DDEVICE_TLS_CONFIG -DCONFIG_SSL -DCONFIG_RDMA -DCONFIG_LLT
