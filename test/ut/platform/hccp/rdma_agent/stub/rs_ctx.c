...
int RsGetDevEidInfoList(unsigned int phyId, struct DevEidInfo infoList[], unsigned int startIndex,
    unsigned int count)
{
    return 0;
}
...
int RsCtxGetAuxInfo(struct RaRsDevInfo *devInfo, struct AuxInfoIn *infoIn,
