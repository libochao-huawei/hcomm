...
TransportHeterogStub::TransportHeterogStub()
    : TransportHeterog("12315", invalidIp, invalidIp, 0, 0, TransportResourceInfo())
{}
TransportShmEventStub::TransportShmEventStub()
    : TransportHeterog("12315", invalidIp, invalidIp, 0, 0, TransportResourceInfo())
{}
 ...
 * 在 test/ut/stub/CMakeLists.txt 中，该文件被显式排除在了 FRAMEWORK_HOST_SOURCES 之外，会导致生成的桩库 libhccl_llt.so
 * 中缺少该符号 所以需要在 UT 的桩代码文件 test/ut/stub/llt_hccl_stub.cc 中添加该函数的桩实现
 */
namespace hccl {
