...
void RdmaHandleManager::DeInitByPhyId(u32 devPhyId)
{
}

void RdmaHandleManager::RdmaDeInit(RdmaHandle rdmaHandle, HrtNetworkMode netMode)
{
}

void RdmaHandleManager::UbCtxDestroy(RdmaHandle handle)
{
}

void RdmaHandleManager::UbDestroyJfc(RdmaHandle handle, JfcHandle jfcHandle)
{
}
