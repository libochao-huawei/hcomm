...
TEST_F(TransportIbverbsTest, Ut_FillExchangeDataTotalSize_NotifyNumNonZero_AddsThreeMemMsg)
{
    std::chrono::milliseconds timeout{ 1 };
    MachinePara base{};
...
TEST_F(TransportIbverbsTest, Ut_FillExchangeDataTotalSize_MultiQpAndNotify_AddsMultiQpNotifyMemMsg)
{
    std::chrono::milliseconds timeout{ 1 };
    MachinePara mp{};
    mp.userMemEnable = false;
    ...
    const u64 extra = 3ULL * static_cast<u64>(sizeof(MemMsg)) + 3ULL * static_cast<u64>(sizeof(MemMsg));
