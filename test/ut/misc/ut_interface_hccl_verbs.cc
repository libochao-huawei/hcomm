...
{
    MOCKER(hrtGetDeviceRefresh).stubs().will(invoke(stub_hrtGetDeviceRefresh_success));
    MOCKER_CPP(&TypicalMrManager::RegisterMem).stubs().with(any()).will(invoke(stub_RegisterMem_success));
...
{
    MOCKER(hrtGetDeviceRefresh).stubs().will(invoke(stub_hrtGetDeviceRefresh_success));
    MOCKER_CPP(&TypicalQpManager::CreateCq).stubs().with(any()).will(invoke(stub_CreateCq_success));
...
TEST_F(InterfaceHcclVerbsTest, CreateQPWithCQWithAttr_Success)
{
    ...
    MOCKER_CPP(&TypicalQpManager::GetCqDepth).stubs().with(any(), any()).will(invoke(stub_GetCqDepth_success));
    MOCKER_CPP(&TypicalQpManager::CreateQpWithCQ).stubs().with(any(), any()).will(invoke(stub_CreateQpWithCQ_success));
...
{
    MOCKER(hrtGetDeviceRefresh).stubs().will(invoke(stub_hrtGetDeviceRefresh_success));
    MOCKER_CPP(&TypicalQpManager::GetCqHandle).stubs().with(any(), any()).will(invoke(stub_GetCqHandle_success));
...
{
    MOCKER(hrtGetDeviceRefresh).stubs().will(invoke(stub_hrtGetDeviceRefresh_success));
    MOCKER_CPP(&TypicalQpManager::GetQpHandleByQpn).stubs().with(any(), any()).will(invoke(stub_GetQpHandleByQpn_success));
