...
HcclResult stub_CreateTypicalCq_Success(RdmaHandle rdmaHandle, u32 cqDepth, u32 &cqn, void **cqHandle)
{
    cqn = g_nextCqn++;
...
HcclResult stub_CreateTypicalCq_Fail(RdmaHandle rdmaHandle, u32 cqDepth, u32 &cqn, void **cqHandle)
{
    return HCCL_E_INTERNAL;
}

HcclResult stub_DestroyTypicalCq_Success(RdmaHandle rdmaHandle, u32 cqn, void *cqHandle)
{
    return HCCL_SUCCESS;
}

HcclResult stub_DestroyTypicalCq_Fail(RdmaHandle rdmaHandle, u32 cqn, void *cqHandle)
{
    return HCCL_E_INTERNAL;
}

HcclResult stub_CreateQpWithCQConfig_Success(RdmaHandle rdmaHandle, s32 qpMode,
...
HcclResult stub_CreateQpWithCQConfig_Fail(RdmaHandle rdmaHandle, s32 qpMode,
    const QpConfigWithCQInfo& qpConfig, QpHandle &qpHandle, struct TypicalQp& qpInfo)
{
    return HCCL_E_INTERNAL;
}

HcclResult stub_HrtRaQpDestroyWithoutCQ_Success(QpHandle handle)
{
    return HCCL_SUCCESS;
}

HcclResult stub_HrtRaQpDestroyWithoutCQ_Fail(QpHandle handle)
{
    return HCCL_E_INTERNAL;
}
...
{
    opRsp->db.dbIndex = 0;
    opRsp->db.dbInfo = reinterpret_cast<void*>(0x1000);
    return HCCL_SUCCESS;
}
