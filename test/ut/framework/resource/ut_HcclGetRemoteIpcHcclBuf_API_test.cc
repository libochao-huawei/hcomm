...
TEST_F(HcclGetRemoteIpcHcclBufTest, ut_HcclGetRemoteIpcHcclBuf_When_OpResCtxNull_Expect_ReturnIsHCCL_E_PARA)
{
    MOCKER_CPP(&HcclCommunicator::GetCommResource, bool (HcclCommunicator::*)(void *&))
        .stubs()
        .with(any())
        .will(invoke(GetCommResourceStub));
