...
public:
    ...
    HcclResult OpRetryBase::Recv(std::shared_ptr<HcclSocket> socket, void *data, u64 totalSize) override {
        return HCCL_SUCCESS;
    }

    HcclResult OpRetryBase::Send(std::shared_ptr<HcclSocket> socket, void *data, u64 totalSize) override {
        return HCCL_SUCCESS;
    }
