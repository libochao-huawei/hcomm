...
TEST_F(OpretryLinkManageTest, Ut_GetLinkInfoByIdentifier_When_WithTag_Expect_Success)
{
    OpretryLinkManage &manager = OpretryLinkManage::GetInstance(0);
    std::string identifier = "test_identifier_4";
    std::string newTag = "test_tag_4";
    std::vector<u32> remoteRankList = {1, 2, 3};
    ...
    ret = manager.GetLinkInfoByIdentifier(identifier, newTag, resultList);
    EXPECT_EQ(ret, HCCL_SUCCESS);
    EXPECT_EQ(resultList, remoteRankList);
}
...
TEST_F(OpretryLinkManageTest, Ut_GetLinkInfoByIdentifier_When_WithoutTag_Expect_Success)
{
    ...
    std::string newTag1 = "test_tag_5_1";
    std::string newTag2 = "test_tag_5_2";
    std::vector<u32> remoteRankList1 = {1, 2, 3};
...
TEST_F(OpretryLinkManageTest, Ut_GetLinkInfoByIdentifier_When_IdentifierNotFound_Expect_Error)
{
    OpretryLinkManage &manager = OpretryLinkManage::GetInstance(0);
    ...
    HcclResult ret = manager.GetLinkInfoByIdentifier(identifier, newTag, remoteRankList);
    EXPECT_EQ(ret, HCCL_E_PARA);
}

TEST_F(OpretryLinkManageTest, Ut_GetLinkInfoByIdentifier_When_TagNotFound_Expect_Error)
{
    OpretryLinkManage &manager = OpretryLinkManage::GetInstance(0);
    std::string identifier = "test_identifier_6";
    std::string newTag = "test_tag_6";
    std::vector<u32> remoteRankList = {1, 2, 3};
    ...
    std::vector<u32> resultList;
    ret = manager.GetLinkInfoByIdentifier(identifier, "non_existent_tag", resultList);
    EXPECT_EQ(ret, HCCL_E_PARA);
}
...
{
    OpretryLinkManage &manager = OpretryLinkManage::GetInstance(0);
    std::string identifier = "test_identifier_7";
    std::string newTag = "test_tag_7";
    std::vector<u32> remoteRankList = {1, 2, 3};
...
{
    OpretryLinkManage &manager = OpretryLinkManage::GetInstance(0);
    std::string identifier = "test_identifier_8";
