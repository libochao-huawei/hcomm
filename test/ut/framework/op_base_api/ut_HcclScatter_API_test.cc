...
TEST_F(HcclScatterTest, Ut_HcclScatter_When_GroupModeAndRecvBufIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(rankNum * HCCL_COM_DATA_SIZE, 0, HCCL_COM_DATA_SIZE);
    u32 root = 0;
...
TEST_F(HcclScatterTest, Ut_HcclScatter_When_GroupModeAndCountIsZero_Expect_ReturnIsHCCL_SUCCESS)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(rankNum * HCCL_COM_DATA_SIZE, 0, 0);
    u32 root = 0;
    UT_COMM_CREATE_DEFAULT(comm);
    UT_STREAM_CREATE_DEFAULT(stream);
...
TEST_F(HcclScatterTest, Ut_HcclScatter_When_GroupModeAndCommIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(rankNum * HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE);
    u32 root = 0;
