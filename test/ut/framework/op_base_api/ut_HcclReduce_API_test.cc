...
TEST_F(HcclReduceTest, Ut_HcclReduce_When_GroupModeAndSendBufIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(0, HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE);
    u32 root = 0;
...
TEST_F(HcclReduceTest, Ut_HcclReduce_When_GroupModeAndCountIsZero_Expect_ReturnIsHCCL_SUCCESS)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(0, 0, 0);
    u32 root = 0;
...
TEST_F(HcclReduceTest, Ut_HcclReduce_When_GroupModeAndCommIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE);
    u32 root = 0;
