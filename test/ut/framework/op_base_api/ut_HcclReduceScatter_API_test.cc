...
TEST_F(HcclReduceScatterTest, Ut_HcclReduceScatter_When_GroupModeAndSendBufIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(0, HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE);
    UT_COMM_CREATE_DEFAULT(comm);
...
TEST_F(HcclReduceScatterTest, Ut_HcclReduceScatter_When_GroupModeAndCountIsZero_Expect_ReturnIsHCCL_SUCCESS)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(0, 0, 0);
    UT_COMM_CREATE_DEFAULT(comm);
...
TEST_F(HcclReduceScatterTest, Ut_HcclReduceScatter_When_GroupModeAndRecvBufIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(HCCL_COM_DATA_SIZE, 0, HCCL_COM_DATA_SIZE);
    UT_COMM_CREATE_DEFAULT(comm);
...
TEST_F(HcclReduceScatterTest, Ut_HcclReduceScatter_When_GroupModeAndCommIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    UT_SET_SENDBUF_RECVBUF_COUNT(HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE, HCCL_COM_DATA_SIZE);
    Ut_Device_Set(0);
