...
TEST_F(HcclAlltoAllVCTest, Ut_HcclAlltoAllVC_When_CommIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    Ut_Buf_Create(sendBuf, HCCL_COM_DATA_SIZE);
...
TEST_F(HcclAlltoAllVCTest, Ut_HcclAlltoAllVC_When_GroupModeAndSendCountMatrixIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    Ut_Buf_Create(sendBuf, HCCL_COM_DATA_SIZE);
    sendCountMatrix = nullptr;
...
TEST_F(HcclAlltoAllVCTest, Ut_HcclAlltoAllVC_When_GroupModeAndCommIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    Ut_Buf_Create(sendBuf, HCCL_COM_DATA_SIZE);
    sendCountMatrix = (u64*)sal_malloc(1 * sizeof(u64));
...
TEST_F(HcclAlltoAllVCTest, Ut_HcclAlltoAllVC_When_GroupModeAndStreamIsNull_Expect_ReturnIsHCCL_E_PTR)
{
    hcclGroupDepth = 1;
    Ut_Buf_Create(sendBuf, HCCL_COM_DATA_SIZE);
    sendCountMatrix = (u64*)sal_malloc(1 * sizeof(u64));
    ...
    HcclResult ret = HcclAlltoAllVCInner(sendBuf, sendCountMatrix, HCCL_DATA_TYPE_INT8, recvBuf, HCCL_DATA_TYPE_INT8, comm, nullptr);
    EXPECT_EQ(ret, HCCL_E_PTR);
