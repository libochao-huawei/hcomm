...
TEST_F(GetOpScratchMemSizeTest, Ut_GetOpScratchMemSize_When_BroadcastSmallData_Expect_Mem) {
    MOCKER_CPP(HcomGetCommByGroup).stubs().will(returnValue(HCCL_SUCCESS));  
...
TEST_F(GetOpScratchMemSizeTest, Ut_GetOpScratchMemSize_When_BroadcastLargeData_Expect_NoExm) {
    MOCKER_CPP(HcomGetCommByGroup).stubs().will(returnValue(HCCL_SUCCESS));
