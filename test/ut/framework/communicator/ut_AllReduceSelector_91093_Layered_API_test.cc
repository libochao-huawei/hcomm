...
constexpr u64 TEST_AR_COUNT = 2U * 1024U * 1024U;

AlgType BuildArAlgType(AlgTypeLevel1 level1)
{
    return AlgType(AlgTypeLevel0::ALG_LEVEL0_NP_SINGLE_RING, level1, AlgTypeLevel2::ALG_LEVEL2_RING);
}
...
class AllReduceSelector91093LayeredTest : public testing::Test {
public:
    void SetUp() override
    {
...
TEST_F(AllReduceSelector91093LayeredTest, Ut_SelectAlgfor91093_When_OxcLayeredReadyAndOrdinaryRing_Expect_LayeredExecutor)
{
    EXPECT_EQ(Select91093(true, true, BuildArAlgType(AlgTypeLevel1::ALG_LEVEL1_RING)),
        "AllReduceRingLayeredExecutor");
}

TEST_F(AllReduceSelector91093LayeredTest, Ut_SelectAlgfor91093_When_NonOxcOrdinaryRing_Expect_OriginalRingExecutor)
{
    EXPECT_EQ(Select91093(false, true, BuildArAlgType(AlgTypeLevel1::ALG_LEVEL1_RING)),
        "AllReduceRingFor91093Executor");
}

TEST_F(AllReduceSelector91093LayeredTest, Ut_SelectAlgfor91093_When_LayeredPlanesMissing_Expect_OriginalRingExecutor)
{
    EXPECT_EQ(Select91093(true, false, BuildArAlgType(AlgTypeLevel1::ALG_LEVEL1_RING)),
        "AllReduceRingFor91093Executor");
}

TEST_F(AllReduceSelector91093LayeredTest, Ut_SelectAlgfor91093_When_UnsupportedLevel1_Expect_OriginalRingExecutor)
{
    EXPECT_EQ(Select91093(true, true, BuildWholeRingAlgType()), "AllReduceRingFor91093Executor");
}

TEST_F(AllReduceSelector91093LayeredTest, Ut_SelectAlgfor91093_When_DoubleRingCandidate_Expect_OriginalExecutor)
{
    EXPECT_EQ(Select91093(true, true, BuildArAlgType(AlgTypeLevel1::ALG_LEVEL1_RING), TopoType::TOPO_TYPE_NP_DOUBLE_RING),
