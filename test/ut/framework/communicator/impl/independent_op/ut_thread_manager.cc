...
public:
    void SetUp() override {
        ...
        MockManagerCallbacks(callbacks);
        std::unique_ptr<ThreadMgr> threadManager = std::make_unique<ThreadMgr>(1, 1, "test", nullptr, callbacks);
...
void MockManagerCallbacks(ManagerCallbacks& callbacks) {
