...
TEST_F(UtAicpuTsHcommThreadRegisterDfx, Ut_HcommThreadRegisterDfx_When_DfxAllDisabled_Expect_ReturnHCCL_SUCCESS)
{
    ...
    res = HcclDfxRegOpInfoByCommId(nullptr, nullptr);
    EXPECT_EQ(res, HCCL_SUCCESS);
}
