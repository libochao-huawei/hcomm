...
TEST_F(UtAicpuTsHcommBatchTransfer, Ut_HcommBatchTransfer_When_thread_IsNull_Expect_PtrError)
{
    ThreadHandle thread = nullptr;
    ChannelHandle channel = reinterpret_cast<ChannelHandle>(0x1000);
    HcommBatchTransferDesc * transferDescs = reinterpret_cast<HcommBatchTransferDesc *>(0x2000);
...
{
    ThreadHandle thread = reinterpret_cast<ChannelHandle>(0x1000);
    ChannelHandle channel = nullptr;
    HcommBatchTransferDesc * transferDescs = reinterpret_cast<HcommBatchTransferDesc *>(021000);
    uint32_t transferDescNum = 1;
...
{
    ThreadHandle thread = reinterpret_cast<ChannelHandle>(0x1000);
    ChannelHandle channel = reinterpret_cast<ChannelHandle>(0x2000);
...
TEST_F(UtAicpuTsHcommBatchTransfer, Ut_HcommBatchTransfer_When_Write_Expect_Success)
{
    ...
    vector<HcommBatchTransferDesc> transferDescs;
