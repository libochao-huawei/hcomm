...
TEST_F(UtAicpuTsHcommBatchTransferOnThread, Ut_HcommBatchTransferOnThread_When_ReduceWrite_Expect_Success)
{
    uint32_t transferDescNum = 4;
    std::vector<HcommBatchTransferDesc> transferDescs;
    HcommBatchTransferDesc tmpTransferDesc;
...
TEST_F(UtAicpuTsHcommBatchTransferOnThread, Ut_HcommBatchTransferOnThread_When_ReduceRead_Expect_Success)
{
    uint32_t transferDescNum = 4;
    std::vector<HcommBatchTransferDesc> transferDescs;
    HcommBatchTransferDesc tmpTransferDesc;
