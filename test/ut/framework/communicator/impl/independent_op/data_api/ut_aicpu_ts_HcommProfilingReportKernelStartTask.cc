...
TEST_F(UtAicpuTsHcommProfilingReportKernelStartTask,
    Ut_HcommProfilingReportKernelStartTask_When_DfxAllDisabled_Expect_ReturnHCCL_SUCCESS)
{
    ...
    res = HcommProfilingReportKernelStartTask(0, nullptr);
