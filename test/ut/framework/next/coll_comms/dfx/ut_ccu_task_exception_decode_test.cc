...
std::string FormatPanicLogWithOps(DevType deviceType, const uint8_t* panicLog)
{
...
TEST_F(CcuTaskExceptionDecodeTest, Ut_PrintCcumDfxInfoV2_WhenDeviceTypeIs910B_ExpectReadableString)
{
    ...
    info->valid_bits = 0x7FFU;
    info->ccum_sqe_recv_cnt = 21;
    info->ccum_sqe_send_cnt = 22;
    info->ccum_mission_dfx = 23;
    info->ccum_tif_sqe_cnt = 24;
    info->ccum_tif_cqe_cnt = 25;
    info->ccum_cif_sqe_cnt = 26;
    info->ccum_cif_cqe_cnt = 27;
    info->ccum_sqe_drop_cnt = 28;
    info->ccum_sqe_addr_len_err_drop_cnt = 29;
    info->lqc_ccu_sec_reg0 = 1;
    info->ccum_mcm_dfx = 30;
...
TEST_F(CcuTaskExceptionDecodeTest, Ut_PrintCcumDfxInfoV2_WhenFieldInvalid_ExpectInvalidMarkerWithoutRawValue)
{
    ...
    std::memset(panicLog, 0, sizeof(panicLog));
    TestCcumDfxInfoV2* info = reinterpret_cast<TestCcumDfxInfoV2*>(panicLog);
    info->bs.sqe_recv_cnt = 1;
    info->bs.mission_dfx = 1;
    info->bs.tif_sqe_cnt = 1;
    info->bs.tif_cqe_cnt = 1;
    info->bs.cif_sqe_cnt = 1;
    info->bs.cif_cqe_cnt = 1;
    info->bs.sqe_drop_cnt = 1;
    info->bs.sqe_err_drop_cnt = 1;
    info->bs.sec_reg0 = 1;
    info->bs.mcm_dfx = 1;
    info->ccum_sqe_recv_cnt = 31;
    info->ccum_sqe_send_cnt = 222;
    info->ccum_mission_dfx = 33;
    info->ccum_tif_sqe_cnt = 34;
    info->ccum_tif_cqe_cnt = 35;
    info->ccum_cif_sqe_cnt = 36;
    info->ccum_cif_cqe_cnt = 37;
    info->ccum_sqe_drop_cnt = 38;
    info->ccum_sqe_addr_len_err_drop_cnt = 39;
    info->lqc_ccu_sec_reg0 = 1;
    info->ccum_mcm_dfx = 40;
