...
static_assert(
    sizeof(TestCcumDfxInfoV2) == 132, "TestCcumDfxInfoV2 size drifted; sync mirror with production ccumDfxInfoV2");
static_assert(
    MAX_CCU_EXCEPTION_INFO_SIZE == 128, "panicLog ABI changed; re-evaluate V2 OOB risk before relaxing this tripwire");
