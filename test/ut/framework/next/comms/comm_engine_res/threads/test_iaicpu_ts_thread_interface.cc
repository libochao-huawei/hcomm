 ...
 * 验证：未初始化时返回错误码
 */
TEST_F(TestIAicpuTsThread, Ut_IAicpuTsThread_GetStreamLitePtr_When_NotInited_Expect_Return_Para_Error)
{
    IAicpuTsThread aicpuThread;
    void *streamLitePtr = nullptr;
 ...
 * 验证：传入空指针时返回错误码
 */
TEST_F(TestIAicpuTsThread, Ut_IAicpuTsThread_GetStreamLitePtr_When_NullPtr_Expect_Return_Para_Error)
{
    IAicpuTsThread aicpuThread;
    aicpuThread.StreamLiteInit(1, 2, 3, 4);
 ...
 * 验证：未初始化时返回错误码
 */
TEST_F(TestIAicpuTsThread, Ut_IAicpuTsThread_GetSqId_When_NotInited_Expect_Return_Para_Error)
{
    IAicpuTsThread aicpuThread;
    uint32_t sqId = 0;
