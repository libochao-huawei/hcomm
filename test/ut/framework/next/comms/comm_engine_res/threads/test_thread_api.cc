...
TEST_F(TestHcclThread, Ut_HcclThreadResGetInfo_When_commNull_Return_HCCL_E_NOT_FOUND)
{
    HcclResult ret = HcclThreadResGetInfo(nullptr, thread, ThreadResType::THREAD_RES_TYPE_STREAM, sizeof(ThreadResTypeStream), &stream);
