...
TEST_F(RdmaConnLiteTest, Ut_When_SqContext_Expect_Valid)
{
    ...
    EXPECT_EQ(connLite.sqContext.qpn, 1);
    EXPECT_EQ(connLite.sqContext.sqVa, 0x10000);
    EXPECT_EQ(connLite.sqContext.wqeSize, 64);
    EXPECT_EQ(connLite.sqContext.depth, 128);
    EXPECT_EQ(connLite.sqContext.headAddr, 0x20000);
    EXPECT_EQ(connLite.sqContext.tailAddr, 0x20008);
    EXPECT_EQ(connLite.sqContext.sl, 0);
    EXPECT_EQ(connLite.sqContext.dbVa, 0x30000);
...
TEST_F(RdmaConnLiteTest, Ut_When_CqContext_Expect_Valid)
{
    ...
    EXPECT_EQ(connLite.cqContext.cqn, 2);
    EXPECT_EQ(connLite.cqContext.cqVa, 0x40000);
    EXPECT_EQ(connLite.cqContext.cqeSize, 32);
    EXPECT_EQ(connLite.cqContext.cqDepth, 256);
    EXPECT_EQ(connLite.cqContext.headAddr, 0x50000);
    EXPECT_EQ(connLite.cqContext.tailAddr, 0x50008);
    EXPECT_EQ(connLite.cqContext.dbVa, 0x60000);
...
TEST_F(RdmaConnLiteTest, Ut_When_EmptyUniqueId_Expect_DefaultValues)
{
    ...
    EXPECT_EQ(connLite.dmaMode_, 0);
    EXPECT_EQ(connLite.sqContext.qpn, 0);
    EXPECT_EQ(connLite.cqContext.cqn, 0);
