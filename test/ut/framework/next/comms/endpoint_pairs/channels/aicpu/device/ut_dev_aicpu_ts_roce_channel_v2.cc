...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_Construct_Expect_Success)
{
    ...
    DevAicpuTsRoceChannelV2 channelLite(uniqueId_);
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_NotifyNum_Expect_Correct)
{
    ...
    EXPECT_EQ(channelLite.notifyNum_, NOTIFY_NUM);
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_BufferNum_Expect_Correct)
{
    ...
    EXPECT_EQ(channelLite.bufferNum_, BUFFER_NUM);
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_ConnNum_Expect_Correct)
{
    ...
    EXPECT_EQ(channelLite.connNum_, CONN_NUM);
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_LocalNotifies_Expect_NotEmpty)
{
    ...
    EXPECT_EQ(channelLite.localNotifies_.size(), static_cast<size_t>(NOTIFY_NUM));
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_RemoteNotifies_Expect_NotEmpty)
{
    ...
    EXPECT_EQ(channelLite.remoteNotifies_.size(), static_cast<size_t>(NOTIFY_NUM));
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_LocBufferVec_Expect_NotEmpty)
{
    ...
    EXPECT_EQ(channelLite.locBufferVec_.size(), static_cast<size_t>(BUFFER_NUM));
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_RmtBufferVec_Expect_NotEmpty)
{
    ...
    EXPECT_EQ(channelLite.rmtBufferVec_.size(), static_cast<size_t>(BUFFER_NUM));
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_ConnVec_Expect_NotEmpty)
{
    ...
    EXPECT_EQ(channelLite.connVec_.size(), static_cast<size_t>(CONN_NUM));
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_ConnUniqueIdVec_Expect_NotEmpty)
{
    ...
    EXPECT_EQ(channelLite.connUniqueIdVec_.size(), static_cast<size_t>(CONN_NUM));
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_LocalNotifyValues_Expect_Correct)
{
    ...
    ASSERT_EQ(channelLite.localNotifies_.size(), static_cast<size_t>(NOTIFY_NUM));
    for (u32 i = 0; i < NOTIFY_NUM; i++) {
        EXPECT_EQ(channelLite.localNotifies_[i]->GetId(), i + 1);
        EXPECT_EQ(channelLite.localNotifies_[i]->GetDevPhyId(), i + 10);
    }
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_RemoteNotifyValues_Expect_Correct)
{
    ...
    ASSERT_EQ(channelLite.remoteNotifies_.size(), static_cast<size_t>(NOTIFY_NUM));
    for (u32 i = 0; i < NOTIFY_NUM; i++) {
        EXPECT_EQ(channelLite.remoteNotifies_[i].GetAddr(), 0x2000 + i * 0x100);
        EXPECT_EQ(channelLite.remoteNotifies_[i].GetSize(), 0x100u);
        EXPECT_EQ(channelLite.remoteNotifies_[i].GetRkey(), 0x200 + i);
    }
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_NotifyValueBufferValues_Expect_Correct)
{
    ...
    ASSERT_NE(channelLite.notifyValueBuffer_, nullptr);
    EXPECT_EQ(channelLite.notifyValueBuffer_->GetAddr(), 0x3000u);
    EXPECT_EQ(channelLite.notifyValueBuffer_->GetSize(), 0x200u);
    EXPECT_EQ(channelLite.notifyValueBuffer_->GetLkey(), 0x300u);
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_LocBufferValues_Expect_Correct)
{
    ...
    ASSERT_EQ(channelLite.locBufferVec_.size(), static_cast<size_t>(BUFFER_NUM));
    for (u32 i = 0; i < BUFFER_NUM; i++) {
        EXPECT_EQ(channelLite.locBufferVec_[i].GetAddr(), 0x4000 + i * 0x200);
        EXPECT_EQ(channelLite.locBufferVec_[i].GetSize(), 0x200u);
        EXPECT_EQ(channelLite.locBufferVec_[i].GetLkey(), 0x400 + i);
    }
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_RmtBufferValues_Expect_Correct)
{
    ...
    ASSERT_EQ(channelLite.rmtBufferVec_.size(), static_cast<size_t>(BUFFER_NUM));
    for (u32 i = 0; i < BUFFER_NUM; i++) {
        EXPECT_EQ(channelLite.rmtBufferVec_[i].GetAddr(), 0x5000 + i * 0x200);
        EXPECT_EQ(channelLite.rmtBufferVec_[i].GetSize(), 0x200u);
        EXPECT_EQ(channelLite.rmtBufferVec_[i].GetRkey(), 0x600 + i);
    }
...
TEST_F(DevAicpuTsRoceChannelV2Test, Ut_When_ConnVecValues_Expect_Correct)
{
    ...
    ASSERT_EQ(channelLite.connVec_.size(), static_cast<size_t>(CONN_NUM));
    for (u32 i = 0; i < CONN_NUM; i++) {
        EXPECT_NE(channelLite.connVec_[i], nullptr);
        EXPECT_EQ(channelLite.connVec_[i]->dmaMode_, 0u);
        EXPECT_EQ(channelLite.connVec_[i]->sqContext.qpn, 1u + i);
        EXPECT_EQ(channelLite.connVec_[i]->cqContext.cqn, 2u + i);
    }
