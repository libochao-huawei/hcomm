...
protected:
    ...
    virtual void SetUp()
    {
        ...
        MOCKER(HrtDevMemAlignWithPage).stubs().will(invoke(StubHrtDevMemAlignWithPage));
        MOCKER(HrtIpcSetMemoryName).stubs().will(invoke(StubHrtIpcSetMemoryName));
        MOCKER(HrtIpcDestroyMemoryName).stubs().will(invoke(StubHrtIpcDestroyMemoryName));
        MOCKER(HrtDeviceGetBareTgid).stubs().will(invoke(StubHrtDeviceGetBareTgid));
