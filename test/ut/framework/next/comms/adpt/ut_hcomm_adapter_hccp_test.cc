...
TEST_F(HcommAdapterHccpTest, ut_HccpGetUboeFlagEnable_When_VersionEnough_Expect_SuccessAndFlagValid)
{
    u32 devPhyId = 1;
...
TEST_F(HcommAdapterHccpTest, ut_HccpGetUboeFlagEnable_When_VersionNotEnough_Expect_SuccessButFlagInvalid)
{
    u32 devPhyId = 1;
