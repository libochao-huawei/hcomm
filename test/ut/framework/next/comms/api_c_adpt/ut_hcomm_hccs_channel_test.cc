...
public:
    void SetUp() override {
        ...
        MOCKER_CPP(&hccl::HcclSocket::Send, HcclResult(hccl::HcclSocket::*)(const void *, u64)).stubs().will(returnValue(HCCL_SUCCESS));
        MOCKER_CPP(&hccl::HcclSocket::Recv, HcclResult(hccl::HcclSocket::*)(void *, u32, u32)).stubs().will(returnValue(HCCL_SUCCESS));
