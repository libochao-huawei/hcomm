...
protected:
    ...
    HcclResult CreateUbMemEndpoint(const std::string& ip, void** endpointHandle)
    {
...
TEST_F(AivUbMemEndpointTest, Ut_When_Register_Memory_NORMAL_Expect_Return_SUCCESS)
{
    ...
    HcclResult ret = CreateUbMemEndpoint("1.0.0.0", &endpointHandle);
...
TEST_F(AivUbMemEndpointTest, Ut_When_Unregister_Wrong_Handle_Expect_Return_Error)
{
    ...
    HcclResult ret = CreateUbMemEndpoint("1.0.0.0", &endpointHandle1);
    EXPECT_EQ(ret, HCCL_SUCCESS);
