...
TEST_F(AicpuTsRoceRegedMemMgrTest, Ut_RegisterMemory_WithNetDev_MockLocalRdmaInit_ThenAgain_Returns_AGAIN)
{
    ...
    AicpuTsRoceRegedMemMgr mgr(reinterpret_cast<HcclNetDev>(&netCtx));
    HcommMem mem{};
    ...
    void *h2 = nullptr;
    EXPECT_EQ(mgr.RegisterMemory(mem, "t", &h2), HCCL_E_AGAIN);
}
