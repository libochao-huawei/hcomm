...
{
    if (error_code == "EI0013" && value.size() >= 6) {
        printf("Execution_Error_ROCE_CQE(EI0013): An error CQE occurred during operator execution. Local information: server %s, "
            "device ID %s, device IP %s. Peer information: server %s, device ID %s, device IP %s.\n",
            value[0].c_str(), value[1].c_str(), value[2].c_str(),
            value[3].c_str(), value[4].c_str(), value[5].c_str());
