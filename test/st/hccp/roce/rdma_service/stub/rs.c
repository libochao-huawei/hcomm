...
struct RsConnCb {
    ...
    struct RsListHead listen_list;
    struct RsListHead serverAcceptList;
    struct RsListHead server_conn_list;
    struct RsListHead client_conn_list;
    struct RsListHead white_list;
};
...
// void RsDev2conncb(struct timeval *end_time, struct timeval *start_time, float *msec)
// {
