...
extern int ra_ctx_prepare_qp_create(struct qp_create_attr *qpAttr, struct ctx_qp_attr *ctx_qp_attr);extern int qp_query_batch_param_check(void *qp_handle[], unsigned int *num, unsigned int phyId, unsigned int ids[]);
...
void tc_ra_rs_ctx_qp_unbind()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_unbind_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_unbind_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_qp_unbind_data),
...
void tc_ra_rs_ctx_qp_destroy()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_destroy_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_destroy_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_qp_destroy_data),
...
void tc_ra_rs_ctx_init()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_init_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_init_data));

    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_init_data),
...
void tc_ra_rs_ctx_deinit()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_deinit_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_deinit_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_deinit_data),
...
void tc_ra_rs_lmem_reg()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_lmem_reg_info_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_lmem_reg_info_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_lmem_reg_info_data),
...
void tc_ra_rs_lmem_unreg()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_lmem_unreg_info_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_lmem_unreg_info_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_lmem_unreg_info_data),
...
void tc_ra_rs_rmem_import()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_rmem_import_info_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_rmem_import_info_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_rmem_import_info_data),
...
void tc_ra_rs_rmem_unimport()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_rmem_unimport_info_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_rmem_unimport_info_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_rmem_unimport_info_data),
...
void tc_ra_rs_ctx_cq_create()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_cq_create_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_cq_create_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_cq_create_data),
...
void tc_ra_rs_ctx_cq_destroy()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_cq_destroy_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_cq_destroy_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_cq_destroy_data),
...
void tc_ra_rs_ctx_qp_create()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_create_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_create_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_qp_create_data),
...
void tc_ra_rs_ctx_qp_import()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_import_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_import_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_qp_import_data),
...
void tc_ra_rs_ctx_qp_unimport()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_unimport_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_unimport_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_qp_unimport_data),
...
void tc_ra_rs_ctx_qp_bind()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_bind_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_qp_bind_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_qp_bind_data),
...
void tc_ra_rs_ctx_batch_send_wr()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_batch_send_wr_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_batch_send_wr_data));

    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_batch_send_wr_data),
...
void tc_ra_rs_ctx_update_ci()
{
    ...
    char* in_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_update_ci_data));
    char* out_buf = calloc(1, sizeof(struct MsgHead) + sizeof(union op_ctx_update_ci_data));

    data_in.tx_data.phy_id = 0;
    data_in.tx_data.dev_index = 0;
    memcpy_s(in_buf + sizeof(struct MsgHead), sizeof(union op_ctx_update_ci_data),
...
void tc_ra_ctx_qp_destroy_batch_async()
{
    ...
    // num > HCCP_MAX_QP_DESTROY_BATCH_NUM
...
void tc_qp_destroy_batch_param_check()
{
    ...
    // 测试用例2: qp_handle为NULL
    qp_handle[0] = NULL;
    ret = qp_destroy_batch_param_check(&ctx_handle, qp_handle, ids, &num);
    EXPECT_INT_EQ(-EINVAL, ret);

    // 测试用例3: ctx_handle为NULL
...
void tc_ra_hdc_ctx_qp_destroy_batch_async()
{
    ...
    // qp_destroy_batch_param_check fail
    ...
    // RaHdcSendMsgAsync success
    mocker(RaHdcSendMsgAsync, 1, 0);
    ret = ra_hdc_ctx_qp_destroy_batch_async(&ctx_handle, qp_handle, &num, &req_handle);
    EXPECT_INT_EQ(0, ret);
    mocker_clean();

    // ra_hdc_async_handle_qp_destroy_batch test
    req_handle->recvBuf = &recv_buf;
...
void tc_qp_query_batch_param_check()
{
    ...
    // 6: ra_ctx_query_qp_batch 为 NULL
