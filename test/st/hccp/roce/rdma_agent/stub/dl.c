...
int (*ra_peer_init_p)(s32 dev_id) = RaPeerInit;
int (*ra_peer_deinit_p)(s32 dev_id) = RaPeerDeinit;
int (*ra_peer_socket_batch_connect_p)(struct SocketConnectInfoT conn[], u32 num) = RaPeerSocketBatchConnect;
int (*ra_peer_socket_batch_close_p)(struct SocketCloseInfoT conn[], u32 num) = RaPeerSocketBatchClose;
int (*ra_peer_socket_listen_start_p)(struct SocketListenInfoT conn[], u32 num) = RaPeerSocketListenStart;
int (*ra_peer_socket_listen_stop_p)(struct SocketListenInfoT conn[], u32 num) = RaPeerSocketListenStop;
int (*ra_peer_get_sockets_p)(u32 role, struct SocketInfoT conn[], u32 num) = RaPeerGetSockets;
int (*ra_peer_socket_send_p)(int dev_id, void* handle, void* data, u64 size) = RaPeerSocketSend;
int (*ra_peer_socket_recv_p)(int dev_id, void* handle, void* data, u64 size) = RaPeerSocketRecv;
void* (*ra_peer_qp_create_p)(int dev_id, int flag) = RaPeerQpCreate;
int (*ra_peer_qp_destroy_p)(void *handle) = RaPeerQpDestroy;
int (*ra_peer_qp_connect_async_p)(void* handle, void *sock_handle) = RaPeerQpConnectAsync;
int (*ra_peer_get_qp_status_p)(void* handle, int *status)= RaPeerGetQpStatus;
int (*ra_peer_mr_reg_p)(void* handle, void *addr, u64 size, int access) = RaPeerMrReg;
int (*ra_peer_mr_dereg_p)(void* handle, void* addr) = RaPeerMrDereg;
int (*ra_peer_send_async_p)(void* handle, struct SendWr* wr, u32* wqe_index) = RaPeerSendWr;
int (*ra_peer_get_notify_base_addr_p)(void *handle, u64 *va, u64 *size) = RaPeerGetNotifyBaseAddr;

int (*ra_hdc_init_p)(s32 dev_id) = RaHdcInit;
int (*ra_hdc_deinit_p)(s32 dev_id) = RaHdcDeinit;
int (*ra_hdc_socket_batch_connect_p)(struct SocketConnectInfoT conn[], u32 num) = RaHdcSocketBatchConnect;
int (*ra_hdc_socket_batch_close_p)(struct SocketCloseInfoT conn[], u32 num) = RaHdcSocketBatchClose;
int (*ra_hdc_socket_listen_start_p)(struct SocketListenInfoT conn[], u32 num) = RaHdcSocketListenStart;
int (*ra_hdc_socket_listen_stop_p)(struct SocketListenInfoT conn[], u32 num) = RaHdcSocketListenStop;
int (*ra_hdc_get_sockets_p)(u32 role, struct SocketInfoT conn[], u32 num) = RaHdcGetSockets;
int (*ra_hdc_socket_send_p)(void* handle, void* data, u64 size) = RaHdcSocketSend;
int (*ra_hdc_socket_recv_p)(void* handle, void* data, u64 size) = RaHdcSocketRecv;
void* (*ra_hdc_qp_create_p)(int dev_id, int flag) = RaHdcQpCreate;
int (*ra_hdc_qp_destroy_p)(void *handle) = RaHdcQpDestroy;
int (*ra_hdc_qp_connect_async_p)(void* handle, void *sock_handle) = RaHdcQpConnectAsync;
int (*ra_hdc_get_qp_status_p)(void* handle, int *status)= RaHdcGetQpStatus;
int (*ra_hdc_mr_reg_p)(void* handle, void *addr, u64 size, int access) = RaHdcMrReg;
int (*ra_hdc_mr_dereg_p)(void* handle, void* addr) = RaHdcMrDereg;
int (*ra_hdc_send_async_p)(void* handle, struct SendWr* wr, struct SendWrRsp *op_rsp, unsigned int host_tgid) = RaHdcSendWr;
int (*ra_hdc_get_notify_base_addr_p)(void *handle, u64 *va, u64 *size) = RaHdcGetNotifyBaseAddr;
