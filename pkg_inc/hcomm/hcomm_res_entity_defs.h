...
#define HCOMM_RES_ENTITY_TYPE_RDMA 0U
#define HCOMM_RES_ENTITY_TYPE_URMA 1U

struct ProtectionInfo {
    uint32_t type; // HCOMM_RES_ENTITY_TYPE_*
    uint64_t addr;
    uint64_t length;
    union MemInfo {
        ...
        int8_t reserve[32];//预留32字节，用于固定MemInfo的ABI布局
    } memInfo;
};
