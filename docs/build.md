...
2. 安装社区尝鲜版CANN Toolkit包
    ...
    - aarch64架构：[Ascend-cann-toolkit_8.5.0-beta.1_linux-aarch64.run](https://mirror-centralrepo.devcloud.cn-north-4.huaweicloud.com/artifactory/cann-run-release/software/9.0.0/20260205000325321/aarch64/Ascend-cann-toolkit_9.0.0_linux-aarch64.run)
    - x86_64架构：[Ascend-cann-toolkit_8.5.0-beta.1_linux-x86_64.run](https://mirror-centralrepo.devcloud.cn-north-4.huaweicloud.com/artifactory/cann-run-release/software/9.0.0/20260205000325321/x86_64/Ascend-cann-toolkit_9.0.0_linux-x86_64.run)
...
1. 环境准备
   ...
   - Atlas A2系列产品:
     ...
     - Ascend-ops包（aarch64架构）：[Ascend-cann-910b-ops_8.5.0-beta.1_linux-aarch64.run](https://mirror-centralrepo.devcloud.cn-north-4.huaweicloud.com/artifactory/cann-run-release/software/9.0.0/20260205000325321/aarch64/Ascend-cann-910b-ops_9.0.0_linux-aarch64.run)
     - Ascend-ops包（x86_64架构）：[Ascend-cann-910b-ops_8.5.0-beta.1_linux-x86_64.run](https://mirror-centralrepo.devcloud.cn-north-4.huaweicloud.com/artifactory/cann-run-release/software/9.0.0/20260205000325321/x86_64/Ascend-cann-910b-ops_9.0.0_linux-x86_64.run)
   ...
   - Atlas A3系列产品:
     ...
     - Ascend-ops包（aarch64架构）：[Ascend-cann-A3-ops_8.5.0-beta.1_linux-aarch64.run](https://mirror-centralrepo.devcloud.cn-north-4.huaweicloud.com/artifactory/cann-run-release/software/9.0.0/20260205000325321/aarch64/Ascend-cann-A3-ops_9.0.0_linux-aarch64.run)
     - Ascend-ops包（x86_64架构）：[Ascend-cann-A3-ops_8.5.0-beta.1_linux-x86_64.run](https://mirror-centralrepo.devcloud.cn-north-4.huaweicloud.com/artifactory/cann-run-release/software/9.0.0/20260205000325321/x86_64/Ascend-cann-A3-ops_9.0.0_linux-x86_64.run)
