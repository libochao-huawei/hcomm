...
- 并发单元间的同步：
  ...
  - 在一个通信实体内，一个Thread可以向另一个Thread发送同步信号，一个Thread可以等待另一个Thread的同步信号，具体接口请参见[本地操作](../../api_ref/comm_opdev/data_plan_api/cpu-cpu_ts-aicpu_ts/local_operations/README.md)。
