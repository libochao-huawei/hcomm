...
> 2. 本章所述的算法是开发者自行实现的算法，HCCL\_ALGO环境变量配置的算法是HCCL内置算法。HCCL内置算法可参考《[HCCL集合通信库用户指南](https://gitcode.com/cann/hccl//master/docs/user_guide/README.md)》的相关参考 \> 集合通信算法介绍。
